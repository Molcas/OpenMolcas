...
:kword:`ROSTate`
  This keyword can be used in an XMS-PDFT calculation (which needs RASSCF, CASPT2 and MCPDFT modules). This keyword stands for ROtate STates, and it rotate the states after the last diagonalization of the CASSCF, CASCI, RASSCF or RASCI calculation. 
  ...
  More information regarding XMS-PDFT can be found on the Minnesota OpenMolcas page (https://comp.chem.umn.edu/openmolcas/).

  .. xmldoc:: <KEYWORD MODULE="RASSCF" NAME="ROSTate" KIND="SINGLE" LEVEL="BASIC">
