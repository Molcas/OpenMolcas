...
:kword:`RIJ`
  ...
  .. xmldoc:: <KEYWORD MODULE="GATEWAY" NAME="RIJ" APPEAR="RI-J option" KIND="SINGLE" EXCLUSIVE="RIJK,RIC,RICD,LOW,MEDI,HIGH,NOCD,XRIC,DCCD" LEVEL="BASIC">
              %%Keyword: RIJ <basic>
              <HELP>
...
:kword:`RIJK`
  ...
  .. xmldoc:: <KEYWORD MODULE="GATEWAY" NAME="RIJK" APPEAR="RI-JK option" KIND="SINGLE" EXCLUSIVE="RIJ,RIC,RICD,LOW,MEDI,HIGH,NOCD,XRIC,DCCD" LEVEL="BASIC">
              %%Keyword: RIJK <basic>
              <HELP>
...
:kword:`RIC`
  ...
  .. xmldoc:: <KEYWORD MODULE="GATEWAY" NAME="RIC" APPEAR="RI-C option" KIND="SINGLE" EXCLUSIVE="RIJ,RIJK,RICD,LOW,MEDI,HIGH,NOCD,XRIC,DCCD" LEVEL="BASIC">
              %%Keyword: RIC <basic>
              <HELP>
...
:kword:`RICD`
  ...
  .. xmldoc:: <KEYWORD MODULE="GATEWAY" NAME="RICD" APPEAR="RI-aCD option" KIND="SINGLE" EXCLUSIVE="RIJ,RIJK,RIC,LOW,MEDI,HIGH,NOCD,XRIC,DCCD" LEVEL="BASIC">
              %%Keyword: RICD <basic>
              <HELP>
...
:kword:`DCCD`
  ...
  .. xmldoc:: <KEYWORD MODULE="GATEWAY" NAME="DCCD" APPEAR="DC RI-aCD option" KIND="SINGLE" EXCLUSIVE="RIJ,RIJK,RIC,LOW,MEDI,HIGH,NOCD,XRIC,RICD" LEVEL="BASIC">
              %%Keyword: DCCD <basic>
              <HELP>
              Use the aCD or acCD approach to treat the two-electron integrals.
              This procedure will use an on-the-fly generated auxiliary basis set.
...
:kword:`XRICd`
  ...
  .. xmldoc:: <KEYWORD MODULE="GATEWAY" NAME="XRIC" APPEAR="x-RICD option" KIND="SINGLE" EXCLUSIVE="RIJ,RIJK,RIC,RICD,LOW,MEDI,HIGH,NOCD,DCCD" LEVEL="BASIC">
              %%Keyword: xRICD <basic>
              <HELP>
...
:kword:`NOCD`
  ...
  .. xmldoc:: <KEYWORD MODULE="GATEWAY" NAME="NOCD" APPEAR="No CD" KIND="SINGLE" EXCLUSIVE="RIJ,RIJK,RIC,RICD,LOW,MEDI,HIGH,XRIC,DCCD" LEVEL="BASIC">
              %%Keyword: NOCD <basic>
              <HELP>
              Disable Cholesky decomposition.
