...
*> \param[out] S
*> \verbatim
*>          S is REAL*8           array, dimension (min(M,N))
*>          The singular values of A, sorted so that S(i) >= S(i+1).
*> \endverbatim
*>
*> \param[out] U
*> \verbatim
*>          U is REAL*8           array, dimension (LDU,UCOL)
...
*> \param[out] VT
*> \verbatim
*>          VT is REAL*8           array, dimension (LDVT,N)
