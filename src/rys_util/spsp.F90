...
subroutine spsp(EFInt,Zeta,nZeta,P,lP,rKappAB,A,B,Eta,nEta,Q,lQ,rKappCD,C,D,CoorAC,TMax,iPntr,nPntr,x0,nMax,CW6,CW5,CW4,CW3,CW2, &
...
if (ABeqCD) then
  ...
  do iEta=1,nEta
    do iZeta=1,nZeta
      ...
      EFInt(iZeta,iEta,2,1) = PreFct*(x101*y011*w1+x102*y012*w2)
      EFInt(iZeta,iEta,3,1) = PreFct*(x101*z011*w1+x102*z012*w2)
      EFInt(iZeta,iEta,1,2) = PreFct*(y101*x011*w1+y102*x012*w2)
      EFInt(iZeta,iEta,2,2) = PreFct*(y111*w1+y112*w2)
      EFInt(iZeta,iEta,3,2) = PreFct*(y101*z011*w1+y102*z012*w2)
      EFInt(iZeta,iEta,1,3) = PreFct*(z101*x011*w1+z102*x012*w2)
      EFInt(iZeta,iEta,2,3) = PreFct*(z101*y011*w1+z102*y012*w2)
