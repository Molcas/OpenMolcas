...
#include "real.fh"
real*8 EFInt(nZeta,nEta,27), Zeta(nZeta), Eta(nEta), CoorAC(3,2), ZInv(nZeta), EInv(nEta), P(lP,3), Q(lQ,3), A(3), B(3), C(3), &
       D(3), rKappAB(nZeta), rKappCD(nEta), x0(nMax), CW6(nMax,2), CW5(nMax,2), CW4(nMax,2), CW3(nMax,2), CW2(nMax,2), &
       CW1(nMax,2), CW0(nMax,2), CR6(nMax,2), CR5(nMax,2), CR4(nMax,2), CR3(nMax,2), CR2(nMax,2), CR1(nMax,2), CR0(nMax,2), &
       HerW(2), HerR2(2)
integer iPntr(nPntr)
logical EQ
