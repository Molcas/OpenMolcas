...
!               1990, IBM                                              *
!***********************************************************************
      SubRoutine Rys88(Arg,nArg,Root,Weight,iPntr,nPntr,                &
...
#include "real.fh"
      Real*8 Arg(nArg), Root(8,nArg), Weight(8,nArg), x0(nMax),         &
     &       R6(nMax,8), R5(nMax,8),                                    &
     &       R4(nMax,8), R3(nMax,8), R2(nMax,8), R1(nMax,8), R0(nMax,8),&
     &       W6(nMax,8), W5(nMax,8),                                    &
     &       W4(nMax,8), W3(nMax,8), W2(nMax,8), W1(nMax,8), W0(nMax,8),&
     &       HerW(8), HerR2(8)
      Integer iPntr(nPntr)
!
      xdInv=One/ddx
