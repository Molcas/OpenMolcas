...
#include "real.fh"
real*8 Arg(nArg), Root(3,nArg), Weight(3,nArg), x0(nMax), R6(nMax,3), R5(nMax,3), R4(nMax,3), R3(nMax,3), R2(nMax,3), R1(nMax,3), &
       R0(nMax,3), W6(nMax,3), W5(nMax,3), W4(nMax,3), W3(nMax,3), W2(nMax,3), W1(nMax,3), W0(nMax,3), HerW(3), HerR2(3)
integer iPntr(nPntr)
