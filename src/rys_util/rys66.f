...
*               1990, IBM                                              *
************************************************************************
      SubRoutine Rys66(Arg,nArg,Root,Weight,iPntr,nPntr,
...
#include "real.fh"
      Real*8 Arg(nArg), Root(6,nArg), Weight(6,nArg), x0(nMax),
     &       R6(nMax,6), R5(nMax,6),
     &       R4(nMax,6), R3(nMax,6), R2(nMax,6), R1(nMax,6), R0(nMax,6),
     &       W6(nMax,6), W5(nMax,6),
     &       W4(nMax,6), W3(nMax,6), W2(nMax,6), W1(nMax,6), W0(nMax,6),
     &       HerW(6), HerR2(6)
      Integer iPntr(nPntr)
*
      xdInv=One/ddx
