...
real(kind=wp) :: D1(nrys,nt), D2(nrys,nt), D3(nrys,nt), PAO(nt), tmp1_, tmp2_, tmp3_
...
select case (nRys)
  ...
  case (2)
    do it=1,nt
      ...
      tmp3 = tmp3+(D3(1,iT)+D3(2,iT))*PAO(It)
    end do
  ...
  case (3)
    do it=1,nt
      ...
      tmp3 = tmp3+(D3(1,iT)+D3(2,iT)+D3(3,iT))*PAO(It)
    end do
  ...
  case (4)
    do it=1,nt
      ...
      tmp3 = tmp3+(D3(1,iT)+D3(2,iT)+D3(3,iT)+D3(4,iT))*PAO(It)
    end do
  ...
  case (5)
    do it=1,nt
      ...
      tmp3 = tmp3+(D3(1,iT)+D3(2,iT)+D3(3,iT)+D3(4,iT)+D3(5,iT))*PAO(It)
    end do
  ...
  case (6)
    do it=1,nt
      ...
      tmp3 = tmp3+(D3(1,iT)+D3(2,iT)+D3(3,iT)+D3(4,iT)+D3(5,iT)+D3(6,iT))*PAO(It)
    end do
  ...
  case (7)
    do it=1,nt
      ...
      tmp3 = tmp3+(D3(1,iT)+D3(2,iT)+D3(3,iT)+D3(4,iT)+D3(5,iT)+D3(6,iT)+D3(7,iT))*PAO(It)
    end do
  ...
  case (8)
    do it=1,nt
      ...
      tmp3 = tmp3+(D3(1,iT)+D3(2,iT)+D3(3,iT)+D3(4,iT)+D3(5,iT)+D3(6,iT)+D3(7,iT)+D3(8,iT))*PAO(It)
    end do
  ...
  case (9)
    do it=1,nt
      ...
      tmp3 = tmp3+(D3(1,iT)+D3(2,iT)+D3(3,iT)+D3(4,iT)+D3(5,iT)+D3(6,iT)+D3(7,iT)+D3(8,iT)+D3(9,iT))*PAO(It)
    end do
