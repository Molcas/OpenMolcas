...
subroutine vRys2D(xyz2D,nArg,lRys,nabMax,ncdMax,PAWP,QCWQ,B10,laa,B00,lac,B01,lcc)
!***********************************************************************
!                                                                      *
...
if (laa /= 0) call RecPrt(' B10',' ',B10,lRys,nArg)
if (lac /= 0) call RecPrt(' B00',' ',B00,lRys,nArg)
if (lcc /= 0) call RecPrt(' B01',' ',B01,lRys,nArg)
#endif
