...
call map(wrk,wrksize,2,2,1,0,0,t11,1,m1,posst,rc)
!0.2 map M2(i,a) <- T1o(a,i)bb
call map(wrk,wrksize,2,2,1,0,0,t12,1,m2,posst,rc)
...
if (idaaaa == myRank) then
  ...
  call map(wrk,wrksize,4,3,2,1,4,v2,1,v3,posst,rc)
  ...
  call map(wrk,wrksize,4,1,2,4,3,v2,1,v3,posst,rc)
...
if ((myRank == idaaaa) .or. (myRank == idbbaa)) then
  ...
  call map(wrk,wrksize,4,1,3,4,2,v2,1,v3,posst,rc)
end if
!parend
...
if (myRank == idaaaa) then
  ...
  call map(wrk,wrksize,4,2,3,1,4,v4,1,v2,posst,rc)
  ...
  call map(wrk,wrksize,4,3,1,4,2,v2,1,v4,posst,rc)
  ...
  call map(wrk,wrksize,4,1,4,2,3,v3,1,v2,posst,rc)
  ...
  call map(wrk,wrksize,4,1,3,2,4,v4,1,v3,posst,rc)
  ...
  call map(wrk,wrksize,4,4,1,3,2,v4,1,v2,posst,rc)
  !I.5.3 mult V4(b,j,a,i) <- V2(b,j,m,e) . V1(m,e,a,i)
  call ccmult(wrk,wrksize,4,4,4,2,v2,1,v1,1,v4,ssc,rc)
  !I.5.4 map V3(a,b,i,j) <- V4(b,j,a,i)
  call map(wrk,wrksize,4,2,4,1,3,v4,1,v3,posst,rc)
...
if (myRank == idbbaa) then
  ...
  call map(wrk,wrksize,4,3,2,4,1,w13,1,v3,posst,rc)
  ...
  call map(wrk,wrksize,4,1,2,4,3,v4,1,v3,posst,rc)
  ...
  call map(wrk,wrksize,4,3,2,4,1,v3,1,v4,posst,rc)
  ...
  call map(wrk,wrksize,4,3,1,4,2,v2,1,v3,posst,rc)
  ...
  call map(wrk,wrksize,4,2,4,1,3,v3,1,v2,posst,rc)
...
if (myRank == idbbbb) then
  ...
  call map(wrk,wrksize,4,3,2,4,1,v2,1,v3,posst,rc)
  !K.3.13 get V2(f,b,n,j) <- T2o(f,b,n,j)abab
  call filemanager(2,lunt2o3,rc)
  call getmediate(wrk,wrksize,lunt2o3,v2,rc)
  !K.3.14 map V4(f,n,b,j) <- V2(f,b,n,j)
  call map(wrk,wrksize,4,1,3,2,4,v2,1,v4,posst,rc)
  ...
  call map(wrk,wrksize,4,1,4,2,3,v4,1,v2,posst,rc)
...
if (myRank == idaabb) then
  ...
  call map(wrk,wrksize,4,3,2,1,4,w14,1,v3,posst,rc)
  ...
  call map(wrk,wrksize,4,2,3,1,4,v3,1,v4,posst,rc)
  ...
  call map(wrk,wrksize,4,4,1,3,2,v3,1,v2,posst,rc)
  ...
  call map(wrk,wrksize,4,1,3,2,4,v3,1,v2,posst,rc)
...
if (myRank == idabba) then
  ...
  call map(wrk,wrksize,4,3,2,1,4,w13,1,v3,posst,rc)
  ...
  call map(wrk,wrksize,4,1,3,4,2,v4,1,v3,posst,rc)
  !M.3.4 get V2(f,e,m,n) <- <fe||mn>abab
  call filemanager(2,lunabij3,rc)
  call getmediate(wrk,wrksize,lunabij3,v2,rc)
  !M.3.5 map V4(m,e,f,n) <- V2(f,e,m,n)
  call map(wrk,wrksize,4,3,2,1,4,v2,1,v4,posst,rc)
  ...
  call map(wrk,wrksize,4,1,4,3,2,v2,1,v3,posst,rc)
  ...
  call map(wrk,wrksize,4,1,4,2,3,v4,1,v3,posst,rc)
...
if (myRank == idbaab) then
  ...
  call map(wrk,wrksize,4,3,2,4,1,w14,1,v3,posst,rc)
  ...
  call map(wrk,wrksize,4,3,1,2,4,v4,1,v3,posst,rc)
  !N.3.4 get V2(e,f,n,m) <- <ef||nm>abab
  call filemanager(2,lunabij3,rc)
  call getmediate(wrk,wrksize,lunabij3,v2,rc)
  !N.3.5 map V4(m,e,f,n) <- V2(e,f,n,m)
  call map(wrk,wrksize,4,2,3,4,1,v2,1,v4,posst,rc)
  ...
  call map(wrk,wrksize,4,2,3,1,4,v4,1,v3,posst,rc)
