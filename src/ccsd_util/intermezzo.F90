...
call map(wrk,wrksize,2,2,1,0,0,t11%d,t11%i,1,m1%d,m1%i,m1%pos0,posst,rc)
!0.2 map M2(i,a) <- T1o(a,i)bb
call map(wrk,wrksize,2,2,1,0,0,t12%d,t12%i,1,m2%d,m2%i,m2%pos0,posst,rc)
...
if (idaaaa == myRank) then
  ...
  call expand(wrk,wrksize,4,3,w11%d,w11%i,1,v2%pos0,v2%d,v2%i,rc)
  !I.2.2 map V3(m,e,j,n) <- V2(j,e,m,n)
  call map(wrk,wrksize,4,3,2,1,4,v2%d,v2%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  !I.2.3 mult V2(m,e,j,b) <- V3(m,e,j,n) . M1(n,b)
  call mult(wrk,wrksize,4,2,4,1,v3%d,v3%i,1,m1%d,m1%i,1,v2%d,v2%i,ssc,v2%pos0,rc)
  !I.2.4 map V3(m,e,b,j) <- V2(m,e,j,b)
  call map(wrk,wrksize,4,1,2,4,3,v2%d,v2%i,1,v3%d,v3%i,v3%pos0,posst,rc)
...
if ((myRank == idaaaa) .or. (myRank == idbbaa)) then
  ...
  call getmediate(wrk,wrksize,lunt2o1,v3%pos0,v3%d,v3%i,rc)
  !I.3.2 expand V2(f,b,j,n) <- V3(fb,jn)
  call expand(wrk,wrksize,4,4,v3%d,v3%i,1,v2%pos0,v2%d,v2%i,rc)
  !I.3.3 mkQ V2(f,b,j,n) <- 0.5 V2(f,b,j,n) + T1o(f,j)aa . T1o(b,n)aa
  call mkq(wrk,wrksize,v2%d,v2%i,t11%d,t11%i,t11%d,t11%i,Half,rc)
  !I.3.4 map V3(f,n,b,j) <- V2(f,b,j,n)
  call map(wrk,wrksize,4,1,3,4,2,v2%d,v2%i,1,v3%d,v3%i,v3%pos0,posst,rc)
end if
!parend
...
if (myRank == idbbaa) then
  ...
  call wrtmediate(wrk,wrksize,lunqaaaa,v3%d,v3%i,rc)
end if
...
if (myRank == idaaaa) then
  ...
  call getmediate(wrk,wrksize,lunabij1,v2%pos0,v2%d,v2%i,rc)
  !I.3.7 expand V4(e,f,m,n) <- V2(ef,mn)
  call expand(wrk,wrksize,4,4,v2%d,v2%i,1,v4%pos0,v4%d,v4%i,rc)
  !I.3.8 map V2(m,e,f,n) <- V4(e,f,m,n)
  call map(wrk,wrksize,4,2,3,1,4,v4%d,v4%i,1,v2%d,v2%i,v2%pos0,posst,rc)
  !I.3.9 mult V4(m,e,b,j) <- V2(m,e,f,n) . V3(f,n,b,j)
  call mult(wrk,wrksize,4,4,4,2,v2%d,v2%i,1,v3%d,v3%i,1,v4%d,v4%i,ssc,v4%pos0,rc)
  !I.3.10 add V1(m,e,b,j) <- -1.0 . V4(m,e,b,j)
  call add(wrk,wrksize,4,4,0,0,0,0,1,1,-One,v4%d,1,v1%d,v1%i,1,rc)
  ...
  call map(wrk,wrksize,4,3,1,4,2,v2%d,v2%i,1,v4%d,v4%i,v4%pos0,posst,rc)
  !I.3.15 mult V2(m,e,b,j) <- V3(m,e,f,n) . V4(f,n,b,j)
  call mult(wrk,wrksize,4,4,4,2,v3%d,v3%i,1,v4%d,v4%i,1,v2%d,v2%i,ssc,v2%pos0,rc)
  !I.3.16 add V1(m,e,b,j) <- 0.5 . V2(m,e,b,j)
  call add(wrk,wrksize,4,4,0,0,0,0,1,1,Half,v2%d,1,v1%d,v1%i,1,rc)
  ...
  call expand(wrk,wrksize,4,4,v2%d,v2%i,1,v3%pos0,v3%d,v3%i,rc)
  !I.4.3 map V2(a,i,m,e) <- V3(a,e,i,m)
  call map(wrk,wrksize,4,1,4,2,3,v3%d,v3%i,1,v2%d,v2%i,v2%pos0,posst,rc)
  !I.4.4 mult V4(a,i,b,j) <- V2(a,i,m,e) . V1(m,e,b,j)
  call mult(wrk,wrksize,4,4,4,2,v2%d,v2%i,1,v1%d,v1%i,1,v4%d,v4%i,ssc,v4%pos0,rc)
  !I.4.5 map V3(a,b,i,j) <- V4(a,i,b,j)
  call map(wrk,wrksize,4,1,3,2,4,v4%d,v4%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  !I.4.6 pack V3(ab,ij) <- V2(ab,i,j) <- V3(a,b,i,j)
  call fack(wrk,wrksize,4,1,v3%d,1,v3%i,v2%d,v2%i,v2%pos0,rc)
  ...
  call map(wrk,wrksize,4,4,1,3,2,v4%d,v4%i,1,v2%d,v2%i,v2%pos0,posst,rc)
  !I.5.3 mult V4(b,j,a,i) <- V2(b,j,m,e) . V1(m,e,a,i)
  call mult(wrk,wrksize,4,4,4,2,v2%d,v2%i,1,v1%d,v1%i,1,v4%d,v4%i,ssc,v4%pos0,rc)
  !I.5.4 map V3(a,b,i,j) <- V4(b,j,a,i)
  call map(wrk,wrksize,4,2,4,1,3,v4%d,v4%i,1,v3%d,v3%i,v3%pos0,posst,rc)
...
if (myRank == idbbaa) then
  ...
  call map(wrk,wrksize,4,3,2,4,1,w13%d,w13%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  !J.2.2 mult V4(m,e,j,b) <- V3(m,e,j,n) . M1(n,b)
  call mult(wrk,wrksize,4,2,4,1,v3%d,v3%i,1,m1%d,m1%i,1,v4%d,v4%i,ssc,v4%pos0,rc)
  !J.2.3 map V3(m,e,b,j) <- V4(m,e,j,b)
  call map(wrk,wrksize,4,1,2,4,3,v4%d,v4%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  ...
  call getmediate(wrk,wrksize,lunqaaaa,v2%pos0,v2%d,v2%i,rc)
  ...
  call map(wrk,wrksize,4,3,2,4,1,v3%d,v3%i,1,v4%d,v4%i,v4%pos0,posst,rc)
  ...
  call map(wrk,wrksize,4,3,1,4,2,v2%d,v2%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  !J.3.8 get V2(ef,mn) = <ef||mn>bbbb from lunb file
  call filemanager(2,lunabij2,rc)
  call getmediate(wrk,wrksize,lunabij2,v2%pos0,v2%d,v2%i,rc)
  ...
  call add(wrk,wrksize,4,4,0,0,0,0,1,1,Half,v4%d,1,v1%d,v1%i,1,rc)

  !J.4 R1(a,i,b,j)aaaa <= sum(m,e-bb) [ T2o(a,e,i,m)abab . WIII(m,e,b,j)bbaa ]
  !    T2n(ab,ij)aaaa   <= {1(a,i,b,j)-R1(b,i,a,j)-R1(a,j,b,i)+R1(b,j,a,i)}aaaa
  !J.4.1 get V3(a,e,i,m) <- T2o(a,e,i,m)abab
  call filemanager(2,lunt2o3,rc)
  call getmediate(wrk,wrksize,lunt2o3,v3%pos0,v3%d,v3%i,rc)
  ...
  call expand(wrk,wrksize,4,4,v4%d,v4%i,1,v3%pos0,v3%d,v3%i,rc)
  ...
  call map(wrk,wrksize,4,2,4,1,3,v3%d,v3%i,1,v2%d,v2%i,v2%pos0,posst,rc)
...
if (myRank == idbbbb) then
  ...
  call expand(wrk,wrksize,4,3,w12%d,w12%i,1,v2%pos0,v2%d,v2%i,rc)
  !K.2.2 map V3(m,e,j,n) <- V2(j,e,m,n)
  call map(wrk,wrksize,4,3,2,1,4,v2%d,v2%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  !K.2.3 mult V2(m,e,j,b) <- V3(m,e,j,n) . M2(n,b)
  call mult(wrk,wrksize,4,2,4,1,v3%d,v3%i,1,m2%d,m2%i,1,v2%d,v2%i,ssc,v2%pos0,rc)
...
if ((myRank == idbbbb) .or. (myRank == idaabb)) then
  ...
  call filemanager(2,lunt2o2,rc)
  call getmediate(wrk,wrksize,lunt2o2,v3%pos0,v3%d,v3%i,rc)
  !K.3.2 expand V2(f,b,j,n) <- V3(fb,jn)
  call expand(wrk,wrksize,4,4,v3%d,v3%i,1,v2%pos0,v2%d,v2%i,rc)
  !K.3.3 mkQ V2(f,b,j,n) <- 0.5 V2(f,b,j,n) + T1o(f,j)bb . T1o(b,n)bb
  call mkq(wrk,wrksize,v2%d,v2%i,t12%d,t12%i,t12%d,t12%i,Half,rc)
...
if (myRank == idaabb) then
  ...
  call wrtmediate(wrk,wrksize,lunqbbbb,v3%d,v3%i,rc)
end if
...
if (myRank == idbbbb) then
  ...
  call map(wrk,wrksize,4,3,2,4,1,v2%d,v2%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  !K.3.13 get V2(f,b,n,j) <- T2o(f,b,n,j)abab
  call filemanager(2,lunt2o3,rc)
  call getmediate(wrk,wrksize,lunt2o3,v2%pos0,v2%d,v2%i,rc)
  !K.3.14 map V4(f,n,b,j) <- V2(f,b,n,j)
  call map(wrk,wrksize,4,1,3,2,4,v2%d,v2%i,1,v4%d,v4%i,v4%pos0,posst,rc)
  ...
  call map(wrk,wrksize,4,1,4,2,3,v4%d,v4%i,1,v2%d,v2%i,v2%pos0,posst,rc)
...
if (myRank == idaabb) then
  ...
  call map(wrk,wrksize,4,3,2,1,4,w14%d,w14%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  !L.2.2 mult V4(m,e,j,b) <- V3(m,e,j,n) . M2(n,b)
  call mult(wrk,wrksize,4,2,4,1,v3%d,v3%i,1,m2%d,m2%i,1,v4%d,v4%i,ssc,v4%pos0,rc)
  ...
  call getmediate(wrk,wrksize,lunqbbbb,v2%pos0,v2%d,v2%i,rc)
  call filemanager(3,lunqbbbb,rc)
  !L.2.2 get V3(e,f,m,n) <- <ef||mn>abab
  call filemanager(2,lunabij3,rc)
  call getmediate(wrk,wrksize,lunabij3,v3%pos0,v3%d,v3%i,rc)
  !L.2.3 map V4(m,e,f,n) <- V3(e,f,m,n)
  call map(wrk,wrksize,4,2,3,1,4,v3%d,v3%i,1,v4%d,v4%i,v4%pos0,posst,rc)
  ...
  call map(wrk,wrksize,4,4,1,3,2,v3%d,v3%i,1,v2%d,v2%i,v2%pos0,posst,rc)
  ...
  call map(wrk,wrksize,4,1,3,2,4,v3%d,v3%i,1,v2%d,v2%i,v2%pos0,posst,rc)
...
if (myRank == idabba) then
  ...
  call map(wrk,wrksize,4,3,2,1,4,w13%d,w13%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  ...
  call mkq(wrk,wrksize,v4%d,v4%i,t11%d,t11%i,t12%d,t12%i,Half,rc)
  !M.3.3 map V3(f,n,b,j) <- V4(f,b,j,n)
  call map(wrk,wrksize,4,1,3,4,2,v4%d,v4%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  !M.3.4 get V2(f,e,m,n) <- <fe||mn>abab
  call filemanager(2,lunabij3,rc)
  call getmediate(wrk,wrksize,lunabij3,v2%pos0,v2%d,v2%i,rc)
  !M.3.5 map V4(m,e,f,n) <- V2(f,e,m,n)
  call map(wrk,wrksize,4,3,2,1,4,v2%d,v2%i,1,v4%d,v4%i,v4%pos0,posst,rc)
  !M.3.6 mult V2(m,e,b,j) <- V4(m,e,f,n) . V3(f,n,b,j)
  call mult(wrk,wrksize,4,4,4,2,v4%d,v4%i,1,v3%d,v3%i,1,v2%d,v2%i,ssc,v2%pos0,rc)
  ...
  call map(wrk,wrksize,4,1,4,3,2,v2%d,v2%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  !M.4.3 mult V4(a,j,b,i) <- V3(a,j,m,e) . V1(m,e,b,i)
  call mult(wrk,wrksize,4,4,4,2,v3%d,v3%i,1,v1%d,v1%i,1,v4%d,v4%i,ssc,v4%pos0,rc)
  !M.4.4 map V3(a,b,i,j) <- V4(a,j,b,i)
  call map(wrk,wrksize,4,1,4,2,3,v4%d,v4%i,1,v3%d,v3%i,v3%pos0,posst,rc)
...
if (myRank == idbaab) then
  ...
  call map(wrk,wrksize,4,3,2,4,1,w14%d,w14%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  ...
  call map(wrk,wrksize,4,3,1,2,4,v4%d,v4%i,1,v3%d,v3%i,v3%pos0,posst,rc)
  !N.3.4 get V2(e,f,n,m) <- <ef||nm>abab
  call filemanager(2,lunabij3,rc)
  call getmediate(wrk,wrksize,lunabij3,v2%pos0,v2%d,v2%i,rc)
  !N.3.5 map V4(m,e,f,n) <- V2(e,f,n,m)
  call map(wrk,wrksize,4,2,3,4,1,v2%d,v2%i,1,v4%d,v4%i,v4%pos0,posst,rc)
  ...
  call map(wrk,wrksize,4,2,3,1,4,v4%d,v4%i,1,v3%d,v3%i,v3%pos0,posst,rc)
