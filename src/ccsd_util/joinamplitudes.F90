...
!
!        this routine join contributions to amplitudes (Tn) from all
...
!        will be demaged. (acutally V1 and V2 only)
!
...
!        call MPI_ALLREDUCE (wrk(posst130),wrk(possv10),length,
...
!        end do
!
!1.om   allreduge t13,t14 together
...
!        call MPI_ALLREDUCE (wrk(posst210),wrk(possv10),length,
!    c  MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,rc)
!
...
!        end do
!
!2.om   allreduge t21-t23 together
