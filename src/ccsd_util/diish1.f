...
!
!     this routine upgrade rdiis1(p,q) maptix
!     rdiis1(p,q) = szkey*rdiis1(p,q) + (xp|xq)
!
!     nind   - number of indexes in vectors (i)
...
!     if tere is less than 5 vectors, use any map
!     ndiis  - dimension of DIIS (2-4) (I)
!     szkey  - 0 - no vanishing rdiis1 at the beggining
!     1 - vanishing rdiis1 at the beggining
!
#include "wrk.fh"
#include "ccsd1.fh"
!
