...
if (myRank == idfin) then
  ...
  call map(wrk,wrksize,4,4,1,2,3,mapdw11,mapiw11,1,mapdv3,mapiv3,possv30,posst,rc)
...
if (myRank == idfin) then
  ...
  call map(wrk,wrksize,4,4,1,2,3,mapdw12,mapiw12,1,mapdv3,mapiv3,possv30,posst,rc)
...
if (myRank == idaabb) then
  ...
  call map(wrk,wrksize,4,1,3,2,4,mapdv1,mapiv1,1,mapdv3,mapiv3,possv30,posst,rc)
...
if (myRank == idbaab) then
  ...
  call map(wrk,wrksize,4,3,1,4,2,mapdv1,mapiv1,1,mapdv3,mapiv3,possv30,posst,rc)
...
if (myRank == idfin) then
  ...
  call map(wrk,wrksize,4,4,1,2,3,mapdw13,mapiw13,1,mapdv3,mapiv3,possv30,posst,rc)
  ...
  call map(wrk,wrksize,4,4,1,2,3,mapdw14,mapiw14,1,mapdv3,mapiv3,possv30,posst,rc)
