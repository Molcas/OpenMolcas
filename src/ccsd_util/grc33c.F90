...
subroutine grc33C(mapda,mapdb,mapdc,mapia,mapib,mapic,mvec,ssa,ssb,pbar,possc0,ix)
...
if (pbar == 1) then
  ...
  call grc0(2,0,mapda(0,1),mapdb(0,3),0,0,mmul(ssa,ssb),possc0,possct,mapdc,mapic)
  ...
  call grc0(4,nhelp1,mapda(0,1),mapda(0,2),mapdb(0,2),mapdb(0,3),mmul(ssa,ssb),possc0,possct,mapdc,mapic)
