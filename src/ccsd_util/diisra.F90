...
!
!     this routine read num vectors of amplitudes
...
!     poss10    - initial possition of vector 1 (I)
!     mapd2     - direct matrix of vector 2 (I)
!     mapi2     - inverse matrix of vector 2 (I)
!     poss20    - initial possition of vector 2 (I)
!     mapd3     - direct matrix of vector 3 (I)
!     mapi3     - inverse matrix of vector 3 (I)
!     poss30    - initial possition of vector 3 (I)
!     mapd4     - direct matrix of vector 4 (I)
!     mapi4     - inverse matrix of vector 4 (I)
!     poss40    - initial possition of vector 4 (I)
!     if there is less tahn 4 vecrors required
!     use any map's and poss's
!
#include "wrk.fh"
!
