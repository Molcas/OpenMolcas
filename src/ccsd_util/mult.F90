...
!***********************************************************************
     ...
     & possc0,rc)
!
!     ninda   - # of indexes in matrix A (Input)
!     nindb   - # of indexes in matrix B (Input)
!     nindc   - # of indexes in matrix C (Input, for test)
!     nindsum - # of sumation indexes    (Input)
...
!     possc0  - initial possition of matrix C  (Input)
!
!
!     This routine realize matrix-matrix and matrix-vector multiplications
