...
subroutine grc23C(mapda,mapdb,mapdc,mapia,mapib,mapic,mvec,ssa,ssb,pbar,possc0,ix)
...
integer(kind=iwp) :: mapda(0:512,6), mapdb(0:512,6), mapdc(0:512,6), mapia(8,8,8), mapib(8,8,8), mapic(8,8,8), mvec(4096,7), ssa, &
                     ssb, pbar, possc0, ix
#include "ccsd1.fh"
integer(kind=iwp) :: ia, ib, ic, nhelp1, nhelp2, nhelp3, nhelp31, nhelp32, nhelp4, ntest1, possct, sa1, sa2, sb1, sb12, sb2, sb3
...
if (pbar == 1) then
  ...
  call grc0(3,mapdb(0,6),mapda(0,1),mapdb(0,2),mapdb(0,3),0,mmul(ssa,ssb),possc0,possct,mapdc,mapic)
