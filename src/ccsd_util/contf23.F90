...
if (myRank == idbaab) then
  ...
  call expand(wrk,wrksize,4,3,mapdw11,mapiw11,1,possv10,mapdv1,mapiv1,rc)

  !1.2 map V2(m,i,e,n) <= V1(i,e,m,n)
  call map(wrk,wrksize,4,2,3,1,4,mapdv1,mapiv1,1,mapdv2,mapiv2,possv20,posst,rc)
  ...
  call map(wrk,wrksize,4,2,3,1,4,mapdw13,mapiw13,1,mapdv2,mapiv2,possv20,posst,rc)
...
if (myRank == idaabb) then
  ...
  call expand(wrk,wrksize,4,3,mapdw12,mapiw12,1,possv10,mapdv1,mapiv1,rc)
  ...
  call map(wrk,wrksize,4,2,3,4,1,mapdw14,mapiw14,1,mapdv2,mapiv2,possv20,posst,rc)
