...
if (myRank == idbaab) then
  ...
  call map(wrk,wrksize,2,1,2,0,0,f21%d,f21%i,1,m1%d,m1%i,m1%pos0,posst,rc)
  ...
  call mult(wrk,wrksize,2,2,2,1,m2%d,m2%i,1,t11%d,t11%i,1,m3%d,m3%i,ssc,m3%pos0,rc)
  ...
  call expand(wrk,wrksize,4,6,v3%d,v3%i,1,v2%pos0,v2%d,v2%i,rc)

  !5.3 mult V3(ab,k,l) <= V2(a,b,k,m) . M1(m,l)
  call mult(wrk,wrksize,4,2,4,1,v2%d,v2%i,1,m1%d,m1%i,1,v3%d,v3%i,ssc,v3%pos0,rc)
  ...
  call map(wrk,wrksize,4,1,2,4,3,v1%d,v1%i,1,v2%d,v2%i,v2%pos0,posst,rc)
...
if (myRank == idaabb) then
  ...
  call map(wrk,wrksize,2,1,2,0,0,f22%d,f22%i,1,m1%d,m1%i,m1%pos0,posst,rc)
  ...
  call mult(wrk,wrksize,2,2,2,1,m2%d,m2%i,1,t12%d,t12%i,1,m3%d,m3%i,ssc,m3%pos0,rc)
  ...
  call mult(wrk,wrksize,4,2,4,1,v1%d,v1%i,1,m1%d,m1%i,1,v3%d,v3%i,ssc,v3%pos0,rc)
