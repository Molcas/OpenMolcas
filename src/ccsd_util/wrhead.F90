...
write(6,'(6X,A)') '-----------------------'
write(6,*)
write(6,'(6X,A,T47,8I4)') 'Symmetry species',(nhelp,nhelp=1,nsym)
write(6,'(6X,A,T47,8I4)') 'Total no. of orbitals',(norb(nhelp),nhelp=1,nsym)
write(6,'(6X,A,T47,8I4)') 'No. of occupied orbitals with alpha spin',(noa(nhelp),nhelp=1,nsym)
write(6,'(6X,A,T47,8I4)') 'No. of occupied orbitals with beta spin',(nob(nhelp),nhelp=1,nsym)
write(6,'(6X,A,T47,8I4)') 'No. of virtual orbitals with alpha spin',(nva(nhelp),nhelp=1,nsym)
write(6,'(6X,A,T47,8I4)') 'No. of virtual orbitals with beta spin',(nvb(nhelp),nhelp=1,nsym)
write(6,*)
if (fullprint > 1) then
  write(6,*)
  write(6,16) nsym
...
if (typden == 0) then
  write(6,'(6X,A,T45,A)') 'Type of denominators','diagonal Fock matrix elements'
else if (typden == 1) then
  write(6,'(6X,A,T45,A)') 'Type of denominators','spin averaged diagonal Fock matrix elements'
else
...
!FUE write(6,71) ccconv
!FUE 71 format (' ENERGY CONVERGENCE CRITER.  : ',d10.5)
