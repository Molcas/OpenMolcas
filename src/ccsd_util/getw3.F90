...
!***********************************************************************
     ...
     & lunw3xxxx,nxxxx)
!
!     This routine reconstruct W3(m,e,a,j)xxxx from lunw3xxxx file
!     to V1(m,e,a,j) and define corresponding mapdv1 and mapiv1
!     This routine also close lunw3xxxx file
!
...
!
!3.3.2insert H1 into V1 for given a and syma
