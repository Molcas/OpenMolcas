...
subroutine grc44C(a,b,c,mvec,ssa,ssb,pbar,ix)
...
if (pbar == 1) then
  ...
  call grc0(2,0,a%d(0,1),b%d(0,4),0,0,mmul(ssa,ssb),possct,c)
  ...
  call grc0(4,nhelp1,a%d(0,1),a%d(0,2),b%d(0,3),b%d(0,4),mmul(ssa,ssb),possct,c)
