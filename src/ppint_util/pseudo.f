...
!AOM      dimension ipt(55),a(iptmax)
      dimension ipt(55)
!
!     Write (*,*) 'ncr',(ncr(i),i=1,npot)
!     Write (*,*) 'zcr',(zcr(i),i=1,npot)
!     Write (*,*) 'ccr',(ccr(i),i=1,npot)
!     Write (*,*) 'nkcrl',(nkcrl(i,1),i=1,lcr(1)+1)
!     Write (*,*) 'nkcru',(nkcru(i,1),i=1,lcr(1)+1)
!     Write (*,*)
!                                                                      *
!***********************************************************************
!                                                                      *
...
!AOM      if ( ipt(31) .gt. iptmax ) stop 'work space too small'
      ltot1 = lit + ljt - 1
      ltot12 = ltot1**2
      ...
      ipt(36) = ipt(35) +  ltot1
      ipt(37) = ipt(36) +  ltot1
!AOM      if ( ipt(37) .gt. iptmax ) stop 'work space too small'
      mproju = 2*lproju+1
      lamau = lit+lproju
...
!AOM      if ( ipt(51) .gt. iptmax ) stop 'work space too small'
