      SubRoutine Drv1El(DMET_f,DInf,nDInf,Info)
************************************************************************
*                                                                      *
...
*             January 1991                                             *
*                                                                      *
* (c) Copyright 1991 R. Lindh, Dept. of Theor. Chem. Univ. of Lund,    *
...
************************************************************************
     ...
     &          NAMem_GIAO,
     &          dTdmu_Mem
      Real*8 DInf(nDInf,nDInf), DMET_f(nDInf,nDInf)
#ifdef _FDE_
      ! Embedding
...
************************************************************************
      ...
      If (lOMQ.and..Not.Primitive_Pass) Then
         ...
         Call Allocate_Auxiliary()
*
         Call dCopy_(nComp,Work(ipOMQ),1,CoorO(1        ),1) ! Change from 3 to ncomp?
         Call dCopy_(nComp,Work(ipOMQ),1,CoorO(1+  ncomp),1) !
         Call dCopy_(nComp,Work(ipOMQ),1,CoorO(1+2*ncomp),1) !
...
* We use all nine compenents even if we only need 6 of these later.
*
* Mxx
