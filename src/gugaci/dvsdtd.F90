...
lpok = jpadlr
jmlr = mul_tab(jml,jmr)
goto(101,102,103,104,105,106,10,108,109,110,111,112,113,10,115,10,117,118,119,120,121,122,123,124,125,10),lpok ! 107???
!=======================================================================
! sd(6-1) a&r(02)-
! sd(6-2) c(22)a&(13)-
! sd(6-3) a&r(13)c'(22)-
...
jmlr = mul_tab(jml,jmr)
lpok = jpadlr
goto(101,102,103,104,105,106,10,108,10,110,111,112,113,10,115,10,117,118,119,120,121,122,123,124,125,10),lpok ! 109???
!=======================================================================
! sd(6-1) a&r(02)-
! sd(6-2) c(22)a&(13)-
! sd(6-3) a&r(13)c'(22)-
...
jmlr = mul_tab(jml,jmr)
lpok = jpadlr
!goto(101,102,103,104,105,106,10,108,109,110,111,112,113,10,115,10,117,118,119,120,121,122,123,124,125,10),lpok
goto(101,102,103,104,105,106,10,108,109,110,111,112,113,10,115,10,117,118,119,120,121,122,123,124,125,10),lpok
!=======================================================================
! sd(6-1) a&r(02)-
! sd(6-2) c(22)a&(13)-
