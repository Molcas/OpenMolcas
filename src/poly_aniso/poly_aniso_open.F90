...
if (dbg) write(u6,*) 'Enter find_aniso_format'
call find_aniso_format(old_aniso_format)
if (dbg) write(u6,*) 'Exit find_aniso_format'

! initialize some important variables
if (dbg) write(u6,*) 'Enter fetch_init_const'
call fetch_init_const(nneq,neqv,nmax,exch,nLoc,nCenter,nT,nH,nTempMagn,nDir,nDirZee,nMult,nPair,MxRank1,MxRank2,old_aniso_format, &
                      iReturn)
if (dbg) write(u6,*) 'Exit fetch_init_const'

if (dbg) write(u6,*) 'pa_open::             nneq=',nneq
if (dbg) write(u6,*) 'pa_open::             neqv=',neqv
if (dbg) write(u6,*) 'pa_open::             nmax=',nmax
if (dbg) write(u6,*) 'pa_open::             exch=',exch
if (dbg) write(u6,*) 'pa_open::             nLoc=',nLoc
if (dbg) write(u6,*) 'pa_open::          nCenter=',nCenter
if (dbg) write(u6,*) 'pa_open::               nT=',nT
if (dbg) write(u6,*) 'pa_open::               nH=',nH
if (dbg) write(u6,*) 'pa_open::        nTempMagn=',nTempMagn
if (dbg) write(u6,*) 'pa_open::             nDir=',nDir
if (dbg) write(u6,*) 'pa_open::          nDirZee=',nDirZee
if (dbg) write(u6,*) 'pa_open::            nMult=',nMult
if (dbg) write(u6,*) 'pa_open::            nPair=',nPair
if (dbg) write(u6,*) 'pa_open::          MxRank1=',MxRank1
if (dbg) write(u6,*) 'pa_open::          MxRank2=',MxRank2
if (dbg) write(u6,*) 'pa_open::          iReturn=',iReturn
if (dbg) write(u6,*) 'pa_open:: old_aniso_format=',old_aniso_format
...
! main program
if (dbg) write(u6,*) 'Enter poly_aniso_1'
if (dbg) call xFlush(u6)
call POLY_ANISO_1(nneq,neqv,nmax,exch,nLoc,nCenter,nT,nH,nTempMagn,nDir,nDirZee,nMult,nPair,MxRank1,MxRank2,old_aniso_format, &
                  iReturn)
if (dbg) write(u6,*) 'Exit poly_aniso_1'
