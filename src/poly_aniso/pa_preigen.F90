...
if ((AnisoLines1 .or. AnisoLines3 .or. AnisoLines9) .and. Dipol .and. KE .and. (.not. JITO_exchange)) then
  write(6,'(6a)') 'Coupled|','     Lines Model      |',' Dipole-Dipole Inter. |','   Kinetic Exchange   |', &
                  '         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |','  absolute val., cm-1 |', &
                  '  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','----------------------|','----------------------|', &
                  '---------------------------------------------|'

  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WLIN(i),'|',WDIP(i),'|',WKEX(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','----------------------|', &
                  '---------------------------------------------|'
...
!----------------------------------------------------------------------!
  ...
  write(6,'(6a)') 'Coupled|','     Lines Model      |',' Dipole-Dipole Inter. |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WLIN(i),'|',WDIP(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'

!----------------------------------------------------------------------!
else if ((AnisoLines1 .or. AnisoLines3 .or. AnisoLines9) .and. (.not. Dipol) .and. KE .and. (.not. JITO_exchange)) then
  write(6,'(6a)') 'Coupled|','     Lines Model      |','   Kinetic Exchange   |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WLIN(i),'|',WKEX(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'

!----------------------------------------------------------------------!
else if ((.not. (AnisoLines1 .or. AnisoLines3 .or. AnisoLines9)) .and. Dipol .and. KE .and. (.not. JITO_exchange)) then
  write(6,'(6a)') 'Coupled|',' Dipole-Dipole Inter. |','   Kinetic Exchange   |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WDIP(i),'|',WKEX(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'

!----------------------------------------------------------------------!
else if ((AnisoLines1 .or. AnisoLines3 .or. AnisoLines9) .and. (.not. Dipol) .and. (.not. KE) .and. (.not. JITO_exchange)) then
  write(6,'(6a)') 'Coupled|','     Lines Model      |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WLIN(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','---------------------------------------------|'

!----------------------------------------------------------------------!
else if ((.not. (AnisoLines1 .or. AnisoLines3 .or. AnisoLines9)) .and. Dipol .and. (.not. KE) .and. (.not. JITO_exchange)) then
  write(6,'(6a)') 'Coupled|',' Dipole-Dipole Inter. |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WDIP(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','---------------------------------------------|'

!----------------------------------------------------------------------!
else if ((.not. (AnisoLines1 .or. AnisoLines3 .or. AnisoLines9)) .and. (.not. Dipol) .and. KE .and. (.not. JITO_exchange)) then
  write(6,'(6a)') 'Coupled|','   Kinetic Exchange   |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WKEX(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','---------------------------------------------|'
...
!----------------------------------------------------------------------!
  ...
  write(6,'(6a)') 'Coupled|','   Kinetic Exchange   |','     ITO Exchange     |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WKEX(i),'|',WITO(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'

!----------------------------------------------------------------------!
else if ((.not. (AnisoLines1 .or. AnisoLines3 .or. AnisoLines9)) .and. (.not. Dipol) .and. (.not. KE) .and. JITO_exchange) then
  write(6,'(6a)') 'Coupled|','     ITO Exchange     |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WITO(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','---------------------------------------------|'

!----------------------------------------------------------------------!
else if ((.not. (AnisoLines1 .or. AnisoLines3 .or. AnisoLines9)) .and. Dipol .and. (.not. KE) .and. JITO_exchange) then
  write(6,'(6a)') 'Coupled|',' Dipole-Dipole Inter. |','     ITO Exchange     |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WDIP(i),'|',WITO(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'

!----------------------------------------------------------------------!
else if ((.not. (AnisoLines1 .or. AnisoLines3 .or. AnisoLines9)) .and. Dipol .and. KE .and. JITO_exchange) then
  write(6,'(6a)') 'Coupled|',' Dipole-Dipole Inter. |','   Kinetic Exchange   |','     ITO Exchange     |', &
                  '         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |','  absolute val., cm-1 |', &
                  '  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','----------------------|','----------------------|', &
                  '---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WDIP(i),'|',WKEX(i),'|',WITO(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','----------------------|', &
                  '---------------------------------------------|'
...
!----------------------------------------------------------------------!
  ...
  write(6,'(6a)') 'Coupled|','     Lines Model      |','     ITO Exchange     |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WLIN(i),'|',WITO(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','---------------------------------------------|'

!----------------------------------------------------------------------!
else if ((AnisoLines1 .or. AnisoLines3 .or. AnisoLines9) .and. Dipol .and. (.not. KE) .and. JITO_exchange) then
  write(6,'(6a)') 'Coupled|','     Lines Model      |',' Dipole-Dipole Inter. |','     ITO Exchange     |', &
                  '         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |','  absolute val., cm-1 |', &
                  '  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','----------------------|','----------------------|', &
                  '---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WLIN(i),'|',WDIP(i),'|',WITO(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','----------------------|', &
                  '---------------------------------------------|'
...
!----------------------------------------------------------------------!
  ...
  write(6,'(6a)') 'Coupled|','     Lines Model      |','   Kinetic Exchange   |','     ITO Exchange     |', &
                  '         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |','  absolute val., cm-1 |', &
                  '  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','----------------------|','----------------------|', &
                  '---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',WLIN(i),'|',WKEX(i),'|',WITO(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','----------------------|', &
                  '---------------------------------------------|'
...
!----------------------------------------------------------------------!
  ...
  write(6,'(6a)') '-------|','----------------------|','----------------------|','----------------------|', &
                  '----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,6(f20.12,2x,A))') i,'|',WLIN(i),'|',WDIP(i),'|',WKEX(i),'|',WITO(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','----------------------|','----------------------|', &
                  '----------------------|','---------------------------------------------|'
...
!----------------------------------------------------------------------!
  ...
  write(6,'(6a)') 'Coupled|','  Magnetic Exchange   |','         Total Magnetic Interaction          |'
  write(6,'(6a)') 'State  |','  absolute val., cm-1 |','  absolute val., cm-1 |  relative val., cm-1 |'
  write(6,'(6a)') '-------|','----------------------|','---------------------------------------------|'
  do i=1,exch
    write(6,'(i5,2x,A,5(f20.12,2x,A))') i,'|',W(i),'|',W(i),'|',W(i)-W(1),'|'
  end do
  write(6,'(6a)') '-------|','----------------------|','---------------------------------------------|'
end if
...
if (iPrint >= 3) then
  ...
  write(6,*)
  write(6,'(100a)') (('%'),i=1,100)
  write(6,'(10x,a)') 'EigenVectors of the Total Magnetic Interaction'
  write(6,'(100a)') (('%'),i=1,100)

  if (exch >= 4) then
    write(6,'(A,16A)') '-',('---',m=1,lmax),'|',('---------------------------|',i=1,4)
    write(fmtline,'(A,i2,A)') '(1x,',lmax,'A,39x,A,38x,A)'
    write(6,fmtline) ('   ',m=1,lmax),'eigenvectors of the exchange matrix','|'
  else if (exch == 3) then
    write(6,'(A,16A)') '-',('---',m=1,lmax),'|',('---------------------------|',i=1,3)
    write(fmtline,'(A,i2,A)') '(1x,',lmax,'A,25x,A,24x,A)'
    write(6,fmtline) ('   ',m=1,lmax),'eigenvectors of the exchange matrix','|'
  else if (exch == 2) then
    write(6,'(A,16A)') '-',('---',m=1,lmax),'|',('---------------------------|',i=1,2)
    write(fmtline,'(A,i2,A)') '(1x,',lmax,'A,11x,A,10x,A)'
    write(6,fmtline) ('   ',m=1,lmax),'eigenvectors of the exchange matrix','|'
  else if (exch == 1) then
    write(6,'(A,16A)') '-',('---',m=1,lmax),'|','---------------------------|'
    write(fmtline,'(A,i2,A)') '(1x,',lmax,'A,5x,A,3x,A)'
    write(6,fmtline) ('   ',m=1,lmax),'exchange eigenvector','|'
  end if

  do J=1,exch,4
    jEnd = min(exch,J+3)
    write(6,'(A,16A)') '-',('---',m=1,lmax),'|',('---------------------------|',i=j,jEnd)

    if (lmax == 1) then

      write(6,'(A,5A)') 'Exch|',('      exchange state       |',i=j,jEnd)

      write(6,'(A,6A)') ' bas|',('                           |',i=j,jEnd)
      write(6,'(A,6(a,i5,a))') '    |',('         ',i,'             |',i=j,jEnd)
      write(fmtline,'(A,i2,A)') '(A,',lmax,'i3,a,6(a,f19.12,2x,a))'
      write(6,fmtline) ' ',(i,i=1,lmax),'|',('  E =',w(i)-w(1),' |',i=j,jEnd)

    else if (lmax == 2) then

      write(6,'(A,6A)') 'Exch.  |',('      exchange state       |',i=j,jEnd)
      ...
      write(6,fmtline) ' Exchange |',('      exchange state       |',i=j,jEnd)

      write(6,'(A,6A)') ' basis on |',('                           |',i=j,jEnd)
      write(6,'(A,6(a,i5,a))') '    sites |',('         ',i,'             |',i=j,jEnd)
      write(fmtline,'(A,i2,A)') '(A,',lmax,'i3,a,6(a,f19.12,2x,a))'
      write(6,fmtline) ' ',(i,i=1,lmax),'|',('  E =',w(i)-w(1),' |',i=j,jEnd)
      ...
      write(6,fmtline) ' Exchange','|',('      exchange state       |',i=j,jEnd)
      write(6,fmtline) ' basis on','|',('                           |',i=j,jEnd)
      write(fmtline,'(A,i2,A,i2,A)') '(',nf,'x,A,',nf,'x,A,4(a,i5,a))'
      write(6,fmtline) '    sites','|',('         ',i,'             |',i=j,jEnd)
      write(fmtline,'(A,i2,A)') '(A,',lmax,'i3,a,6(a,f19.12,2x,a))'
      write(6,fmtline) ' ',(i,i=1,lmax),'|',('  E =',w(i)-w(1),' |',i=j,jEnd)

    end if

    write(6,'(A,16A)') '-',('---',m=1,lmax),'|',('----- Real ------- Imag ---|',i=j,jEnd)

    write(fmtline,'(A,i2,A)') '(A,',lmax,'i3,A,5(2F13.9,1x,a))'
    do iss=1,exch
      write(6,fmtline) '<',(ibas(iss,m)+1,m=1,lmax),'|',(Z(iss,i),'|',i=j,jEnd)
    end do  !iss
    write(6,'(A,16A)') '-',('---',m=1,lmax),'|',('---------------------------|',i=j,jEnd)
    write(6,*)
  end do ! j
  ...
  write(6,'(10x,a)') 'Printing of EigenVectors of the Total Magnetic Interaction is Suppressed.'
  write(6,'(10x,a)') 'Set PRLV >=3 to activate printing of this information.'
end if
