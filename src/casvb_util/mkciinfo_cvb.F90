...
#include "main_cvb.fh"
#include "WrkSpc.fh"
integer(kind=iwp) :: k1, k10, k11, k2, k3, k4, k5, k6, k7, k8, k9
...
call mkciinfo2_cvb(iwork(ll(1)),iwork(ll(2)),iwork(ll(3)),iwork(ll(4)),iwork(ll(5)),iwork(ll(6)),work(ll(9)),work(ll(10)), &
                   iwork(k1),iwork(k2),iwork(k3),iwork(k4),iwork(k5),iwork(k6),iwork(k7),iwork(k8),iwork(k9),iwork(k10),iwork(k11))
call mfreei_cvb(k1)
