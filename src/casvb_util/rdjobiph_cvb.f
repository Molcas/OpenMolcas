...
! -------------------
!      integer iadr15_j(15)
!      integer nactel_j,ispin_j,nsym_j,lsym_j,nfro_j(mxsym),
!     >  nish_j(mxsym),nash_j(mxsym),ndel_j(mxsym),
!     >  nbas_j(mxsym)
...
!     >  nrs1_j(mxsym),nrs2_j(mxsym),nrs3_j(mxsym),
!     >  nhole1_j,nelec3_j,ipt2_j
