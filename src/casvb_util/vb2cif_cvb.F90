...
if (nfrag <= 1) then
  call ci2vb2_cvb(work(iaddr_ci(icivec)),cvbdet,iwork(ll(11)),iwork(ll(12)),dum,1)
else
  call dpci2vb_cvb(work(iaddr_ci(icivec)),cvbdet,work(lv(5)),ic,dum,1)
end if
call setcnt2_cvb(icivec,0)

return

end subroutine vb2cif_cvb
