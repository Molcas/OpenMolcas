...
subroutine asonc2_cvb(c,axc,sxc,nvec,civbh,civbs,orbs,gjorb,gjorb2,gjorb3,cvbdet)
...
real(kind=wp) :: c(nvb,nvec), axc(nvb,nvec), sxc(nvb,nvec), civbh(ndet), civbs(ndet), orbs(norb,norb), gjorb(*), gjorb2(*), &
