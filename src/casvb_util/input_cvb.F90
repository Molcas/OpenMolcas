...
integer(kind=iwp) :: i, i2s_min, ibase, iconf, iconf_add, idelstr, ifrag, ifrom, ifsc, ifxstr, ioffs, iorb, ip_cvb, ip_from, &
                     ip_iconfs, ip_symelm, ip_to, iS, isyme, ito, jconf, jorb, kbasiscvb_inp, mxpair, mxdimrel, need, nelcheck, &
                     nmov, noe1
real(kind=wp) :: swap
...
call input2_cvb(iorbrel,mxdimrel,ifxorb,ifxstr,idelstr,iorts,izeta,ip_iconfs,orbs,irdorbs,ip_cvb,ip_symelm,kbasiscvb_inp)
