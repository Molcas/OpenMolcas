...
write(6,formAF) ' Lower triangle uses SPIN function with Snorm=',ssnorm
write(6,formAF) ' Upper triangle uses FULL function with Snorm=',snorm
! DLC
!snorm = one/snorm
!ssnorm = one/ssnorm
...
if ((abs(tot-scheck) > cut) .or. (abs(stot-scheck) > cut)) write(6,formAD) 'WARNING: spins ',stot,tot,scheck
