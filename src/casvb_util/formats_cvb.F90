...
! iprec=8 => formMXP1='(4x,8(5x,i3,4x))'
formMXP1 = '(4x,8('
if (ix1 > 0) then
...
call appendchr_cvb(formMXP1,'))',0)
! iprec=8 => formMXP2='(4x,8(7x,i3,6x))'
formMXP2 = '(4x,8('
if (ix1 > 0) then
