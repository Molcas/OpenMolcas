...
if (ip(3) < 3) return
if (imethod /= 4) then
  write(6,'(/,a)') ' -------- Details of parameters used by 2nd-order optimizer: -------------'
  ...
  write(6,'(a)') ' (3) ... Optimization is close to wrong stationary point.'
  ...
  write(6,'(/,a,/)') ' -------- Details of parameters used by Davidson optimizer: --------------'
