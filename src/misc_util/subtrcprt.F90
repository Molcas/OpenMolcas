...
do i=1,nRowSub
  do j=1,nCol
    Accum1 = Accum1+A(i,j)*A(i,j)
    Accum2 = Accum2+A(i,j)
  end do
end do
write(LuWr,'(E24.17)') Accum1,Accum2
#else
write(LuWr,*)
write(LuWr,'(2X,A)') 'row norms'
write(LuWr,FMT) (DDot_(nCol,A(i,1),nRow,A(i,1),nRow),i=1,nRowSub)
