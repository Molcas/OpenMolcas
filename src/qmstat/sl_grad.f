...
*     <Arguments></Arguments>
*     <Purpose>
*     This subroutine is taken from the Anders program
*     called Diffsph that calculates the coulombic interaction between
*     two Slater-type densities.
*     </Purpose>
*     <Dependencies></Dependencies>
*     <Author>A.Ohrn</Author>
*     <Modified_by>Jose</Modified_by>
*     <Side_Effects></Side_Effects>
*     <Description>
* The subroutine (originally called Coulomb) is taken and simplyfied
...
* classical molecules with a S (charge) slater distribution and a p
* (dipole) distribution and it is not ready for Qmstat purposes.
* Quantum molecule is represented up to L=2. Interaction with
* Multipole distributed Quadrupoles can be treated using a S
...
* xx=1, xy=2, xz=3, yy=4, yz=5 and zz=6
* So the EintSl have to be changed outside the subroutine
* to be adapted to the QmStat order
* xx=1, xy=2, yy=3, xz=4, yz=5 and zz=6
* The subroutine have the Paramenter MxMltp that should be
