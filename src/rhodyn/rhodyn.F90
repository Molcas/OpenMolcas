...
call mma_deallocate(nconf,safe='*')
call mma_deallocate(lroots,safe='*')
call mma_deallocate(ispin,safe='*')
call mma_deallocate(istates,safe='*')
call mma_deallocate(taushift,safe='*')
call mma_deallocate(amp,safe='*')
call mma_deallocate(sigma,safe='*')
call mma_deallocate(omega,safe='*')
call mma_deallocate(phi,safe='*')
call mma_deallocate(pulse_vector,safe='*')

! allocated in prepare part
call mma_deallocate(list_sf_states,safe='*')
call mma_deallocate(list_sf_mult,safe='*')
call mma_deallocate(list_sf_spin,safe='*')
call mma_deallocate(list_so_mult,safe='*')
call mma_deallocate(list_so_spin,safe='*')
call mma_deallocate(list_so_proj,safe='*')
call mma_deallocate(list_so_sf,safe='*')
call mma_deallocate(V_CSF,safe='*')
call mma_deallocate(V_SO,safe='*')
call mma_deallocate(H_CSF,safe='*')
call mma_deallocate(CI,safe='*')
call mma_deallocate(DTOC,safe='*')
call mma_deallocate(E,safe='*')
call mma_deallocate(U_CI,safe='*')
call mma_deallocate(SO_CI,safe='*')
call mma_deallocate(E_SO,safe='*')
call mma_deallocate(E_SF,safe='*')
call mma_deallocate(HTOTRE_CSF,safe='*')
call mma_deallocate(dipole,safe='*')
call mma_deallocate(dysamp,safe='*')
call mma_deallocate(dysamp_bas,safe='*')
call mma_deallocate(HTOT_CSF,safe='*')
call mma_deallocate(CSF2SO,safe='*')
call mma_deallocate(tmp,safe='*')
call mma_deallocate(DM0,safe='*')
call mma_deallocate(HSOCX,safe='*')

! allocated in dynamics part
call mma_deallocate(U_CI_compl,safe='*')
call mma_deallocate(dipole,safe='*')
call mma_deallocate(hamiltonian,safe='*')
call mma_deallocate(hamiltoniant,safe='*')
call mma_deallocate(density0,safe='*')
call mma_deallocate(decay,safe='*')
call mma_deallocate(densityt,safe='*')
call mma_deallocate(dipole_basis,safe='*')
call mma_deallocate(a_einstein,safe='*')
call mma_deallocate(emiss,safe='*')
