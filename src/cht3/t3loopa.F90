...
! if memory is available loops over i,j,k, in subloops can be grouped !!!
      if(nga.eq.ngc) then
!
!mp      call t3_bt_aaa(nug,g(ka),g(ka),g(ka),g(la),g(mi),g(mij),
     ...
     &ifvo)
!mp     $oep(aset+1),enx,g(voa),
!mp     $t1a(noab(isp)*aset+1),t1b(noab(isp)*aset+1),g(t3a),g(t3b),ifvo)
!
      elseif(nga.eq.ngb)then
!mp      call t3_bt_aac(nug,g(ka),g(kb),g(kc),g(la),g(lc),g(mi),g(mij),
...
!mp     $oeh,oep(aset+1),oep(cset+1),enx,g(voa),g(voc),
!mp     $t1a(noab(isp)*aset+1),t1b(noab(isp)*aset+1),
!mp     $t1a(noab(isp)*cset+1),t1b(noab(isp)*cset+1),
!mp     $g(t3a),g(t3b),ifvo)
      elseif(ngb.eq.ngc)then
!mp      call t3_bt_acc(nug,g(ka),g(kb),g(kc),g(la),g(lc),g(mi),g(mij),
...
!mp      call t3_bt_abc(nug,g(ka),g(kb),g(kc),g(la),g(lb),g(lc),g(mi),
!mp     $g(mij),adim,bdim,cdim,N,noab(isp),nuab(isp),nnoab(iuhf),lu,
     ...
     &Work(t3a),Work(t3b),ifvo)
!mp     $oeh,oep(aset+1),oep(bset+1),oep(cset+1),enx,g(voa),g(vob),g(voc),
!mp     $t1a(noab(isp)*aset+1),t1b(noab(isp)*aset+1),t1a(noab(isp)*bset+1),
!mp     $t1b(noab(isp)*bset+1),t1a(noab(isp)*cset+1),t1b(noab(isp)*cset+1),
!mp     $g(t3a),g(t3b),ifvo)
      endif   ! cases
      energ(isp)=energ(isp)+enx
!mp     write (*,'(A,i5,x,3(i3,1x),f21.19)') 'Tsk, nga, ngb, ngc, inc = ',
