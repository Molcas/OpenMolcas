...
!
!SUBROUTINE EX24 EXCHANGE OF THE 2nd and 4th index in a matrix
!
...
!
!S EX24_A EXCHANGE OF THE 2nd and 4th index in a matrix+ADD
!
      IJ=1
      DO J=1,I2
         DO L=1,J1
...
!
!S EX34_A EXCHANGE OF THE 3nd and 4th index in a matrix+ADD
!
      IJ=1
!     DO J=1,I2
      DO L=1,J1
