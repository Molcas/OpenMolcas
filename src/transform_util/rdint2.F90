...
!      Write(6,*) '   <AT/BU> IF ISP.GE.ISR'
!      Write(6,*) '   <AT/UB> IF ISP.GT.ISS AND ISP.NE.ISQ'
!      Write(6,*) '   <TA/BU> IF ISQ.GT.ISR AND ISP.NE.ISQ'
!      Write(6,*) '   <TA/UB> IF ISQ.GE.ISS AND ISP.NE.ISQ'
!      Write(6,*) ' IAD2M(1,iSymIJAB)  COULOMB INTEGRALS <AB|TU>'
!      Write(6,*) ' IAD2M(2,iSymIJAB)  EXCHANGE INTEGRALS <AB|TU> FOR SYM
!     &  T > SYM U'
!      Write(6,*) ' IAD2M(3,iSymIJAB)  EXCHANGE INTEGRALS <AB|TU> FOR SYM
!     &  T < SYM U'
