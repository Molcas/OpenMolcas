...
************************************************************************
      Subroutine MkExSB23(iAddSB,iSymI,iSymJ,iSymA,iSymB, iI,iJ, numV)
************************************************************************
...
*     Generate the SubBlock
      Call DGEMM_('N','T',nSsh(iSymB),nAsh(iSymA),numV,1.0d0,
     &    Work(iAddLy0),nSsh(iSymB), Work(iAddLx0),nAsh(iSymA),
