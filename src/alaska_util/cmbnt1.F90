...
subroutine CmbnT1(Rnxyz,nZeta,la,lb,Zeta,rKappa,rFinal,Txyz,Alpha,Beta,Grad,nGrad,DAO,IfGrad,IndGrd,iStab,jStab,kOp)
!***********************************************************************
          ...
          if (ixa > 0) then
            ...
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,1) = rKappa(iZeta)*( &
                                   (Two*Txyz(iZeta,1,ixa+1,ixb)*Alpha(iZeta)+ &
                                     xa*Txyz(iZeta,1,ixa-1,ixb))* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                   (Two*Rnxyz(iZeta,1,ixa+1,ixb)*Alpha(iZeta)+ &
            ...
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,1) = rKappa(iZeta)*Alpha(iZeta)*( &
                                    Two*Txyz(iZeta,1,ixa+1,ixb)* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                    Two*Rnxyz(iZeta,1,ixa+1,ixb)* &
                                        Txyz(iZeta,2,iya,iyb)* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                    Two*Rnxyz(iZeta,1,ixa+1,ixb)* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
          ...
          if (ixb > 0) then
            ...
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,4) = rKappa(iZeta)*( &
                                   (Two*Txyz(iZeta,1,ixa,ixb+1)*Beta(iZeta)+ &
                                     xb*Txyz(iZeta,1,ixa,ixb-1))* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                   (Two*Rnxyz(iZeta,1,ixa,ixb+1)*Beta(iZeta)+ &
            ...
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,4) = rKappa(iZeta)*Beta(iZeta)*( &
                                    Two*Txyz(iZeta,1,ixa,ixb+1)* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                    Two*Rnxyz(iZeta,1,ixa,ixb+1)* &
                                        Txyz(iZeta,2,iya,iyb)* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                    Two*Rnxyz(iZeta,1,ixa,ixb+1)* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
          ...
          if (iya > 0) then
            ...
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,2) = rKappa(iZeta)*( &
                                   ...
                                   (Two*Rnxyz(iZeta,2,iya+1,iyb)*Alpha(iZeta)+ &
                                     ya*Rnxyz(iZeta,2,iya-1,iyb))* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
                                   (Two*Txyz(iZeta,2,iya+1,iyb)*Alpha(iZeta)+ &
            ...
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,2) = rKappa(iZeta)*Alpha(iZeta)*( &
                                        Txyz(iZeta,1,ixa,ixb)* &
                                    Two*Rnxyz(iZeta,2,iya+1,iyb)* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
                                    Two*Txyz(iZeta,2,iya+1,iyb)* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
                                    Two*Rnxyz(iZeta,2,iya+1,iyb)* &
                                        Txyz(iZeta,3,iza,izb))
          ...
          if (iyb > 0) then
            ...
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,5) = rKappa(iZeta)*( &
                                        Txyz(iZeta,1,ixa,ixb)* &
                                   (Two*Rnxyz(iZeta,2,iya,iyb+1)*Beta(iZeta)+ &
                                     yb*Rnxyz(iZeta,2,iya,iyb-1))* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
                                   (Two*Txyz(iZeta,2,iya,iyb+1)*Beta(iZeta)+ &
            ...
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,5) = rKappa(iZeta)*Beta(iZeta)*( &
                                        Txyz(iZeta,1,ixa,ixb)* &
                                    Two*Rnxyz(iZeta,2,iya,iyb+1)* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
                                    Two*Txyz(iZeta,2,iya,iyb+1)* &
                                        Rnxyz(iZeta,3,iza,izb)+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
                                    Two*Rnxyz(iZeta,2,iya,iyb+1)* &
                                        Txyz(iZeta,3,iza,izb))
          ...
          if (iza > 0) then
            ...
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,3) = rKappa(iZeta)*( &
                                        Txyz(iZeta,1,ixa,ixb)* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
                                   (Two*Rnxyz(iZeta,3,iza+1,izb)*Alpha(iZeta)+ &
                                   ...
                                   (Two*Rnxyz(iZeta,3,iza+1,izb)*Alpha(iZeta)+ &
                                     za*Rnxyz(iZeta,3,iza-1,izb))+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
                                   (Two*Txyz(iZeta,3,iza+1,izb)*Alpha(iZeta)+ &
                                     za*Txyz(iZeta,3,iza-1,izb)))
            end do
          else
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,3) = rKappa(iZeta)*Alpha(iZeta)*( &
                                        Txyz(iZeta,1,ixa,ixb)* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
                                    Two*Rnxyz(iZeta,3,iza+1,izb)+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
                                        Txyz(iZeta,2,iya,iyb)* &
                                    Two*Rnxyz(iZeta,3,iza+1,izb)+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
          ...
          if (izb > 0) then
            ...
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,6) = rKappa(iZeta)*( &
                                        Txyz(iZeta,1,ixa,ixb)* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
                                   (Two*Rnxyz(iZeta,3,iza,izb+1)*Beta(iZeta)+ &
                                   ...
                                   (Two*Rnxyz(iZeta,3,iza,izb+1)*Beta(iZeta)+ &
                                     zb*Rnxyz(iZeta,3,iza,izb-1))+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
                                   (Two*Txyz(iZeta,3,iza,izb+1)*Beta(iZeta)+ &
                                     zb*Txyz(iZeta,3,iza,izb-1)))
            end do
          else
            do iZeta=1,nZeta
              rFinal(iZeta,ipa,ipb,6) = rKappa(iZeta)*Beta(iZeta)*( &
                                        Txyz(iZeta,1,ixa,ixb)* &
                                        Rnxyz(iZeta,2,iya,iyb)* &
                                    Two*Rnxyz(iZeta,3,iza,izb+1)+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
                                        Txyz(iZeta,2,iya,iyb)* &
                                    Two*Rnxyz(iZeta,3,iza,izb+1)+ &
                                        Rnxyz(iZeta,1,ixa,ixb)* &
