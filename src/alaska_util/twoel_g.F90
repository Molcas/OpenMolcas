...
subroutine TwoEl_g(Coor,iAO,iStb,jStb,kStb,lStb,nRys, &
                   k2Data1,k2Data2, &
...
implicit none
integer(kind=iwp), intent(in) :: iAO(4), iStb, jStb, kStb, lStb, nRys, nData1, nData2, &
...
integer(kind=iwp) :: iC, iCar, iCent, iCmpa, iDCRR(0:7), iDCRS(0:7), iDCRT(0:7), iDCRTS, iEta, iiCent, ijklab, ijMax, ijMin, ikl, &
                     ...
                     nW2, nW4, nWrk3, nZeta_Tot, iAnga(4), iCmp(4), iShll(4), iShell(4)
