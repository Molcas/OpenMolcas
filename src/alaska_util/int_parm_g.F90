...
subroutine Int_Parm_g(iSD4,nSD,iCmpa,iShlla,iShela,iPrimi,jPrimj,kPrimk,lPriml, &
...
integer(kind=iwp), intent(out) :: iCmpa(4), iShlla(4), iShela(4), iPrimi, jPrimj, kPrimk, lPriml, k2ij, ik2, nDCRR, &
