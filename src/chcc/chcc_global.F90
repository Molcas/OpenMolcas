...
!
!
!2        position of Permanent arrays
!
!        Fock matrix             - PosFoo,PosFvv,PosFvo
!        Orbital energies        - PosOE
!        T1 amplitudes, old, new - PosT1o,PosT1n
...
!        position of Free space - PosFree
!
        integer PosFoo,PosFvv,PosFvo,PosOE,PosT1o,PosT1n
        integer PosHoo,PosHvv,PosHvo,PosGoo,PosGvv
        integer PosA,PosAex
        integer PosFree
!
        common /ccsd2/ PosFoo,PosFvv,PosFvo,PosOE,PosT1o,               &
     &                 PosT1n,PosHoo,PosHvv,PosHvo,PosGoo,PosGvv,       &
     &                       PosA,PosAex,                               &
     &                 PosFree
!
!
...
!
         integer no_t,nv_t
         parameter (no_t=4)
         ! IFG: nv_t and nc_t arbitrarily reduced. If larger sizes
         ...
         parameter (nc_t=10)
!
         real*8 T1c(nv_t,no_t),T2c(nv_t,nv_t,no_t,no_t)
         real*8 OEo(no_t),OEv(nv_t)
         real*8 Q0(no_t,no_t,no_t,no_t)
         real*8 Q1(nv_t,no_t,no_t,no_t)
         real*8 Q21(nv_t,no_t,nv_t,no_t)
         real*8 Q22(nv_t,nv_t,no_t,no_t)
         real*8 Q3(nv_t,nv_t,nv_t,no_t)
         real*8 Q4(nv_t,nv_t,nv_t,nv_t)
         real*8 L0k(nc_t,no_t,no_t)
         real*8 L1k(nc_t,no_t,nv_t)
         real*8 L2k(nc_t,nv_t,nv_t)
!
         real*8 Jc(nv_t,no_t,no_t,nv_t)
         real*8 Kc(no_t,nv_t,no_t,nv_t)
         real*8 Ac(no_t,no_t,no_t,no_t)
         real*8 Bc(nv_t,nv_t,nv_t,nv_t)
         real*8 Hooc(no_t,no_t)
         real*8 Hvvc(nv_t,nv_t)
         real*8 Hvoc(nv_t,no_t)
         real*8 Gooc(no_t,no_t)
         real*8 Gvvc(nv_t,nv_t)
!
