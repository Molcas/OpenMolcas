...
!***********************************************************************
        subroutine Chck_W4                                              &
     &  (W4,dima,dimbe,dimb,dimga,adda,addbe,addb,addga)
!    c  (W4,dima,dimga,dimb,dimbe,adda,addga,addb,addbe)
!
!        this routine test W4
!
        implicit none
#include "chcc1.fh"
...
!          if (abs(W4(a,ga,b,be)-s).gt.1.0d-10) then
            bad=bad+1
!            W4(a,be,b,ga)=s
          end if
          ntot=ntot+1
