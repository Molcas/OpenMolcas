...
subroutine DistMemo3v3chol(NvGrp,maxdim,PosV1,PosV2,PosV3,PosV4,PosH1,PosH2,PosH3,PosH4,PosM1,PosM2,PosM3,PosM4,PosM5,PosK,PosQ, &
                           PosT)
! This routine does:
...
PosM3 = PosT
PosT = PosT+length
if (printkey >= 10) write(6,*) 'DM M3 ',PosM3,length
length = no*nc*no
PosM4 = PosT
PosT = PosT+length
if (printkey >= 10) write(6,*) 'DM M4 ',PosM4,length
length = no*nc*maxdim
PosM5 = PosT
PosT = PosT+length
if (printkey >= 10) write(6,*) 'DM M5 ',PosM5,length
