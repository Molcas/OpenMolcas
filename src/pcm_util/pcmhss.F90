...
implicit none
#include "hss_interface.fh"
integer(kind=iwp) :: iAlpha, iAnga(4), iAtom, iBeta, iCar, iDAO, iDCRT(0:7), idx(3,4), iIrrep, ipA, ipAOff, ipB, ipBOff, ipDAO, &
                     iStb(0:7), iTs, iuvwx(4), iZeta, jAtom, jCar, JndGrd(0:2,0:3,0:7), JndHss(0:3,0:2,0:3,0:2,0:7), lDCRT, LmbdT, &
                     mOp(4), nArray, nDAO, nDCRT, nFinal, nip, nla, nlb, nOOp, nStb
