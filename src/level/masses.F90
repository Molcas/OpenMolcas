...
!
     ...
     &         42.9587666d0, 43.9554818d0, 45.9536926d0, 47.952534d0/
...
!
     ...
     &         47.9479463d0, 48.9478700d0, 49.9447912d0/
...
!
     ...
     &         60.9310560d0, 61.9283451d0, 63.9279660d0/
...
!
     ...
     &         66.9271273d0, 67.9248442d0, 69.9253193d0/
...
!
     ...
     &         72.9234589d0, 73.9211778d0, 75.9214026d0/
...
!
     ...
     &         76.9199140d0, 77.9173091d0, 79.9165213d0, 81.9166994d0/
...
!
     ...
     &          81.9134836d0, 82.914136d0, 83.911507d0, 85.91061073d0/
...
!
     ...
     &                      91.9050408d0, 93.9063152d0, 95.9082734d0/
...
!
     ...
     &        94.9058421d0, 95.9046795d0, 96.9060215d0, 97.9054082d0,   &
     &        99.907477d0/
...
!
     ...
     &     98.9059393d0, 99.9042195d0, 100.9055821d0, 101.9043493d0,    &
     &     103.905433d0/
...
!
     ...
     &       104.905085d0, 105.903486d0, 107.903892d0, 109.905153d0/
...
!
     ...
     &       109.9030021d0, 110.9041781d0, 111.9027578d0, 112.9044017d0,&
     &       113.9033585d0, 115.904756d0/
      DATA (ns2(48,i),i=1,8)/0,0,0,1,0,1,0,0/
      DATA (ab(48,i),i=1,8)/1.25d0, 0.89d0, 12.49d0, 12.80d0, 24.13d0,  &
     &                      12.22d0, 28.73d0, 7.49d0/
!
...
!
     ...
     &     114.903342d0, 115.901741d0, 116.902952d0, 117.901603d0,      &
     &     118.903308d0, 119.9021947d0, 121.9034390d0, 123.9052739d0/
      DATA (ns2(50,i),i=1,10)/0,0,1,0,1,0,1,0,0,0/
      DATA (ab(50,i),i=1,10)/0.97d0, 0.65d0, 0.34d0, 14.53d0, 7.68d0,   &
     &                       24.23d0, 8.59d0, 32.59d0, 4.63d0, 5.79d0/
!
...
!
     ...
     &    122.9042700d0, 123.9028179d0, 124.9044307d0, 125.9033117d0,   &
     &    127.9044631d0, 129.9062244d0/
      DATA (ns2(52,i),i=1,8)/0,0,1,0,1,0,0,0/
      DATA (ab(52,i),i=1,8)/0.096d0, 2.603d0, 0.908d0, 4.816d0,         &
     &                      7.139d0, 18.95d0, 31.69d0, 33.80d0/
!
...
!
     ...
     &    127.9035313d0, 128.9047794d0, 129.9035080d0, 130.9050824d0,   &
     &    131.9041535d0, 133.9053945d0, 135.907219d0/
      DATA (ns2(54,i),i=1,9)/0,0,0,1,0,3,0,0,0/
      DATA (ab(54,i),i=1,9)/0.10d0, 0.09d0, 1.91d0, 26.4d0, 4.1d0,      &
     &                      21.2d0, 26.9d0, 10.4d0, 8.9d0/
!
...
!
     ...
     &    143.9100873d0, 144.9125736d0, 145.9131169d0, 147.916893d0,    &
     &    149.920891d0/
...
!
     ...
     &    147.9148227d0, 148.9171847d0, 149.9172755d0, 151.9197324d0,   &
     &    153.9222093d0/
...
!
     ...
     &    154.9226220d0, 155.9221227d0, 156.9239601d0, 157.9241039d0,   &
     &    159.9270541d0/
...
!
     ...
     &    159.9251975d0, 160.9269334d0, 161.9267984d0, 162.9287312d0,   &
     &    163.9291748d0/
...
!
     ...
     &    165.9302931d0, 166.9320482d0, 167.9323702d0, 169.9354643d0/
...
!
     ...
     &    170.936323580d0, 171.9363815d0, 172.9382108d0, 173.9388621d0, &
     &    175.9425717d0/
...
!
     ...
     &    176.9432207d0, 177.9436988d0, 178.9458161d0, 179.9465500d0/
...
!
     ...
     &    182.9502230d0, 183.9509312d0, 185.9543641d0/
...
!
     ...
     &    186.9557505d0, 187.9558382d0, 188.9581475d0, 189.9584470d0,   &
     &    191.9614807d0/
...
!
     ...
     &    193.9626803d0, 194.9647911d0, 195.9649515d0, 197.967893d0/
...
!
     ...
     &    198.9682799d0, 199.9683260d0, 200.9703023d0, 201.9706430d0,   &
     &    203.9734939d0/
