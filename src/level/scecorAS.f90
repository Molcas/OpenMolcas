...
!
     ...
     &  KVDIF,NDP,NCN,IDIF,BRUTE,IB,IWR
      REAL*8 EO,DE0,RH,BFCT,ARG2,ARG3,EINT,VPH1,VPH2,DGDV1,DGDV2,DGDVM, &
     &  DGDV2P,DGDVB,DGDVBP,EBRUTE,DEBRUTE,DE1,DE2,Y1,Y2,Y3,RT,ANS1,    &
     &  ANS2,XDIF,VLIM,BMAX,Pi,Pi2,PNCN,PP1,V(NDP),SDRDY(NDP)
...
!     RETURN
  ...
  610 FORMAT(' Double well   E(v=',i3,', J=',I3,')=',f9.3,              &
     & ':   v1(SC)=',F7.3,'   dGdv1=',f8.2/8x,'seeking  v=',I3,         &
     & ' (ICOR=',I2,')',8x,':   v2(SC)=',F7.3,'   dGdv2=',f8.2 )
      END
