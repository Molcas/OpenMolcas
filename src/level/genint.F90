...
602 format(' *** CAUTION ** inward extrapolation exponent coefficient C=',D12.4/10x,'could cause overflows, ... so ...')
604 format(' *** CAUTION ** after 15 tries inward extrap. exponent coefft change is',1PD9.1)
606 format(' Extrapolate to   X <=',F7.4,'  with'/'   Y=',F13.3,SP,1PD15.6,' * exp(',SS,D13.6,'*X)')
608 format(' Extrapolate to   X <=',F8.4,'   with'/'   Y=',F13.3,SP,1PD16.7,' * [X - (',SS,F8.4,')]')
610 format(' Extrapolate to  X <=',F8.4,'   with   Y=',F12.3,SP,1PD15.6,')/X**1')
...
614 format(' Function for  X >=',F8.4,'   generated as'/'   Y=',F12.4,' - (',1PD13.6,') * exp{-',0PF10.6,' * (r -',F9.6,')**2}')
616 format(' Function for  X >=',F8.4,'   generated as'/'   Y=',F12.4,' - (',1PD13.6,') * r**',0PF10.6,'  * exp{-(',F11.6,'*r)}')
618 format(' Extrapolate to  X >=',F8.4,'  using'/'   Y=',F12.4,SP,1PD15.6,'/X**(',SS,D13.6,')] ,  yielding   NCN=',I3)
620 format(' Extrapolate to  X >=',F8.4,'  using'/'   Y=',F12.4,' - [',1PD13.6,'/X**',I1,SP,D14.6,'/X**',SS,I1,']')
622 format(' Extrapolate to  X >=',F8.4,'  using'/'   Y=',F12.4,' - [',1PD13.6,'/X**',I1,SP,D14.6,'/X**',SS,I1,SP,D14.6,'/X**', &
           SS,I2,']')
