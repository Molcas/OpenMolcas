...
!*** Simplified version of AF3x3potRet which does not return derivatives
     ...
     &        DEIGDe(1,1), EIGVEC(3,1), W(3)
      REAL*8  RDIST,RDIST2,RDIST3,DELTAE,C3val,C6val,C8val,De,ULR,      &
     &   RET,RETSig,RETPi,Modulus,M1,M3,M5,Z
      INTEGER          I,J,L
      M1= C3val
      M3= C6val
      M5= C8val
...
!  Initialize interaction matrix to 0.d0
      DO  I= 1,3
          H(I,I)=0.0D0
          ENDDO
!cccc Prepare interation matrix  H
      ...
      H(3,2)= H(2,3)
      H(3,3)= DELTAE
!ccccc Prepare radial derivative of interaction matrix (? is it needed ?)
      DR(1,1)= (3.d0*M1*RETSig + 6.d0*M3/RDIST3                         &
     &                  + 8.D0*M5/(RDIST3*RDIST2))/(3.d0*RDIST3*RDIST)
      ...
      DR(3,2)= DR(2,3)
      DR(3,3)= 0.d0
!ccccc Partial derivative of interaction matric  H  w.r.t.  C3
      ...
      DM1(3,2)= DM1(2,3)
      DM1(3,3)= 0.d0
!ccccc Partial derivative of interaction matric  H  w.r.t.  C6
      ...
      DM3(3,2)= DM3(2,3)
      DM3(3,3)= 0.D0
!ccccc Partial derivative of interaction matric  H  w.r.t.  C8
      ...
      DM5(3,2)= DM5(2,3)
      DM5(3,3)= 0.D0
!ccccc Partial derivative of interaction matric  H  w.r.t.  De
      ...
      DDe(3,2)= DDe(2,3)
      DDe(3,3)= 0.D0
!ccccc Call subroutine to prepare and invert interaction matrix  H
      CALL ZHEEVJ3(H,Q,W)
      L=1
!cc Nor - identify the lowest eigenvalue of  H  and label it  L
      DO J=2,3
          IF (W(J) .LT. W(L)) THEN
              L=J
              ENDIF
