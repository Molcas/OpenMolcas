...
integer(kind=iwp) :: i, iAng, iBas, iBasAO, ibasI, iBasn, iBsInc, iCmp, iCnt, iCnttp, id, id_Tsk, idd, ider, iDisk, iDisp, &
                     iFnc(4), iii, iIrr, iIrrep, ij, ijSh, ip, ipDum, ipFin, ipMem, ipMem2, ipMem3, ipMem4, ipMemX, ipMOC, ipPSO, &
                     iPrim, iS, iSD4(0:nSD,4), iShll, jBas, jBasAO, jBasj, jBasn, jBsInc, jCmp, jCnt, jCnttp, jDisp, jIrr, &
                     JndGrd(3,4,0:7), JndHss(4,3,4,3,0:7), js, kBasAO, kBask, kBasn, kBsInc, kCmp, kCnt, kCnttp, kIrr, klSh, ks, &
                     lBasAO, lBasl, lBasn, lBsInc, lCmp, lCnt, lCnttp, ls, mDeDe, Mem1, Mem2, Mem3, Mem4, MemBuffer, MEMCMO, &
                     memCMO2, MemFck, MemFin, MemMax, MemPrm, MemPSO, MemX, mIndij, mmdede, moip(0:7), MxBsC, n_Int, nAco, nb, &
                     ndisp, nijkl, nijS, nIndij, nMO, nPairs, nQuad, nRys, nSkal, nSO, nTemp, nTwo, nTwo2
