...
subroutine TwoEl_mck(Coor,iShell,iShll,iAOst,iStb,jStb,kStb,lStb,nRys,nData1,nData2, &
                     k2Data1,k2Data2, &
                     Pren,Prem,nAlpha,nBeta,nGamma,nDelta, &
...
implicit none
integer(kind=iwp), intent(in) :: iShell(4), iShll(4), iAOst(4), iStb, jStb, kStb, lStb, nRys, nData1, &
                                 nData2, nAlpha, nBeta, nGamma, nDelta, iBasi, jBasj, kBask, lBasl, &
...
integer(kind=iwp) :: iCar, iCmpa, iCNT, iDCRR(0:7), iDCRS(0:7), iDCRT(0:7), iDCRTS, iEta, iIrr, IncEta, IncZet, Indx(3,4), ip, &
                     ...
                     iAO(4), iCmp(4), iAngV(4), jPrInc, lPrInc
