...
subroutine Clr2(XrIn,rOut,icmp,jcmp,iaoi,iaoj,nACO,nSD,iSD4,nDisp,nTemp,Temp)
...
implicit none
integer(kind=iwp), intent(in) :: icmp, jcmp, iaoi, iaoj, nACO, nSD, iSD4(0:nSD,4), nDisp, nTemp
