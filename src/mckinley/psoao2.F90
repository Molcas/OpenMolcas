...
subroutine PSOAO2(nSO,MemPrm,MemM,iFnc,nAco,Mem1,Mem2,Mem3,Mem4,MemX,MemPSO,MemFck,nFT,nCMO,MemFin,MemBuffer,nSD,iSD4)
!***********************************************************************
!                                                                      *
...
integer(kind=iwp) :: i1, iAO(4), iBas, iBsInc, iCmp, iCmpa(4), iFac, iiBas(4), iPrim, iPrInc, iTmp1, j, jBas, jBsInc, jCmp, jPam, &
                     ...
                     nijkl, nMax, nMaxC, nPam(4,0:7), nTmp1, nTmp2
