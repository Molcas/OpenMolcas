...
subroutine Picky_(iBasi,iBsInc,iPrimi,iBasAO,iBasn,jBasj,jBsInc,jPrimj,jBasAO,jBasn,iCmpi,jCmpj,iShell,jShell,mDCRij,ipDij,ipDDij, &
                  mDij,DeDe,nDeDe)
...
if (mDCRij /= 0) then
  ...
  if ((iBasi == iBsInc) .and. (jBasj == jBsInc)) then
    ...
    call Picky(DeDe(ipDij),i1,j1,iPrimi*jPrimj,iCmpi*jCmpj,mDCRij,i2,i2+i3-1,j2,j2+j3-1,DeDe(ipDDij))
  end if
end if
