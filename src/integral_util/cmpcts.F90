...
subroutine CmpctS(abcd,na,nb,nijkl,mijkl,Zeta,Kappab,P,Ind_Pair,Con,xZeta,xKapp,xP,IndZ,iOff,Jnd,xZInv,AeqB,xab,xabCon,Alpha, &
                  xAlpha,Beta,xBeta)
!***********************************************************************
!                                                                      *
...
if (Jnd < -1) call RecPrt('Cmpct:Zeta',' ',Zeta,mijkl,1)
#endif
