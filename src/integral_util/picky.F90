...
subroutine Picky(iBasi,iBsInc,iPrimi,iBasAO,iBasn,jBasj,jBsInc,jPrimj,jBasAO,jBasn,iShell,jShell,mDCRij,ipDij,ipDDij, &
...
implicit none
integer(kind=iwp), intent(in) :: iBasi, iBsInc, iPrimi, iBasAO, iBasn, jBasj, jBsInc, jPrimj, jBasAO, jBasn, iShell, &
