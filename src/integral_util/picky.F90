...
subroutine Picky(iBasn,jBasn,mDCRij,ipDij,ipDDij, &
...
implicit none
integer(kind=iwp), intent(in) :: iBasn, jBasn, mDCRij, ipDij, nDeDe,i,j,nSD,iSD4(0:nSD,4)
...
integer(kind=iwp) :: iBasAO, jBasAO
