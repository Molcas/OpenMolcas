...
do iBasAO=1,iBasi,iBsInc
  ...
  do jBasAO=1,jBasj,jBsInc
    ...
    if (DoFock) call Picky_(iBasi,iBsInc,iPrimi,iBasAO,iBasn,jBasj,jBsInc,jPrimj,jBasAO,jBasn,iCmpV(1),iCmpV(2),iShelV(1), &
    ...
    do kBasAO=1,kBask,kBsInc
      ...
      if (DoFock) then
        call Picky_(iBasi,iBsInc,iPrimi,iBasAO,iBasn,kBask,kBsInc,kPrimk,kBasAO,kBasn,iCmpV(1),iCmpV(3),iShelV(1),iShelV(3), &
                    mDCRik,ipDik,ipDDik,mDik,DeDe,nDeDe)

        call Picky_(jBasj,jBsInc,jPrimj,jBasAO,jBasn,kBask,kBsInc,kPrimk,kBasAO,kBasn,iCmpV(2),iCmpV(3),iShelV(2),iShelV(3), &
      ...
      do lBasAO=1,lBasl,lBsInc
        ...
        if (DoFock) then
          call Picky_(kBask,kBsInc,kPrimk,kBasAO,kBasn,lBasl,lBsInc,lPriml,lBasAO,lBasn,iCmpV(3),iCmpV(4),iShelV(3),iShelV(4), &
                      mDCRkl,ipDkl,ipDDkl,mDkl,DeDe,nDeDe)

          call Picky_(iBasi,iBsInc,iPrimi,iBasAO,iBasn,lBasl,lBsInc,lPriml,lBasAO,lBasn,iCmpV(1),iCmpV(4),iShelV(1),iShelV(4), &
                      mDCRil,ipDil,ipDDil,mDil,DeDe,nDeDe)

          call Picky_(jBasj,jBsInc,jPrimj,jBasAO,jBasn,lBasl,lBsInc,lPriml,lBasAO,lBasn,iCmpV(2),iCmpV(4),iShelV(2),iShelV(4), &
