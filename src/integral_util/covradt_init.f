...
!
       ...
       End Do
!
!     Original radii - totally weird
!      Data CovRadT_/
!     & 0.00d0,
!     & 0.32d0,                                              0.93d0,
!     & 1.23d0,.90d0,     0.82d0,0.77d0,0.75d0,0.73d0,0.72d0,0.71d0,
!     & 1.54d0,.36d0,     1.18d0,1.11d0,1.06d0,1.02d0,0.99d0,0.98d0,
!     & 2.03d0,.74d0,
!     &              1.44d0,1.32d0,1.22d0,1.18d0,1.17d0,
!     &              1.17d0,1.16d0,1.15d0,1.17d0,1.25d0,
...
!     From: H.B. Schlegel, TCA, 66, 333 (1984).
!     Data CovRadT/
!    &  0.0d0,
!    &  0.32D0,0.60D0,
!    &  1.2D0,1.05D0,0.81D0,0.77D0,2*0.74D0,2*0.72D0,
!    &  1.5D0,1.40D0,1.30D0,1.17D0,1.10D0,1.04D0,2*0.99D0,
!    &  1.8D0,1.60D0,11*1.4D0,1.3D0,2*1.2D0,2*1.1D0/
!
      Return
      End
