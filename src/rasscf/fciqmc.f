...
!>    the RDMs are read from previous runs.
     ...
     &      this, actual_iter, iroot, weight, CMO, DIAF, D1I_AO, D1A_AO,
...
! Run NECI
     ...
     &      GAS_spaces, GAS_particles, tGUGA)
     ...
     &                                  h5_fcidmp, energy_file, tGUGA)
        ...
        call read_neci_RDM(iroot, weight, tGUGA,
