...
use general_data, only: CleanMask, CRPROJ, CRVec, INVEC, ISPIN, LOWDIN_ON, MALTER, MAXALTER, NACTEL, &
                        ...
                        NGAS, NGSSH
use spinfo, only: I2ELIMINATED_IN_GAS, I_ELIMINATE_GAS, IELIMINATED_IN_GAS, IGSOCCX_MOLCAS=>IGSOCCX, &
                  ...
                  NGAS_MOLCAS=>NGAS, NGSSH_MOLCAS=>NGSSH, NROOTS_MOLCAS=>NROOTS, NSYM_MOLCAS=>NSYM, &
