...
if (KeyPRIN) then
  ...
  read(LUInput,*,end=9910,err=9920) j,IPRGLB_IN,(IPRLOC_IN(I),I=1,7)
...
if (ifvb == 2) then
  ...
  if (DBG) then
    ...
    write(u6,*) ' Bypass usual input processing, GoTo 100!'
  end if
end if
if (ifvb == 2) goto 100
...
if (DBG) then
  ...
  write(u6,*) 'KeyCORE,KeyJOBI,KeyLUMO:',KeyCORE,KeyJOBI,KeyLUMO
end if
...
if (DBG) write(u6,*) 'KeyCORE,KeyJOBI,KeyLUMO:',KeyCORE,KeyJOBI,KeyLUMO
...
if (KeyITER) then
  ...
  if (DBG) then
    ...
    if (KeyCION) write(u6,*) ' (Irrelevant, since the CIONLY keyword was also given)'
  end if
  call ChkIfKey()
end if
...
if (DBG) write(u6,*) ' After 100 CONTINUE.'
...
if (IPRLEV >= TERSE) write(u6,*) ' Error exit 9910 from PROC_INP.'
iRc = _RC_INPUT_ERROR_
Go to 9900
...
call WarningMessage(2,ReadStatus)
if (IPRLEV >= TERSE) write(u6,*) ' Error exit 9920 from PROC_INP.'
iRc = _RC_INPUT_ERROR_
Go to 9900
...
call WarningMessage(2,ReadStatus)
if (IPRLEV >= TERSE) then
  write(u6,*) ' Error exit 9930 from PROC_INP.'
