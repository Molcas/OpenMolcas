...
C
      ...
      CALL DRT0 (IA0,IB0,IC0,NVERT0,IWORK(LDRTP),IWORK(LDOWNP),
     *           NTMP,IWORK(LTMP))
...
C
      IF(IPRINT.ge.DEBUG) THEN
        ...
        CALL PRDRT(NVERT0,IWORK(LDRTP),IWORK(LDOWNP))
      ENDIF
C
...
C
      IF(IFCAS.NE.0) THEN
        ...
        CALL RESTR(IWORK(LDRT0),IWORK(LDOWN0),IWORK(LV))
C
...
C
        ...
        CALL DRT(IWORK(LDRT0),IWORK(LDOWN0),IWORK(LV),
...
C
        IF(IPRINT.ge.DEBUG) THEN
          ...
          CALL PRDRT(NVERT,IWORK(LDRT),IWORK(LDOWN))
        ENDIF
C
...
C
      ...
      CALL MKDAW(IWORK(LDOWN),IWORK(LDAW),IPRINT)
C
...
C
      ...
      CALL MKRAW(IWORK(LDOWN),IWORK(LUP),IWORK(LRAW),IPRINT)
C
C     COMPUTE MIDLEVEL AND LIMITS ON MIDVERTICES
C
      NLTV=NLEV+2
      CALL GETMEM('LTV1','ALLO','INTEG',LLTV,NLTV)
      CALL MKMID(IWORK(LDRT),IWORK(LDAW),IWORK(LRAW),IWORK(LLTV),IPRINT)
...
C
      ...
      CALL MKCOT(NSM,IWORK(LDOWN),NOW1,IOW1,
...
C
      ...
      CALL MKSGNUM(IWORK(LDOWN),IWORK(LUP),IWORK(LDAW),IWORK(LRAW),
