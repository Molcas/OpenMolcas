...
if (IPRLEV >= USUAL) then
  ...
  write(u6,'(6X,A25,45X,F10.3)') 'Integrated total density:',Dens_I
  write(u6,'(6X,A58,12X,F10.3)') 'Integrated alpha density before functional transformation:',Dens_a1
  write(u6,'(6X,A58,12X,F10.3)') 'Integrated  beta density before functional transformation:',Dens_b1
  write(u6,'(6X,A58,12X,F10.3)') 'Integrated alpha density  after functional transformation:',Dens_a2
  write(u6,'(6X,A58,12X,F10.3)') 'Integrated  beta density  after functional transformation:',Dens_b2
  write(u6,'(6X,80A)')
  write(u6,'(6X,A32,30X,F18.6)') 'Integrated alpha exchange energy',Funcaa
  write(u6,'(6X,A32,30X,F18.6)') 'Integrated beta  exchange energy',Funcbb
  write(u6,'(6X,A32,30X,F18.6)') 'Integrated  correlation   energy',Funccc
  write(u6,'(6X,80A)')
  write(u6,'(6X,A20,42X,F18.8)') 'Total CAS-DFT energy',CASDFT_E
