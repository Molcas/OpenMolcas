...
*
      ...
      Return
      End
      Subroutine Do_Rho9a(Rho,nRho,mGrid,
     &                    DAij,
...
*
      ...
      Return
      End
      Subroutine Do_Rho9_(Rho,nRho,mGrid,
     &                    DAij,DBij,
     &                    mAO,TabAO1,iBas,iBas_Eff,iCmp,
     &                        TabAO2,jBas,jBas_Eff,jCmp,
     &                    Fact,T_X,TMax_ij,Index_i,Index_j)
...
*
      Return
      End
      Subroutine Do_Rho9a_d(Rho,nRho,mGrid,
     &                    DAii,
     &                    mAO,TabAO1,iBas,iBas_Eff,iCmp,
...
*
      ...
      Return
      End
      Subroutine Do_Rho9_d(Rho,nRho,mGrid,
     &                     DAii,DBii,
     &                     mAO,TabAO1,iBas,iBas_Eff,iCmp,
     &                     Fact,T_X,TMax_ii,Index_i)
      Implicit Real*8 (A-H,O-Z)
