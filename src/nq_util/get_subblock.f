...
#endif
!
!        Note that in gradient calculations we process the grid points
!        for each atomic grid seperately in order to used the
!        translational invariance on the atomic contributions to the
!        gradient.
!
         nTotGP_Save = nTotGP
