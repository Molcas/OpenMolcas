...
*
      ...
      Return
      End
      Subroutine Do_Rho5da(dRho_dR,     mGrid,nGrad_Eff,
     &                     DAij,          mAO,
...
#include "real.fh"
#include "WrkSpc.fh"
      Real*8 dRho_dR(  5,mGrid,nGrad_Eff), DAij(iBas*iCmp,jBas*jCmp),
...
*
      Return
      End
      Subroutine Do_Rho5d_(dRho_dR,     mGrid,nGrad_Eff,
     &                     DAij,DBij,     mAO,
     &                     TabAO1,iBas,iBas_Eff,iCmp,
     &                     TabAO2,jBas,jBas_Eff,jCmp,
     &                     Fact,IndGrd_Eff,T_X,TMax_ij,
...
#include "real.fh"
#include "WrkSpc.fh"
      Real*8 dRho_dR(  10,mGrid,nGrad_Eff),
