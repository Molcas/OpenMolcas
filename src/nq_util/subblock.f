...
!                                                                      *
      ...
      iEnd_R=1
!     Write (*,*)
!     Write (*,*) 'Start range:',iEnd_R, iStart_R
      If (.Not.Check(iOpt_Angular,2)) Then
!        Write (*,*) 'Find R subrange!'
!
...
!
      ...
      iEnd_R  =iR_End
      iSet=-1
!     Write (*,*) 'Actual range:',iEnd_R, iStart_R
!                                                                      *
!***********************************************************************
!                                                                      *
...
!
!        Write (*,*) 'Selected range:',iR_End, iR_Start
!        Write (*,*) 'l_max=',Info_Ang(iSet)%L_Eff
!                                                                      *
!***********************************************************************
!                                                                      *
!---- Angular loop
