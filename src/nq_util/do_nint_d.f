...
!        Grid_AO contains
!        1: phi_i dF/dRho
!        2: {Grad(phi_i GradRho} 2 (dF/dSigma)
!
!        Final integral assembled as, done in do_nIntx.
!
!        Grid_AO(1)_i phi_j
...
!        If (Rho(1,iGrid)<Thr) Cycle
         ...
         Do iCB = 1, nBfn
            ...
            Grid_AO(2,iGrid,iCB,1) = TabAO1(2,iGrid,iCB) * Temp1
...
!
!        Grid_AO contains
!        1: phi_i dF/dRho + {Grad(phi_i) GradRho} 2 (dF/dSigma)
!        2: phi_i 2 (dF/dSigma) GradRho_x
!          +Grad(phi_i)_x dF/dTau
!        3: phi_i 2 (dF/dSigma) GradRho_y
!          +Grad(phi_i)_y dF/dTau
!        4: phi_i 2 (dF/dSigma) GradRho_z
!          +Grad(phi_i)_z dF/dTau
!
!        Final integral assembled as, done in do_nIntx.
!
!        Grid_AO(1)_i phi_j
...
!        1: phi_i dF/dRho + {Grad(phi_i) GradRho} 2 (dF/dSigma)
!        2: phi_i 2 dF/dSigma GradRho_x
!          +Grad(phi_i)_x (dF/dTau + 2 dF/dLapl)
!        3: phi_i 2 (dF/dSigma) GradRho_y
!          +Grad(phi_i)_y (dF/dTau + 2 dF/dLapl)
!        4: phi_i 2 (dF/dSigma) GradRho_z
!          +Grad(phi_i)_z (dF/dTau + 2 dF/dLapl)
!        5: Lapl(phi_i) dF/dLapl
!
!        Final integral assembled as, done in do_nIntx.
!
!        Grid_AO(1)_i phi_j
...
!        If (Rho(1,iGrid)<Thr) Cycle
     ...
     &                             + TabAO1(4,iGrid,iCB) * Temp3
            Grid_AO(2,iGrid,iCB,1) = TabAO1(1,iGrid,iCB) * Temp1
     &                             + TabAO1(2,iGrid,iCB) * Temp45
            Grid_AO(3,iGrid,iCB,1) = TabAO1(1,iGrid,iCB) * Temp2
     &                             + TabAO1(3,iGrid,iCB) * Temp45
            Grid_AO(4,iGrid,iCB,1) = TabAO1(1,iGrid,iCB) * Temp3
     &                             + TabAO1(4,iGrid,iCB) * Temp45
            Grid_AO(5,iGrid,iCB,1) =(TabAO1(5,iGrid,iCB)
     &                              +TabAO1(8,iGrid,iCB)
...
*
     ...
     &                             + TabAO1(4,iGrid,iCB) * Temp3a
            Grid_AO(2,iGrid,iCB,1) = TabAO1(1,iGrid,iCB) * Temp1a
     &                             + TabAO1(2,iGrid,iCB) * Temp45a
            Grid_AO(3,iGrid,iCB,1) = TabAO1(1,iGrid,iCB) * Temp2a
     &                             + TabAO1(3,iGrid,iCB) * Temp45a
            Grid_AO(4,iGrid,iCB,1) = TabAO1(1,iGrid,iCB) * Temp3a
     &                             + TabAO1(4,iGrid,iCB) * Temp45a
            Grid_AO(5,iGrid,iCB,1)=(TabAO1(5,iGrid,iCB)
     &                             +TabAO1(8,iGrid,iCB)
...
*
     ...
     &                             + TabAO1(4,iGrid,iCB) * Temp3b
            Grid_AO(2,iGrid,iCB,2)= TabAO1(1,iGrid,iCB) * Temp1b
     &                            + TabAO1(2,iGrid,iCB) * Temp45b
            Grid_AO(3,iGrid,iCB,2)= TabAO1(1,iGrid,iCB) * Temp2b
     &                            + TabAO1(3,iGrid,iCB) * Temp45b
            Grid_AO(4,iGrid,iCB,2)= TabAO1(1,iGrid,iCB) * Temp3b
     &                            + TabAO1(4,iGrid,iCB) * Temp45b
            Grid_AO(5,iGrid,iCB,2)=(TabAO1(5,iGrid,iCB)
     &                             +TabAO1(8,iGrid,iCB)
