...
rcg21 = wcg_real(Two,One,spin,rms-one,spin,rms)
rcg11 = wcg_real(One,One,spin,rms-one,spin,rms)
rcg20 = wcg_real(Two,Zero,spin,rms,spin,rms)
rcg10 = wcg_real(One,Zero,spin,rms,spin,rms)
