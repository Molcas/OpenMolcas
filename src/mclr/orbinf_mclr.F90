...
subroutine ORBINF_MCLR(NIRREP,NSMOB,NRAS1,NRAS2,NRAS3,MXR4tp,IPRNT)
...
!                                          *
!*******************************************
call ORBORD(NSMOB,MXPOBS,MXR4TP,NDEOBS,NINOBS,NR0OBS,NACOBS,NRSOBS,NR4OBS,NOCOBS,NTOOBS,IREOST,IREOTS,ISMFTO,ITFSO,IPRNT,IBSO, &
