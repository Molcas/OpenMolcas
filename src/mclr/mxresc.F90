...
dimension NSSOA(NOCTPA,NSM), NSSOB(NOCTPB,NSM)
dimension KSSOA(KOCTPA,NSM), KSSOB(KOCTPB,NSM)
dimension K2SSOA(K2OCTPA,NSM)
dimension K2SSOB(K2OCTPB,NSM)
dimension NTSOB(3,NSM)
dimension NAEL123(3,*), NBEL123(3,*)
