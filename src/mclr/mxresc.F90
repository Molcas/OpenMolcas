...
implicit none
integer(kind=iwp) :: NOCTPA, NOCTPB, IAB(NOCTPA,NOCTPB), IACLS, IBCLS, NSM, NSSOA(NOCTPA,NSM), NSSOB(NOCTPB,NSM), &
                     KOCTPA, KSSOA(KOCTPA,NSM), KOCTPB, KSSOB(KOCTPB,NSM), NTSOB(3,NSM), MXPKA, K2OCTPA, K2SSOA(K2OCTPA,NSM), &
                     K2OCTPB, K2SSOB(K2OCTPB,NSM), NAEL123(3,*), NBEL123(3,*), MXCJ, MXCIJA, MXCIJB, MXCIJAB, MXSXBL, MXIJST, &
                     MXIJSTF
