...
integer iprt, intspc, NAEL, NBEL, ICOMBI, IPWAY, NINOB, NP1CNF, NP1CSF, NP2CNF, NP2CSF, NPCNF, NQCNF, NQCSF
real*8 PSIGN
...
!call IAIBCM_MCLR(MNR1,MXR3,NOCTPA,NOCTPB,Str(IATP)%EL1,Str(IATP)%EL3,Str(IBTP)%EL1,Str(IBTP)%EL3,IOCOC,NTEST)
...
call H0CSF(H0,ISBDET,ISBCNF,MXP1,MXP2,MXQ,DTOC,DFTP,CNSM(ieaw)%ICONF,IREFSM,ECORE,NINOB,NOCOB,H0SCR,iH0SCR,NCNASM(IREFSM), &
           NAEL+NBEL,NAEL,NBEL,IPWAY,NP1CSF,NP1CNF,NP2CSF,NP2CNF,NQCSF,NQCNF,NPRCIV,NPCNF,VEC1,VEC2,IPRT,INTSPC,ICOMBI,PSIGN)
!end if
