...
integer ICSM, ISSM
integer ICBLTP(NSM), ISBLTP(NSM)
integer NSSOA(NOCTPA,NSM)
integer NSSOB(NOCTPB,NSM)
integer NTSOB(3,NSM), IBTSOB(3,NSM), ITSOB(*)
integer IAEL1(*), IAEL3(*)
integer IBEL1(*), IBEL3(*)
integer IDC
integer IDOH2
...
integer ISOOSC(NOCTPA,NOCTPB,NSM), NSOOSC(NOCTPA,NOCTPB,NSM)
integer ISOOSE(NOCTPA,NOCTPB,NSM), NSOOSE(NOCTPA,NOCTPB,NSM)
integer ICOOSC(NOCTPA,NOCTPB,NSM), NCOOSC(NOCTPA,NOCTPB,NSM)
integer ICOOSE(NOCTPA,NOCTPB,NSM), NCOOSE(NOCTPA,NOCTPB,NSM)
integer IASOOS(NOCTPA,NOCTPB,NSM), IACOOS(NOCTPA,NOCTPB,NSM)
