...
! CSTATE
integer IREFSM, IREFML, IREFPA, IREFL, MS2, MULTS, NROOT, IDC, INTSEL, IALIGN, NGENSYM, IGENSYM(100), INVSYM, IKRAM
real*8 PSSIGN, PLSIGN, ETHRES, CTHRES

! Stuff from Files_mclr.fh
character(len=8) FnOne, FnJob, FnTwo, FnMol, FnRlx, FnMck, FnTemp, FnHlf1, FnHlf2, FNHlf3, FNHlf4, FnPT2, FNTrI1, FNTrI2, FNTRi3, &
                 FNTRI4, FNTRI5, FNCSF2SD, FnMOTRA, FnQDAT
integer LuOne, LuJob, LuTwo, LuMol, LuRlx, LuMck, LuTemp, LUHLF1, LUHlf2, LUHlf3, LUHLF4, LuPt2, LUTrI1, LUTrI2, LUTRi3, LUTRI4, &
...
integer NICISP, IASTFI(MXPICI), IBSTFI(MXPICI), IACTI(MXPICI), MNR1IC(MXPICI), MXR1IC(MXPICI), MNR3IC(MXPICI), MXR3IC(MXPICI), &
        IZCI, IRCI(3,7,7), NELCI(MXPICI), NAELCI(MXPICI), NBELCI(MXPICI), ISMOST(MXPCSM,MXPCSM), MXSB, MXSOOB, ldet, lcsf
...
integer MAXIT, IRESTR, MXP1, MXP2, MXQ, INCORE, MXCIV, ICISTR, NOCSF, IDIAG, NOINT, NOPAIR, IH1SO, IDELMS, ISOSYM(3), INIDEG, &
        IFINSD, IPREREL, NOMSPA, IPREDZN, ISUPSP, IREDSTP, IDMPIN, MAXRIT, MAXI, MAXK, NOPART, NOHSOO, IDENMT
...
integer NINOB, NACOB, NDEOB, NOCOB, NTOOB, NORB0, NORB1, NORB2, NORB3, NORB4, NOSPIR(MXPIRR), IOSPIR(MXPOBS,MXPIRR), &
        NINOBS(MXPOBS), NR0OBS(1,MXPOBS), NRSOBS(MXPOBS,3), NR4OBS(MXPOBS,MXPR4T), NACOBS(MXPOBS), NOCOBS(MXPOBS), NTOOBS(MXPOBS), &
        NDEOBS(MXPOBS), NRS4TO(MXPR4T), IREOTS(MXPORB), IREOST(MXPORB), ISMFTO(MXPORB), ITPFSO(MXPORB), IBSO(MXPOBS), &
        NTSOB(3,MXPOBS), IBTSOB(3,MXPOBS), ITSOB(MXPORB), NOBPTS(6+MXPR4T,MXPOBS), IOBPTS(6+MXPR4T,MXPOBS), ITOOBS(MXPOBS), &
        ITPFTO(MXPORB), ISMFSO(MXPORB), NOBPT(6+MXPR4T)
