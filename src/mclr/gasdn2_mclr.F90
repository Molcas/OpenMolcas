...
subroutine GASDN2_MCLR(I12,RHO1,RHO2,R,L,CB,SB,C2,ICOCOC,ISOCOC,ICSMOS,ISSMOS,ICBLTP,ISBLTP,NACOB,NSSOA,ISSOA,NSSOB,ISSOB,NAEL, &
                       ...
                       IASOOS,IACOOS,I1,XI1S,I2,XI2S,I3,XI3S,I4,XI4S,X,MXPOBS,IPRNT,RHO1S,LUL,LUR,PSL,PSR,RHO1P,XNATO,ieaw,n1,n2)
...
do ISBLK=1,NSBLK
  ISBSM = ISSMOS(IS1SM)
  if (NTEST >= 20) write(6,*) ' ISBLK ISOFF ',ISBLK,ISOFF
...
IFRSTC = 1
9001 continue
if (NTEST >= 20) write(6,*) ' >>> next batch of R blocks'
ICSTSM = ICENSM
ICSTTA = ICENTA
ICSTTB = ICENTB
      ...
      if ((NIA*NIB*NJA*NJB /= 0) .and. (ISOCOC(IATP,IBTP) == 1) .and. (ICOCOC(JATP,JBTP) == 1) .and. (XNORM2 /= 0.0d0)) then
        ...
        do IRPERM=1,NRPERM
          ...
          call GSDNBB2_MCLR(I12,RHO1,RHO2,IIASM,IIATP,IIBSM,IIBTP,JJASM,JJATP,JJBSM,JJBTP,NGAS,NELFSPGPA(1,IOCTPA-1+IIATP), &
                            ...
                            XI4S,X,NSMOB,NSMST,NSMSX,NSMDX,NIIA,NIIB,NJJA,NJJB,MXPOBS,IPRNT,NACOB,RHO1S,ieaw,n1,n2)
        end do
