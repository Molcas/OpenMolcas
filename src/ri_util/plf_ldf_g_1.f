...
************************************************************************
      Subroutine PLF_LDF_G_1(TInt,nTInt,
      ...
      Do i4=1,lCmp
         ...
         Do i2=1,jCmp
            ...
            Do lSOl=lSO,lSO+lBas-1
               ll=iShlSO(lSOl)
               If (IndxG(ll,iShlL).gt.0) Then
                  Do jSOj=jSO,jSO+jBas-1
                     jj=iShlSO(jSOj)
                     nijkl=nijkl+1
                     If (IndxG(jj,iShlJ).gt.0) Then
                        JL=nRow_G*(IndxG(ll,iShlL)-1)+IndxG(jj,iShlJ)
                        LJ=nRow_G*(IndxG(jj,iShlJ)-1)+IndxG(ll,iShlL)
