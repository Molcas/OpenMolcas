...
#include "print.fh"
integer(kind=iwp) :: i, iAng, iAOst(4), iAOV(4), iBasAO, iBasi, iBasn, iBsInc, iCar, id, iFnc(4), ij, ijkla, &
...
#         endif
          iAOst(:) = iSD4(8,:)
          iAOV(:)  = iSD4(7,:)
          call PGet0(iBasn,jBasn,kBasn,lBasn,iAOV,iAOst,nijkl,Sew_Scr(ipMem1),nSO,iFnc(1)*iBasn,iFnc(2)*jBasn,iFnc(3)*kBasn, &
