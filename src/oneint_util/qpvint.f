...
************************************************************************
      SubRoutine QpVInt(Alpha,nAlpha,Beta, nBeta,Zeta,ZInv,rKappa,P,
...
*
      ...
      If (nip-1.gt.nZeta*nArr) Then
         Call WarningMessage(2,' QpVInt: nip-1.gt.nZeta*nArr')
         Call Abend()
      End If
      ipArr = nip
...
*
         Call Util5(Array(ipB),nZeta,Array(ipRes),la,lb,Array(ipS1),
     &                                           Array(ipS2))
*
