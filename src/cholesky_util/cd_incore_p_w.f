...
*     <Syntax>Call CD\_InCore\_p\_w(X,n,wg,Vec,MxVec,iD,NumCho,Thr,irc)</Syntax>
*     <Arguments>
*       \Argument{X}{Matrix to be Cholesky decomposed, dimension
*                    X(n,n)}{Real*8}{inout}
*       \Argument{n}{Linear dimension of X}{Integer}{in}
*       \Argument{Wg}{Array Wg(n) of diagonal elements weights}{Real*8}{in}
...
*        of weighted diagonal elements. The array iD(k) on exit contains
