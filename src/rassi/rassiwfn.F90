...
integer(kind=iwp) :: wfn_cmo, wfn_cmo_or, wfn_detcoeff, wfn_detcoeff_or, wfn_detocc, wfn_detocc_or, wfn_h_hfc_rms, wfn_overlap, &
...
public :: wfn_cmo, wfn_cmo_or, wfn_detcoeff, wfn_detcoeff_or, wfn_detocc, wfn_detocc_or, wfn_h_hfc_rms, wfn_overlap, wfn_sfs_amfi, &
