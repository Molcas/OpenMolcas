...
! (assuming one state with N and one with N-1 electrons)
! calculate the following quantities:
! (1) The Dyson orbital norm between the two states (DYSAMP)
! (2) The Dyson orbital expansion coefficients in the
!     basis of active biorthonormal orbitals (DYSCOF)
! More functionality should be added here later.
