...
*
*   <DOC>
*     <Name>NAT\_BOND\_ORDER</Name>
*     <Syntax>Call NAT\_BOND\_ORDER(NSYM,NBAS,NAME,iCase)
*     </Syntax>
*     <Arguments>
...
*     </Arguments>
*     <Purpose>Compute Natural Bond Order</Purpose>
*     <Dependencies></Dependencies>
*     <Author>Luca De Vico</Author>
*     <Modified_by>V. Veryazov</Modified_by>
...
*     will considere also triatomic bonds
...
************************************************************************
*                                                                      *
*     Purpose: For a given set of  atomic orbitals compute the         *
*              Natural Bond Order (NBO) as described in                *
*              Jensen: Introduction to Computational Chemistry.        *
*              The atomic orbital are taken as generated by            *
*              LoProp,in order to be localised. In the future,         *
*              hopefully, i twill considere also triatomic bonds       *
*              and then put everything into a molden file and/or gv.   *
*              Treatment of UHF should be included.                    *
*                                                                      *
*     Calling parameters:                                              *
...
*     NAME     : Center and function type label
*     iCase    : type of run:                                          *
*                0 First UHF run, no print just dump                   *
*                1 Second UHF run, final print                         *
*                2 Normal run, print                                   *
*                                                                      *
************************************************************************
*
