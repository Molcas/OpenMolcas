...
clu
clu    This code was adapted for integration on a semi-sphere:
clu    z(i)>=0
clu
chvd
...
chvd   This Subroutine was translated from C to fortran77 by hand.
clu
clu    This code was adapted for integration on a fourth-of-a-sphere:
clu    x(i)>=0; z(i)>=0;
clu
chvd
chvd   Users of this code are asked to include reference [1] in their
...
chvd   This Subroutine was translated from C to fortran77 by hand.
clu
clu    This code was adapted for integration on a octant-of-a-sphere:
clu    x(i)>=0; y(i)>=0; z(i)>=0;
clu
chvd
chvd   Users of this code are asked to include reference [1] in their
chvd   publications, and in the user- and programmers-manuals
