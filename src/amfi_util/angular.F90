...
!bs   a difference of two means two spin flips and is therefore not
!bs   allowed
      Lleftmax=l1+l2
      Lrightmax=l3+l4
      Lleftmin=iabs(l1-l2)
...
!   As the integrals are the same, the pointer points to the same
!   integrals...
!
!
...
!bs   just controlling if x and y integrals have the same number of
!bs   blocks
