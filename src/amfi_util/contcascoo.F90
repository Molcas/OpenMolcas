...
call contract(contrarray(:,1,l1),contrarray(:,3,l2),contrarray(:,3,l3),contrarray(:,1,l4),ncont,nprim,scratch1,scratch2)
...
!ncont : i-th element is number of contracted functions i. index
!nprim : i-th element is number of primitive functions  i. index
call contract(contrarray(:,3,l1),contrarray(:,3,l2),contrarray(:,1,l3),contrarray(:,1,l4),ncont,nprim,scratch1,scratch2)
...
!ncont : i-th element is number of contracted functions i. index
!nprim : i-th element is number of primitive functions  i. index
call contract(contrarray(:,1,l1),contrarray(:,1,l2),contrarray(:,3,l3),contrarray(:,3,l4),ncont,nprim,scratch1,scratch2)
cont4OO(nstart:nstart+nprod-1) = cont4OO(nstart:nstart+nprod-1)+Quart*scratch1(1:nprod)
...
!ncont : i-th element is number of contracted functions i. index
!nprim : i-th element is number of primitive functions  i. index
call contract(contrarray(:,3,l1),contrarray(:,1,l2),contrarray(:,1,l3),contrarray(:,3,l4),ncont,nprim,scratch1,scratch2)
cont4OO(nstart:nstart+nprod-1) = cont4OO(nstart:nstart+nprod-1)+Quart*scratch1(1:nprod)
