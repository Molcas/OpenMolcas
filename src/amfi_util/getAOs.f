...
#include "param.fh"
      ...
      if (.not.EX)  then
!BS      write(6,*) 'get occupations from DATA-block'
         call getAOs2(lhigh)
         return
      endif
      Lu_33=33
