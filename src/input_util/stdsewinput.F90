...
character Key*180, KWord*180, BSLbl*80, Fname*256, DefNm*13, Ref(2)*80, dbas*4
integer BasisTypes(4)

character*180 Line, STDINP(mxAtom*2) ! CGGn
character*256 Basis_lib ! CGGd , INT2CHAR, CHAR4

!GGd      Data WellRad/-1.22D0,-3.20D0,-6.20D0/
...
if (iEnd > LENIN+1) then
  write(6,*) 'Warning: the label ',KWord(1:iEnd),' will be truncated to ',LENIN,' characters!'
end if
