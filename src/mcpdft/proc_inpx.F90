...
use general_data, only: ispin, nactel, nash, nbas, nconf, ndel, ndelt, nelec3, nfro, nhole1, nish, norb, nrs1, nrs1t, nrs2, nrs2t, &
                        nrs3, nrs3t, nssh, nsym, ntot, ntot1, ntot2, ntotsp, stsym
