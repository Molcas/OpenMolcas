...
integer(kind=iwp) :: i, ia, iDo, ie, ifr, ii, ik, iloc, iOff, iOpt, iSkip, iSym, isymlbl, ito, iV, ja, jDo, jk, jloc, jOff, k, ka, &
                     kfr, kk, kOff, kto, lnDel(8), lnDel2(8), lnFro(8), lnFro2(8), lnOrb(8), lnOcc(8), lnOcc2(8), lnVir(8), &
