...
subroutine AI_CPF(JSY,INDEX,C,S,FC,BUFIN,IBUFIN,A,B,FK,DBK,ENP,EPP,KTYP)
...
dimension JSY(*), index(*), C(*), S(*), FC(*), BUFIN(*), IBUFIN(*), A(*), B(*), FK(*), DBK(*), ENP(*), EPP(*)
...
201 call DSQ2(C,S,MUL,INDEX,JSY,NDIAG,INUM,IRC(3),LSYM,NVIRT,SQ2)
