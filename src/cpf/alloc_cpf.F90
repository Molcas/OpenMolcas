...
!PAM96      WRITE(6,50)
!PAM9650    FORMAT(/,6X,'DYNAMICAL CORE STORAGE INFORMATION',/)
      ISTOP=0
      MAX1=0
      MAX2=0
      NVMAX=0
...
20    CONTINUE
10    CONTINUE
!PAM97      CALL ALSO(LW,IROW,LIC,NORBT,NVIRT,LN,ISTOP,IFIRST,
!PAM97     *MADR,LPERMA,LBUF,KBUF,JBUF,IPASS,IRC(1),ISMAX,KBUFF1)
...
!PAM96358   FORMAT(6X,'STORAGE FOR NPSET',I14)
...
!PAM96349   FORMAT(6X,'STORAGE FOR DENS',I15)
      IF(IPRINT.GE.2) THEN
