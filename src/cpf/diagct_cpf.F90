...
subroutine DIAGCT_INTERNAL(H)
  ...
  integer(kind=iwp), pointer :: iH1(:), iH2(:), iH4(:), iH11(:), iH12(:), iH13(:), iH17(:), iH18(:), iH19(:), iH20(:), iH21(:), &
                                iH22(:), iH25(:)
  ILIM = 4
  if (IFIRST /= 0) ILIM = 2
  NCONF = JSC(ILIM)
  ...
  call DCOPY_(LW(21)-LW(20),[Zero],0,H(LW(20)),1)
  ...
  if (IFIRST == 0) then
    call DCOPY_(LW(18)-LW(17),[Zero],0,H(LW(17)),1)
    call c_f_pointer(c_loc(H(LW(4))),iH4,[1])
  ...
  call DCOPY_(LW(12)-LW(11),[Zero],0,H(LW(11)),1)
