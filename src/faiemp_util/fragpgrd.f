...
!
      iCurMdc = 0
!      ! The mdc value of the current fragment placeholder
      iCurCnttp = 0
!      ! The Cnttp of the fragment placeholder
      iCurCenter = 999999
!      ! The index of the fragment in the fragment placeholder list of centers
      iSstart = 0
!      ! The index into the full shells list for the first shell of a fragment
      iSbasis = 0
!      ! The basis function index relative to the start of the fragment
      iSEnd = -1
!      ! Dummy initialize
      Do 1965 iS = 1, nSkal
        iShll  = iSD( 0,iS)
...
! include the minus sign of -2eta_i
     ...
     &        (dbsc(iCurCnttp)%nFragDens+1)/2) Stop 'maxIJSize'
          End If
        End If
!        write(*,*) '  iShll,iAng,mdci,iCnttp,iCurMdc,iCurCnttp',
!     &              iShll,iAng,mdci,iCnttp,iCurMdc,iCurCnttp
!        write(*,*) '  iPrim,iBas =',iPrim,iBas
!
...
!         write(*,*) '    jShll,jAng,jCnttp =',
!    &                    jShll,jAng,jCnttp
!         write(*,*) '    jPrim,jBas =',jPrim,jBas
!                                                                      *
!***********************************************************************
!                                                                      *
...
!             and from jSbasis to jSbasis + jBas*nElem(jAng) - 1
           ipIJ = 1 + maxDensSize
!          write(*,*) '    extracting values from',iSbasis,' to',iSbasis
...
!              write(*,*) 'Filling (',iSlocal-iSbasis+1,',',
...
!     &                        Array(ipIJ), Final(1,1,1,mVec), Fact*Half
