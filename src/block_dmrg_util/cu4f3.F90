...
!     // G(I,j)G(JKL,ikl)[12]
!     CU4F3H=CU4F3H                                                     &
!    & - 0.5D0*G1(iP,lT)*G3(lT,iQ,jP,jQ,kP,kQ)                          &
!    & - 0.5D0*G1(jP,lT)*G3(lT,jQ,iP,iQ,kP,kQ)                          &
!    & - 0.5D0*G1(kP,lT)*G3(lT,kQ,iP,iQ,jP,jQ)                          &
!    & - 0.5D0*G1(lT,iQ)*G3(iP,lT,jP,jQ,kP,kQ)                          &
!    & - 0.5D0*G1(lT,jQ)*G3(jP,lT,iP,iQ,kP,kQ)                          &
!    & - 0.5D0*G1(lT,kQ)*G3(kP,lT,iP,iQ,jP,jQ)
!
