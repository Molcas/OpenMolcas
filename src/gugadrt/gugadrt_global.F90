...
integer(kind=iwp), parameter :: max_innorb = 60
integer(kind=iwp), parameter :: max_node = 36000
integer(kind=iwp), parameter :: maxgdm = 8
integer(kind=iwp), parameter :: max_orb = 260
...
integer(kind=iwp) :: iseg_downwei(25), iseg_sta(26), ja_sys, jb_sys, jc_sys, jpad_upwei(41), jroute_sys, lsm_inn(max_innorb), &
                     mxnode, n_electron, n_ref,  nci_dim, ng_sm, nlsm_all(maxgdm), nlsm_bas(maxgdm), nlsm_ext(maxgdm), &
                     nlsmddel(maxgdm), nlsmedel(maxgdm), norb_act, norb_all, norb_dbl, norb_dz, norb_ext, norb_frz, norb_inn, &
                     ns_sm, nstart_act, nu_ad(41), nu_ae(25)
...
public :: max_innorb, max_node, max_orb, maxgdm, mul_tab
