...
subroutine GetNumHess(CMO,nOrb2Loc,BName,nBasis,nAtoms,fsdim,Ovlp,Ovlp_sqrt,NumHessSymm,debug2,nBas_Start,&
        nBas_per_Atom)
...
real(kind=wp), intent(in) :: CMO(nBasis,nOrb2Loc),Ovlp(nBasis,nBasis),Ovlp_sqrt(nBasis,nBasis)
