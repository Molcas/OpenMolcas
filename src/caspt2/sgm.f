...
! RHS_ALLO in file par_rhs.f). The chunks are along the column indices,
...
!FUE  IF( (ICASE1.EQ.1 .AND. ICASE2.EQ.2) .AND.
!FUE &    (ISYM1.EQ.1  .AND. ISYM2.EQ.1 )       ) IFTEST=1
!PAM      IF(ICASE1.EQ.5.AND.ICASE2.GT.11) IFTEST=1
#ifdef _DEBUGPRINT_
