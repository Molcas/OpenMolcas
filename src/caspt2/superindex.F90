...
subroutine SUPINI()
  ...
  use caspt2_module, only: nAes, nAGEB, nAGEBES, nAGTB, nAGTBES, nAshT, nASUP, nCases, nIAES, nIES, nIGEJ, nIGEJES, nIGTJ, &
                           nIGTJES, nInDep, nIsh, nIshT, nISUP, nSES, nSES, nSsh, nSsh, nSshT, nSym, nTGEU, nTGEUES, nTGTU, &
