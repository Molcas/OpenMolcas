...
use SUPERINDEX, only: MAGEB, MAREL, MTGEU, MTREL, MAGTB, MAREL, MTGTU
...
#endif
use caspt2_module, only: NSYM, NASUP, NISUP, NAGEBES, NTGEUES, NSSH, NAGTBES, NTGTUES
...
integer(kind=iwp) NAS, NIS, lg_W, IASTA, IAEND, IISTA, IIEND, MW, IA, IAABS, IAGEB, IAGEBTOT, IAGTB, IAGTBTOT, IAT, IAV, IC, &
                  ICABS, iCASE, ICT, ICV, IDX, IOFFAT, IOFFAV, IOFFCT, IOFFCV, ISYA, ISYC, ISYM, ISYT, ISYV, IT, ITABS, ITGEU, &
                  ITGEUTOT, ITGTU, ITGTUTOT, IV, IVABS, NCHOBUF, NV, NW
