...
! NIPWLK: NR OF INTEGERS USED TO PACK EACH UP- OR DOWNWALK.
      ...
      CALL NRCOUP_CP2(SGS,CIS,EXS,nVert,nMidV,MxEO,SGS%ISM,SGS%DRT,ISGM,CIS%NOW,CIS%IOW,EXS%NOCP,EXS%IOCP, &
                      CIS%NOCSF,CIS%IOCSF,CIS%NCSF,NRL,EXS%MVL,EXS%MVR,NICOUP)
