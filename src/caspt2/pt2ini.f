...
* All the density matrices kept in memory
      ...
      CALL GETMEM('LFWGT','ALLO','REAL',LFWGT,NSTATE*NSTATE)
      CALL GETMEM('LVWGT','ALLO','REAL',LVWGT,NSTATE*NSTATE)
...
* Deallocate global array for Fock matrix, etc:
      ...
      CALL GETMEM('LFWGT','FREE','REAL',LFWGT,NSTATE*NSTATE)
      CALL GETMEM('LVWGT','FREE','REAL',LVWGT,NSTATE*NSTATE)
