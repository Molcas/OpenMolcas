...
subroutine CLagDXA_FG3(iSym,nAS,nAshT,NG3,NS,BDER,SDER,DF1,DF2,DF3,DG1,DG2,DG3,DEPSA,G2,SC,idxG3)
...
real(kind=wp), intent(in) :: BDER(nAS,nAS), SDER(nAS,nAS), G2(nAshT,nAshT,nAshT,nAshT), SC(NS)
...
do iG3=1,NG3
  ...
  !! last line of F3 transformation in mkfg3
