...
#endif
use caspt2_module, only: NACTEL, NASHT, NSYM, NORB, NASUP, NISUP, NIAES, NTUES, NSSH, NASH, NISH
...
integer(kind=iwp) NAS, NIS, lg_W, IASTA, IAEND, IISTA, IIEND, MW, IA, IAABS, IAEND1, IAEND2, IAJ, IAJTOT, IASTA1, IASTA2, IATOT, &
