...
integer(iwp) :: IA, IAABS, IAEND, IAGEC, IAGECTOT, IAGTC, IAGTCTOT, IAJ, IASTA, IAV, IC, ICABS, iCASE, ICJ, ICV, IDX, IIEND, &
                IISTA, IJ, IJAGEC, IJAGECEND, IJAGECSTA, IJAGTC, IJAGTCEND, IJAGTCSTA, IOBRA(8,8), IOFF, IOFFAJ, IOFFAV, IOFFCJ, &
                IOFFCV, IOKET(8,8), ISYA, ISYAC, ISYC, ISYJ, ISYM, ISYV, IV, lg_W, MW, NAC, NAS, NBRABUF, NIS, NJ, NKETBUF, NV, NW
