...
C SET UP A FULL PALDUS DRT TABLE:
      ...
      CALL mkDRT0(IA0,IB0,IC0,NVERT0,IWORK(LDRTP),IWORK(LDOWNP),
     &           NVCD,IWORK(LVCD))
...
C  CONSTRUCT A RESTRICTED GRAPH.
        ...
        LM3RAS=NACTEL-NELE3
        CALL RESTR(NVERT0,IWORK(LDRTP),IWORK(LDOWN0),IWORK(LV),
     &                 LV1RAS,LV3RAS,LM1RAS,LM3RAS,NVERT)
        NDRT=5*NVERT
        NDOWN=4*NVERT
        CALL GETMEM('DRT','ALLO','INTEG',LDRT,NDRT)
        CALL GETMEM('DOWN','ALLO','INTEG',LDOWN,NDOWN)
        CALL mkDRT(NVERT0,NVERT,IWORK(LDRT0),IWORK(LDOWN0),IWORK(LV),
     &             IWORK(LDRT),IWORK(LDOWN))
        ...
        CALL PRDRT(NVERT,WORK(LDRT),IWORK(LDOWN))
#endif
      END IF
C CALCULATE DIRECT ARC WEIGHT AND LTV TABLES.
      ...
      CALL MKDAW_CP2(NLEV,NVERT,IWORK(LDRT),IWORK(LDOWN),
