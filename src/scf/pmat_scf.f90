...
!
      Interface
        SubRoutine Drv2El_dscf(Dens,TwoHam,nDens,nDisc,Thize,PreSch,FstItr,NoCoul,ExFac)
        Integer nDens, nDisc
...
! to be used.
      ...
      If (n2==1) Then
         NoCoul=.False.
         Call Drv2El_dscf(Dens(1,1,iPsLst),Temp(1,1),nBT,0,Thize,PreSch,FstItr,NoCoul,ExFac)
      Else
!
