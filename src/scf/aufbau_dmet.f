...
************************************************************************
      SubRoutine Aufbau_DMET(EOr,nEOr,nAuf,Occup,nOccup,iOK,nD)
************************************************************************
*                                                                      *
...
*
         ...
         Do iD = 1, nD
            ...
            eferm=FermiPop_DMET(EOr(1,iD),Occup(1,iD),nOrbAS,RTemp,
     &                     nAuf(iD)*mD,UHF_occ)
#define _DEBUG_
#ifdef _DEBUG_
...
*                                                                      *
************************************************************************
      Real*8 Function FermiPop_DMET(e,o,n,T,nEle,UHF_occ)
      Implicit None
*----------------------------------------------------------------------*
* Dummy arguments:                                                     *
