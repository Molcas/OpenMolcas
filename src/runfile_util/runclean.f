...
#ifdef _HAVE_EXTRA_
! FIXME: This include file should be created,
!        as it contains a shared common block
!#include "lfalcon.fh"
#else
       Logical isFalcon
       isFalcon = .false.
...
!           write(6,*) 'cArray label ',i,' used ',
!     &                       i_run_CA_used(i),' times'
...
!           write(6,*) 'dArray label ',i,' used ',
!     &                      i_run_DA_used(i),' times'
...
!           write(6,*) 'dScalar label ',i,' used ',
!     &                      i_run_DS_used(i),' times'
...
!           write(6,*) 'iArray label ',i,' used ',
!     &                       i_run_IA_used(i),' times'
...
!           write(6,*) 'iScalar label ',i,' used ',
!     &                       i_run_IS_used(i), ' times'
