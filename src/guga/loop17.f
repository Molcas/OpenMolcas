...
************************************************************************
      SUBROUTINE LOOP17(KM,ISTOP,IT1,IT2)
...
141   IF(K2F(JM(KM1)).EQ.0)GO TO 41
      ...
      ICOUP1(KM)=ICOUP1(KM1)+IY(IT1+J1(KM1),1)
      ICOUP(KM)=ICOUP(KM1)+IY(IT2+J2(KM1),2)
241   COUP(KM)=-BL2(IB(J2(KM1))+1)*COUP(KM1)/(IB(J2(KM1))+3)
      JM(KM)=K2F(JM(KM1))
      GO TO 40
C     MM
41    IWAY(KM)=3
...
43    IWAY(KM)=5
      ...
      ICOUP(KM)=ICOUP(KM1)+IY(IT2+J2(KM1),2)
      COUP(KM)=BL2(IB(J2(KM1))+2)*BL2(IB(J2(KM1))+1)*COUP(KM1)
      JM(KM)=K2F(JM(KM1))
      GO TO 40
C     PP
44    IWAY(KM)=6
...
161   IF(K2F(JM1(KM1)).EQ.0)GO TO 164
      ...
      ICOUP1(KM)=ICOUP1(KM1)+IY(IT1+J1(KM1),1)
      ICOUP(KM)=ICOUP(KM1)+IY(IT2+J2(KM1),1)
162   WMP=-D1/((IB(J2(KM1))+1)*IB(J2(KM1)))
      JM(KM)=K2F(JM1(KM1))
...
264   IF(K1F(JM(KM1)).EQ.0)GO TO 62
      ...
      ICOUP1(KM)=ICOUP1(KM1)+IY(IT1+J1(KM1),2)
      ICOUP(KM)=ICOUP(KM1)+IY(IT2+J2(KM1),2)
263   WPM=-D1/((IB(J2(KM1))+1)*(IB(J2(KM1))+2))
      JM1(KM)=K1F(JM(KM1))
...
661   IF(K1F(JM(KM1)).EQ.0)GO TO 55
      ...
      ICOUP1(KM)=ICOUP1(KM1)+IY(IT1+J1(KM1),1)
      ICOUP(KM)=ICOUP(KM1)+IY(IT2+J2(KM1),2)
663   WPM=-BL1(IB(J2(KM1))+2)/(IB(J2(KM1))+2)
      JM1(KM)=K1F(JM(KM1))
...
C     (QJ,KQ)
      ...
      ICOUP1(KM)=ICOUP1(KM1)+IY(IT1+J1(KM1),2)
      ICOUP(KM)=ICOUP(KM1)+IY(IT2+J2(KM1),1)
      COUP1(KM)=BL1(IB(J2(KM1))+1)*COUP1(KM1)/(IB(J2(KM1))-1)
      JM1(KM)=K1F(JM1(KM1))
...
171   IF(K2F(JM1(KM1)).EQ.0)GO TO 71
      ...
      ICOUP1(KM)=ICOUP1(KM1)+IY(IT1+J1(KM1),2)
      ICOUP(KM)=ICOUP(KM1)+IY(IT2+J2(KM1),1)
172   COUP(KM)=-COUP1(KM1)/IB(J2(KM1))
      JM(KM)=K2F(JM1(KM1))
      GO TO 40
C     II
71    IWAY(KM)=3
...
72    IWAY(KM)=4
      ...
      ICOUP1(KM)=ICOUP1(KM1)+IY(IT1+J1(KM1),1)
      ICOUP(KM)=ICOUP(KM1)+IY(IT2+J2(KM1),1)
      COUP1(KM)=BL1(IB(J2(KM1)))*BL1(IB(J2(KM1))+1)*COUP1(KM1)
      JM1(KM)=K1F(JM1(KM1))
      GO TO 40
C     KK
73    IWAY(KM)=5
