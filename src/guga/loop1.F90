...
34 IWAY(KM) = 2
if ((K0(IT1+J1(KM1)) == 0) .or. (K2(IT2+J2(KM1)) == 0)) GO TO 35
COUP(KM) = D1
J1(KM) = K0(IT1+J1(KM1))
J2(KM) = K2(IT2+J2(KM1))
ICOUP1(KM) = 0
...
GO TO 40
35 IWAY(KM) = 3
if ((K1(IT1+J1(KM1)) == 0) .or. (K3(IT2+J2(KM1)) == 0)) GO TO 36
...
GO TO 40
36 IWAY(KM) = 4
if ((K0(IT1+J1(KM1)) == 0) .or. (K1(IT2+J2(KM1)) == 0)) GO TO 37
COUP(KM) = D1
J1(KM) = K0(IT1+J1(KM1))
J2(KM) = K1(IT2+J2(KM1))
ICOUP1(KM) = 0
...
GO TO 40
37 IWAY(KM) = 5
if ((K2(IT1+J1(KM1)) == 0) .or. (K3(IT2+J2(KM1)) == 0)) GO TO 30
