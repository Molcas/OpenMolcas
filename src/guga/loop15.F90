...
59 IWAY(KM) = 2
! (HK,FR)
if ((K3(IT1+J1(KM1)) == 0) .or. (K2(IT2+J2(KM1)) == 0)) GO TO 61
WM0 = D0
WP0 = D0
...
ICOUP1(KM) = ICOUP1(KM1)+IY(IT1+J1(KM1),3)
ICOUP(KM) = ICOUP(KM1)+IY(IT2+J2(KM1),2)
163 WP0 = -BS3(IB(J2(KM1))+2)/(IB(J2(KM1))+2)
162 COUP(KM) = WM0*COUP1(KM1)+WP0*COUP(KM1)
GO TO 40
! (HQ,FN)
61 IWAY(KM) = 3
if ((K3(IT1+J1(KM1)) == 0) .or. (K1(IT2+J2(KM1)) == 0)) GO TO 62
WM0 = D0
WP0 = D0
...
ICOUP1(KM) = ICOUP1(KM1)+IY(IT1+J1(KM1),3)
ICOUP(KM) = ICOUP(KM1)+IY(IT2+J2(KM1),1)
263 WP0 = -BS3(IB(J2(KM1))+2)
262 COUP(KM) = WM0*COUP1(KM1)+WP0*COUP(KM1)
GO TO 40
! EM
62 IWAY(KM) = 4
if ((K2(IT1+J1(KM1)) == 0) .or. (K0(IT2+J2(KM1)) == 0)) GO TO 63
if (K0F(JM(KM1)) == 0) GO TO 63
J1(KM) = K2(IT1+J1(KM1))
J2(KM) = K0(IT2+J2(KM1))
...
69 IWAY(KM) = 2
! EI
if ((K2(IT1+J1(KM1)) == 0) .or. (K0(IT2+J2(KM1)) == 0)) GO TO 71
if (K0F(JM1(KM1)) == 0) GO TO 71
J1(KM) = K2(IT1+J1(KM1))
J2(KM) = K0(IT2+J2(KM1))
ICOUP1(KM) = ICOUP1(KM1)+IY(IT1+J1(KM1),2)
ICOUP(KM) = ICOUP(KM1)
