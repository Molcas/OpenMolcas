...
133   IF(NB.GT.ND)GO TO 132
      ...
      NB=ND
      ND=NSAVE
132   CALL INT7(ND,NB,NA,IDIAG,INDOUT,INDOUT,ICAD,IBUFL,KBUF,NTPB)
310   CONTINUE
300   CONTINUE
200   CONTINUE
205   CONTINUE
      CALL AIAI(INDOUT,INDOUT,ICAD,IBUFL,KBUF,NTPB,NBINS)
      CALL EMPTY(IBUFL,IBUFL(RtoI*kBuf+1),ICAD,INDOUT,KBUF,NTPB)
      ICOP1(nCOP+1)=IOUT
...
525   IF(NA.EQ.NB)GO TO 510
      CALL INT7(ND,NB,NA,IDIAG,INDOUT,INDOUT,ICAD,IBUFL,
     *KBUF,NTPB)
      GO TO 510
