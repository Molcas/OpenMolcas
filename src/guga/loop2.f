...
34    IWAY(KM)=2
      IF(K0(IT2+J2(KM1)).EQ.0.OR.K2(IT1+J1(KM1)).EQ.0)GO TO 35
      COUP(KM)=D1
      J1(KM)=K2(IT1+J1(KM1))
      J2(KM)=K0(IT2+J2(KM1))
      ICOUP(KM)=0
      ...
      GO TO 40
35    IWAY(KM)=3
      IF(K1(IT2+J2(KM1)).EQ.0.OR.K3(IT1+J1(KM1)).EQ.0)GO TO 36
      ...
      GO TO 40
36    IWAY(KM)=4
      IF(K0(IT2+J2(KM1)).EQ.0.OR.K1(IT1+J1(KM1)).EQ.0)GO TO 37
      COUP(KM)=D1
      J1(KM)=K1(IT1+J1(KM1))
      J2(KM)=K0(IT2+J2(KM1))
      ICOUP(KM)=0
      ...
      GO TO 40
37    IWAY(KM)=5
      IF(K2(IT2+J2(KM1)).EQ.0.OR.K3(IT1+J1(KM1)).EQ.0)GO TO 30
