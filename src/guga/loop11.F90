...
39 IWAY(KM) = 2
! (B+R,D+O)
if ((K3(IT1+J1(KM1)) == 0) .or. (K2(IT2+J2(KM1)) == 0)) GO TO 41
if (K1F(J1F) == 0) GO TO 141
J1(KM) = K3(IT1+J1(KM1))
J2(KM) = K2(IT2+J2(KM1))
...
JM1(KM) = K1F(J1F)
if (K2F(J1F) == 0) GO TO 40
GO TO 142
141 if (K2F(J1F) == 0) GO TO 41
J1(KM) = K3(IT1+J1(KM1))
J2(KM) = K2(IT2+J2(KM1))
ICOUP1(KM) = ICOUP1(KM1)+IY(IT1+J1(KM1),3)
ICOUP(KM) = ICOUP(KM1)+IY(IT2+J2(KM1),2)
...
! A+M
41 IWAY(KM) = 3
if ((K2(IT1+J1(KM1)) == 0) .or. (K0(IT2+J2(KM1)) == 0)) GO TO 42
if (K0F(J1F) == 0) GO TO 42
J1(KM) = K2(IT1+J1(KM1))
J2(KM) = K0(IT2+J2(KM1))
...
! B+N
42 IWAY(KM) = 4
if ((K3(IT1+J1(KM1)) == 0) .or. (K1(IT2+J2(KM1)) == 0)) GO TO 43
if (K1F(J1F) == 0) GO TO 43
J1(KM) = K3(IT1+J1(KM1))
J2(KM) = K1(IT2+J2(KM1))
ICOUP1(KM) = ICOUP1(KM1)+IY(IT1+J1(KM1),3)
...
! C+M
43 IWAY(KM) = 5
if ((K1(IT1+J1(KM1)) == 0) .or. (K0(IT2+J2(KM1)) == 0)) GO TO 55
if (K0F(J1F) == 0) GO TO 55
J1(KM) = K1(IT1+J1(KM1))
J2(KM) = K0(IT2+J2(KM1))
...
59 IWAY(KM) = 2
! (B+J,D+Q)
if ((K3(IT1+J1(KM1)) == 0) .or. (K1(IT2+J2(KM1)) == 0)) GO TO 61
if (K1F(J1F) == 0) GO TO 161
J1(KM) = K3(IT1+J1(KM1))
J2(KM) = K1(IT2+J2(KM1))
ICOUP1(KM) = ICOUP1(KM1)+IY(IT1+J1(KM1),3)
ICOUP(KM) = ICOUP(KM1)+IY(IT2+J2(KM1),1)
...
! A+I
61 IWAY(KM) = 3
if ((K2(IT1+J1(KM1)) == 0) .or. (K0(IT2+J2(KM1)) == 0)) GO TO 62
if (K0F(J1F) == 0) GO TO 62
J1(KM) = K2(IT1+J1(KM1))
J2(KM) = K0(IT2+J2(KM1))
ICOUP1(KM) = ICOUP1(KM1)+IY(IT1+J1(KM1),2)
ICOUP(KM) = ICOUP(KM1)
...
! C+I
62 IWAY(KM) = 4
if ((K1(IT1+J1(KM1)) == 0) .or. (K0(IT2+J2(KM1)) == 0)) GO TO 63
if (K0F(J1F) == 0) GO TO 63
J1(KM) = K1(IT1+J1(KM1))
J2(KM) = K0(IT2+J2(KM1))
ICOUP1(KM) = ICOUP1(KM1)+IY(IT1+J1(KM1),1)
ICOUP(KM) = ICOUP(KM1)
