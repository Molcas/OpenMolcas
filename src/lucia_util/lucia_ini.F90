...
use spinfo, only: DoComb, I2ELIMINATED_IN_GAS_MOLCAS=>I2ELIMINATED_IN_GAS, I_ELIMINATE_GAS_MOLCAS=>I_ELIMINATE_GAS,  &
                  ...
                  NACTEL_MOLCAS=>NACTEL, NGAS_MOLCAS=>NGAS, NGSSH_MOLCAS=>NGSSH, NROOTS_MOLCAS=>nROOTS,   &
                  NSYM_MOLCAS, POTNUC_MOLCAS=>POTNUC
#ifdef _DEBUGPRINT_
use lucia_data, only: NOCSF
use spinfo, only: IEXPAND, INOCALC, IPT2, ISAVE_EXP, THRE_MOLCAS
#endif
