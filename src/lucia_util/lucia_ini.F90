...
!
     ...
     &  '     One- and two-body density matrices  calculated'
      END IF
      WRITE(6,*)
!?    IF(MOCAA.NE.0) WRITE(6,'(1X,A,I4)')
!?   &  '     MOC method used for alpha-alpha+beta-beta loop '
!?    IF(MOCAB.NE.0) WRITE(6,'(1X,A,I4)')
!?   &  '     MOC method used for alpha-beta loop            '
!
...
!OLD    IF(MPORENP.EQ.1) THEN
!OLD    WRITE(6,*)
!OLD &  '        Moller Plesset partitioning '
!OLD    ELSE IF (MPORENP.EQ.2) THEN
!OLD    WRITE(6,*)
!OLD &  '        Epstein-Nesbet partitioning '
!OLD    ELSE IF  (MPORENP.EQ.0) THEN
!OLD    WRITE(6,*)
!OLD &  '        One-body Hamiltonian readin '
!OLD    END IF
...
!       WRITE(6,*)
!       WRITE(6,'(5X,A)')
!    &  ' No transition properties will be calculated'
      ELSE
        WRITE(6,*)
        WRITE(6,'(5X,A)')                                               &
