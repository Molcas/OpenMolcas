...
use spinfo, only: DoComb, I2ELIMINATED_IN_GAS_MOLCAS=>I2ELIMINATED_IN_GAS, I_ELIMINATE_GAS_MOLCAS=>I_ELIMINATE_GAS,  &
                  ...
                  IPRCI_MOLCAS=>IPRCI, ISPEED, ISPIN_MOLCAS=>ISPIN, ITMAX, STSYM, MS2_MOLCAS=>MS2, &
                  N_2ELIMINATED_GAS_MOLCAS=>N_2ELIMINATED_GAS, N_ELIMINATED_GAS_MOLCAS=>N_ELIMINATED_GAS, &
                  NACTEL_MOLCAS=>NACTEL, NGAS_MOLCAS=>NGAS, NROOTS_MOLCAS=>nROOTS
use general_data, only: NGSSH_MOLCAS=>NGSSH, IGSOCCX_MOLCAS=>IGSOCCX, NSYM_MOLCAS=>NSYM
use rasscf_global, only: POTNUC_MOLCAS=>POTNUC
