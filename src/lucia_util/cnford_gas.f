...
!    &
!    NCONF_OP,IBCONF_REO,IBCONF_OCC,ICONF,IDOREO,IZ_CONF,IREO,NCONF_ALL_SYM)
...
!     CALL CNTOST(ICONF,SGNCTS,ICTSDT,IWORK,IDCNF(1),IREFSM,
!    &            IREFML,IREFG,XNDXCI,NORB,NEL,ORBSYM,
!    &            ICNFOK,IGENSG,ISGNA,ISGNB,IPRCSF)
!
