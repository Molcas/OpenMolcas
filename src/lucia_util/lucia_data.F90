...
integer(kind=iwp) :: I12, I1234S, I12S, I2ELIMINATED_IN_GAS(MXPNGAS), I34S, I_AM_OUT(MXPSTT), I_ELIMINATE_GAS, I_RES_AB, IADVICE, &
                     ...
                     IH0INSPC(MXPPTSPC), IH0SPC, IH1FORM, IOBPTS(6+MXPR4T,MXPOBS), IPART, IPERTOP, IPHGAS(MXPNGAS), IPRCIX, &
                     IPRDEN, IPRDIA, IPRORB, IRAT, IREFSM, IREOST(MXPORB), IREOTS(MXPORB), IRESTR, ISIMSYM, ISMFSO(MXPORB), &
                     ISMFTO(MXPORB), ISMOST(MXPCSM,MXPCSM), ISPGPFTP(MXPNGAS,MXPSTT), ISTAC(MXPSTT,2), ITOOBS(MXPOBS), IUSE_PH, &
                     LCMBSPC(MXPICI), LCSBLK, LUC, LUDIA, LUHC, LUMOUT, LUSC1, LUSC2, LUSC3, LUSC34, LUSC35, LUSC36, LUSC37, &
                     LUSC38, LUSC39, LUSC40, MAX_STR_OC_BLK, MAX_STR_SPGP, MAXOP, MINMAX_SM_GP(2,MXPSTT), MINOP, MNGSOC(MXPNGAS), &
                     MNHL, MOCAA, MS2, MULTS, MXGSOC(MXPNGAS), MXINKA, MXNSTR, MXNTTS, MXSB, MXSOOB, MXTSOB, N_2ELIMINATED_GAS, &
                     ...
                     NSTFSMSPGP(MXPNSMST,MXPSTT), NSTRKS(4), NSTTP, NSTTYP, NTOOB, NTOOBS(MXPOBS), NTSPGP, PNTGRP
...
public :: ECORE, ECORE_HEX, ECORE_ORIG, ENVIRO, I12, I1234S, I12S, I2ELIMINATED_IN_GAS, I34S, I_AM_OUT, I_ELIMINATE_GAS, I_RES_AB, &
          ...
          IPERTOP, IPHGAS, IPRCIX, IPRDEN, IPRDIA, IPRORB, irat, IREFSM, IREOST, IREOTS, IRESTR, ISIMSYM, ISMFSO, ISMFTO, ISMOST, &
          ISPGPFTP, ISTAC, ITOOBS, IUSE_PH, LCMBSPC, LCSBLK, LOFFI, LUC, LUDIA, LUHC, LUMOUT, LUSC1, LUSC2, LUSC3, LUSC34, LUSC35, &
          LUSC36, LUSC37, LUSC38, LUSC39, LUSC40, MAX_STR_OC_BLK, MAX_STR_SPGP, MAXOP, MINMAX_SM_GP, MINOP, MNGSOC, MNHL, MOCAA, &
          MS2, MULTS, MXGSOC, MXINKA, MXNSTR, MXNTTS, MXPCSM, MXPIRR, MXPNGAS, MXPNSMST, MXPOBS, MXPORB, MXPSTT, MXPTSOB, MXSB, &
          MXSOOB, MXTSOB, N_2ELIMINATED_GAS, N_ELIMINATED_BATCHES, N_ELIMINATED_GAS, NACOB, NACOBS, NACTEL, NBINT1, NBINT2, &
          ...
          NSPGPFTP, NSTFGP, NSTFSMGP, NSTFSMSPGP, NSTRKS, NSTTP, NSTTYP, NTOOB, NTOOBS, NTSPGP, PNTGRP, PSSIGN, XISPSM
