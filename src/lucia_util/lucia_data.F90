...
integer(kind=iwp) :: I12, I1234S, I12S, I2ELIMINATED_IN_GAS(MXPNGAS), I34S, I_AM_OUT(MXPSTT), I_ELIMINATE_GAS, I_RES_AB, IADVICE, &
                     ...
                     IPRDEN, IPRDIA, IPRORB, IREFSM, IREOST(MXPORB), IREOTS(MXPORB), IRESTR, ISIMSYM, ISMFSO(MXPORB), &
...
public :: ECORE, ECORE_HEX, ECORE_ORIG, ENVIRO, I12, I1234S, I12S, I2ELIMINATED_IN_GAS, I34S, I_AM_OUT, I_ELIMINATE_GAS, I_RES_AB, &
          ...
          IPERTOP, IPHGAS, IPRCIX, IPRDEN, IPRDIA, IPRORB, IREFSM, IREOST, IREOTS, IRESTR, ISIMSYM, ISMFSO, ISMFTO, ISMOST, &
          ...
          NSPGPFTP, NSTFGP, NSTFSMGP, NSTFSMSPGP, NSTRKS, NSTTP, NSTTYP, NTOOB, NTOOBS, NTSPGP, PSSIGN, XISPSM
