...
public :: Allocate_Local_Arrays, CBLTP, CFTP, CI1BT, CI_VEC, CIBT, CLBT, CLEBT, CONF_OCC, CONF_REO, Deallocate_Local_Arrays, DFTP, &
          DStmp, Dtmp, DTOC, ECORE, ECORE_ORIG, ENVIRO, I12, I1234S, I12S, I2ELIMINATED_IN_GAS, I34S, I_AM_OUT, I_ELIMINATE_GAS, &
          I_RES_AB, IADVICE, IB_CONF_OCC, IB_CONF_REO, IB_SD_FOR_OPEN, IBCONF_ALL_SYM_FOR_OCCLS, IBGPSTR, IBSO, IBSPGPFTP, ICISTR, &
          ICJKAIB, ICMBSPC, IDC, IDIAG, IDISK, IELIMINATED_IN_GAS, IGSFGP, IGSOCC, IGSOCCX, IH0INSPC, IH0SPC, IH1FORM, INGRP_VAL, &
          ini_h0, INT1, IOBPTS, IOCLS, IPART, IPHGAS, IPRCIX, IPRDEN, IREFSM, IREOST, IREOTS, IRESTR, ISIMSYM, ISMDFGP, ISMFSO, &
          ISMFTO, ISMSCR, ISPGPFTP, ISTAC, ISTSGP, ISTSO, ITOOBS, KINH1, KINH1_NOCCSYM, kvec3_length, LCMBSPC, LCSBLK, LOFFI, &
          LSM1, LSM2, LUC, LUDIA, LUHC, LUMOUT, LUSC1, LUSC2, LUSC3, LUSC34, LUSC35, LUSC36, LUSC37, LUSC38, LUSC39, LUSC40, &
          MAX_STR_OC_BLK, MAX_STR_SPGP, MAXOP, Memory_Needed_Lucia, MINMAX_SM_GP, MINOP, MNGSOC, MNHL, MOCAA, MS2, MULTS, MXGSOC, &
          MXINKA, MXNSTR, MXNTTS, MXPCSM, MXPIRR, MXPNGAS, MXPNSMST, MXPOBS, MXPORB, MXPSTT, MXPTSOB, MXSOOB, MXTSOB, &
          N_2ELIMINATED_GAS, N_ELIMINATED_BATCHES, N_ELIMINATED_GAS, NACOB, NACOBS, NACTEL, NACTSYM, NBINT1, NBINT2, NCISPC, &
          NCMBSPC, NCONF_ALL_SYM, NCONF_PER_OPEN, NCONF_PER_SYM, NCONF_TOT, NCSF_HEXS, NCSF_PER_SYM, NDEOB, NELEC, NELFGP, &
