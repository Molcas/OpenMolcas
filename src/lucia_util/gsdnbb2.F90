...
subroutine GSDNBB2(I12,RHO1,RHO2,RHO2S,RHO2A,IASM,IATP,IBSM,IBTP,JASM,JATP,JBSM,JBTP,NGAS,IAOC,IBOC,JAOC,JBOC,NAEL,NBEL,IJAGRP, &
                   IJBGRP,SB,CB,C2,ADSXA,STSTSX,SXDXSX,MXPNGAS,NOBPTS,IOBPTS,MAXI,MAXK,SSCR,CSCR,I1,XI1S,I2,XI2S,I3,XI3S,I4,XI4S, &
                   X,NSMOB,NSMST,NIA,NIB,NJA,NJB,MXPOBS,NACOB,RHO1S,SCLFAC,S2_TERM1,IPHGAS,IDOSRHO1,SRHO1,IPACK)
...
if ((IATP == JATP) .and. (IASM == JASM)) then
  ...
  call GSBBD1(RHO1,NACOB,IBSM,IBTP,JBSM,JBTP,IJBGRP,NIA,NGAS,IBOC,JBOC,SB,CB,ADSXA,STSTSX,MXPNGAS,NOBPTS,IOBPTS,MAXI,MAXK,SSCR, &
              CSCR,I1,XI1S,I2,XI2S,NSMOB,NSMST,MXPOBS,RHO1S,SCLFAC,IPHGAS,IDOSRHO1,SRHO1,IAB)
  ...
  if ((I12 == 2) .and. (NBEL >= 2)) then
    ...
    call TIMING(CPU0,CPU,WALL0,WALL)
    call GSBBD2A(RHO2,RHO2S,RHO2A,NACOB,IBSM,IBTP,JBSM,JBTP,IJBGRP,NIA,NGAS,IBOC,JBOC,SB,CB,ADSXA,STSTSX,SXDXSX,MXPNGAS,NOBPTS, &
                 IOBPTS,MAXI,MAXK,SSCR,CSCR,I1,XI1S,X,NSMOB,NSMST,MXPOBS,SCLFAC,IPACK)
    !    GSBBD2A(RHO2,NACOB,ISCSM,ISCTP,ICCSM,ICCTP,IGRP,NROW,NGAS,ISEL,ICEL,SB,CB,ADSXA,STSTSX,SXDXSX,MXPNGAS,NOBPTS,IOBPTS,MAXI, &
    !            MAXK,SSCR,CSCR,I1,XI1S,X,NSMOB,NSMST,MXPOBS)
    call TIMING(CPU1,CPU,WALL1,WALL)
...
if ((IBTP == JBTP) .and. (IBSM == JBSM)) then
  ...
  IAB = 1
  call TIMING(CPU0,CPU,WALL0,WALL)
  call GSBBD1(RHO1,NACOB,IASM,IATP,JASM,JATP,IJAGRP,NIB,NGAS,IAOC,JAOC,SB,CB,ADSXA,STSTSX,MXPNGAS,NOBPTS,IOBPTS,MAXI,MAXK,SSCR, &
              CSCR,I1,XI1S,I2,XI2S,NSMOB,NSMST,MXPOBS,RHO1S,SCLFAC,IPHGAS,IDOSRHO1,SRHO1,IAB)
  call TIMING(CPU1,CPU,WALL1,WALL)
  TDENSI(1) = TDENSI(1)+(WALL1-WALL0)
  ...
  if ((I12 == 2) .and. (NAEL >= 2)) then
    ...
    call TIMING(CPU0,CPU,WALL0,WALL)
    call GSBBD2A(RHO2,RHO2S,RHO2A,NACOB,IASM,IATP,JASM,JATP,IJAGRP,NIB,NGAS,IAOC,JAOC,SB,CB,ADSXA,STSTSX,SXDXSX,MXPNGAS,NOBPTS, &
                 IOBPTS,MAXI,MAXK,SSCR,CSCR,I1,XI1S,X,NSMOB,NSMST,MXPOBS,SCLFAC,IPACK)
    call TIMING(CPU1,CPU,WALL1,WALL)
    TDENSI(2) = TDENSI(2)+(WALL1-WALL0)
...
if ((I12 == 2) .and. (NAEL >= 1) .and. (NBEL >= 1)) then
  ...
  call GSBBD2B(RHO2,RHO2S,RHO2A,IASM,IATP,IBSM,IBTP,NIA,NIB,JASM,JATP,JBSM,JBTP,NJA,NJB,IJAGRP,IJBGRP,NGAS,IAOC,IBOC,JAOC,JBOC,SB, &
               CB,ADSXA,STSTSX,MXPNGAS,NOBPTS,IOBPTS,MAXK,I1,XI1S,I2,XI2S,I3,XI3S,I4,XI4S,X,NSMOB,NSMST,MXPOBS,IUSEAB,SSCR,CSCR, &
               NACOB,SCLFAC,S2_TERM1,IPACK)
  !    GSBBD2B(RHO2,IASM,IATP,IBSM,IBTP,NIA,NIB,JASM,JATP,JBSM,JBTP,NJA,NJB,IAGRP,IBGRP,NGAS,IAOC,IBOC,JAOC,JBOC,SB,CB,ADSXA, &
  !            STSTSX,MXPNGAS,NOBPTS,IOBPTS,MAXK,I1,XI1S,I2,XI2S,I3,XI3S,I4,XI4S,X,NSMOB,NSMST,MXPOBS,IUSEAB,CJRES,SIRES,NORB)
  call TIMING(CPU1,CPU,WALL1,WALL)
