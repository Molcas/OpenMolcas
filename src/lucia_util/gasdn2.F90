...
subroutine GASDN2(I12,RHO1,RHO2,RHO2S,RHO2A,CB,SB,C2,NACOB,NSSOA,NSSOB,NAEL,IAGRP,NBEL,IBGRP,IOCTPA,IOCTPB,NOCTPA,NOCTPB,NSMST,&
                  NSMOB,MXPNGAS,NOBPTS,IOBPTS,MAXK,MAXI,CSCR,SSCR,STSTSX,SXDXSX,ADSXA,NGAS,NELFSPGP,IDC,I1,XI1S,I2,XI2S,I3,XI3S,&
                  I4,XI4S,X,MXPOBS,RHO1S,LUL,LUR,PSL,PSR,NBATCHL,LBATL,I1BATL,IBLOCKL,NBATCHR,LBATR,I1BATR,IBLOCKR,ICONSPA,&
                  ICONSPB,SCLFAC_L,SCLFAC_R,S2_TERM1,IPHGAS,IDOSRHO1,SRHO1,IPACK)
...
#                 endif
                  ...
                  call GSDNBB2(I12,RHO1,RHO2,RHO2S,RHO2A,IIASM,IIATP,IIBSM,IIBTP,JASM,JATP,JBSM,JBTP,NGAS, &
                               ...
                               NELFSPGP(:,IOCTPB-1+JBTP),NAEL,NBEL,IAGRP,IBGRP,SB(IOFF),CB(JOFF),C2,ADSXA,STSTSX,SXDXSX,MXPNGAS, &
                               NOBPTS,IOBPTS,MAXI,MAXK,SSCR,CSCR,I1,XI1S,I2,XI2S,I3,XI3S,I4,XI4S,X,NSMOB,NSMST,NIIA,NIIB,NJA,NJB, &
                               MXPOBS,NACOB,RHO1S,SCLFAC,S2_TERM1,IPHGAS,IDOSRHO1,SRHO1,IPACK)
