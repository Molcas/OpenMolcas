...
!
      IF(ITASK.EQ.1) THEN
        I1 = SYMPRO(I2,I12)
!
!?    IF(I12.GT.8.OR.I2.GT.8.OR.I12.LE.0.OR.I2.LE.0) THEN
!?      WRITE(6,*) ' I12 and I2 = ', I12, I2
!?    END IF
!
      ELSE IF(ITASK.EQ.2) THEN
!
!?    IF(I12.GT.8.OR.I1.GT.8.OR.I12.LE.0.OR.I1.LE.0) THEN
!?      WRITE(6,*) ' I12 and I1 = ', I12, I1
!?    END IF
!
        I2 = SYMPRO(I1,I12)
      ELSE IF (ITASK.EQ.3) THEN
!
!?    IF(I2.GT.8.OR.I1.GT.8.OR.I2.LE.0.OR.I1.LE.0) THEN
!?      WRITE(6,*) ' I2 and I1 = ', I2, I1
!?    END IF
!
        I12 = SYMPRO(I1,I2)
!
