...
!. Compressed map
               DO IROW = 1, LROW_IN
!?              write(6,*) ' IROW, ICREORB(IROW,KSTR)' ,
!?   &                       IROW, ICREORB(IROW,KSTR)
!OLD             IF(ICREORB(IROW,KSTR) .EQ. -IORBRT ) THEN
...
!?          WRITE(6,*) ' IADRK0 IOFFK IOFFKSP ',
!?   &                   IADRK0,IOFFK,IOFFKSP
!?          WRITE(6,*) ' IADRI0, IOFFISP ',
!?   &                   IADRI0, IOFFISP
!
