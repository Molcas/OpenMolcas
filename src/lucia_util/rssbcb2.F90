...
subroutine RSSBCB2(IASM,IATP,IBSM,IBTP,JASM,JATP,JBSM,JBTP,NGAS,IAOC,IBOC,JAOC,JBOC,NAEL,NBEL,IJAGRP,IJBGRP,SB,CB,JDOH2,NOBPTS, &
                   ...
                   SCLFAC,IPHGAS,I_RES_AB,nTUVX,TUVX,SBZERO)
...
#     endif
      call TIMING(CPU0,CPU,WALL0,WALL)
      call RSBB2A(IBSM,IBTP,JBSM,JBTP,IJBGRP,NIA,NGAS,IBOC,JBOC,SB,CB,NIB,NJB,NOBPTS,MAXI,MAXK,SSCR,CSCR,I1,XI1S,XINT,NSMOB, &
                  NSMST,SCLFAC,IPHGAS,size(TUVX),TUVX)
      call TIMING(CPU1,CPU,WALL1,WALL)
...
#     endif
      call TIMING(CPU0,CPU,WALL0,WALL)
      call RSBB2A(IASM,IATP,JASM,JATP,IJAGRP,NIB,NGAS,IAOC,JAOC,SB,CB,NIA,NJA,NOBPTS,MAXI,MAXK,SSCR,CSCR,I1,XI1S,XINT,NSMOB, &
                  NSMST,SCLFAC,IPHGAS,size(TUVX),TUVX)
      call TIMING(CPU1,CPU,WALL1,WALL)
      TSIGMA(2) = TSIGMA(2)+(WALL1-WALL0)
