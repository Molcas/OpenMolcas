...
use lucia_data, only: IBSPGPFTP, IGSFGP, IGSOCC, IPHGAS, ISPGPFTP, ISTAC, MAX_STR_OC_BLK, MAX_STR_SPGP, MINMAX_SM_GP, MS2, MXNSTR, &
                      MXPNGAS, MXPNSMST, NACOB, NACTEL, NELFGP, NELFSPGP, NELFTP, NGAS, NGRP, NHLFSPGP, NMXOCCLS, NOBPT, NORB1, &
