...
call SBLOCKS(NBLOCK,IBLOCK(:,IBOFF),CB,HCB,VEC3,CIOIO,ISMOST(:,ICSM),NSTSO(IATP)%A,NSTSO(IBTP)%A,NAEL,IATP,NBEL,IBTP,IOCTPA, &
             IOCTPB,NOCTPA,NOCTPB,NIRREP,NSMOB,NOBPTS,MXPNGAS,MAXK,MAXI,INSCR,VEC3,VEC3(1+LSCR2),NGAS,NELFSPGP,IDC,I1,XI1S,I2, &
             XI2S,IDOH2,SVST,PSSIGN,LUC,ICJKAIB,VEC3,VEC3(1+LSCR2),I3,XI3S,I4,XI4S,MOCAA,CLBT,CLEBT,CI1BT,CIBT,IRESTRICT,CONSPA, &
             CONSPB,LSCLFAC,H0SPC,ICBAT_RES,ICBAT_INI,ICBAT_END,IPHGAS,I_RES_AB)
