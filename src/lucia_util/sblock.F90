...
implicit none
integer(kind=iwp), intent(in) :: NBLOCK, IBLOCK(8,*), IBOFF, LUC, IRESTRICT, LUCBLK, ICBAT_RES, ICBAT_INI, ICBAT_END, nTUVX
...
call SBLOCKS(NBLOCK,IBLOCK(:,IBOFF),CB,HCB,VEC3,CIOIO,ICSM,NSTSO(IATP)%A,NSTSO(IBTP)%A,NAEL,IATP,NBEL,IBTP,IOCTPA,IOCTPB,NOCTPA, &
             ...
             H0SPC,ICBAT_RES,ICBAT_INI,ICBAT_END,IPHGAS,I_RES_AB,size(TUVX),TUVX)
