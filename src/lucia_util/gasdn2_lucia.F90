...
!.Output
      ...
      INTEGER INTERACT,NTEST,IBATCHL,NBLKL,IIL,IL,IATP,IBTP,IASM,IBSM,  &
     &        IOFF,ISCALE,IBATCHR,NBLKR,IIR,IR,JATP,JBTP,JASM,JBSM,     &
     &        JOFF,IPERM,NPERM,IIASM,IIBSM,IIATP,IIBTP,IAEXC,IBEXC,     &
     &        IABEXC,NIA,NIB,ILPERM,NLPERM,NIIA,NIIB,LROW,LCOL,NJA,NJB, &
     &        NRPERM
