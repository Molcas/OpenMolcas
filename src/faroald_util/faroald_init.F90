...
! number of possible non-destructive single excitations
...
! For SG_Epq_Psi, we use an excitation table for the beta strings.
...
<<<<<<< HEAD:src/molcas_ci_util/faroald_init.F90
if (mult /= 1) then
=======
!if (mult /= 1) then
>>>>>>> upstream-openmolcas/master:src/faroald_util/faroald_init.F90
