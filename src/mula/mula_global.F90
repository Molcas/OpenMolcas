...
real(kind=wp), allocatable :: AtCoord1(:,:), AtCoord2(:,:), Hess1(:,:), Hess2(:,:), t_dipin1(:), t_dipin2(:), t_dipin3(:), &
                              TranDipGrad(:,:), var(:,:), yin1(:), yin2(:)
...
public :: AtCoord1, AtCoord2, broadplot, cmstart, cmend, energy1, energy2, hbarcm, Hess1, Hess2, Huge_Print, inpUnit, ipow, &
          ...
          OscStr, plotwindow, t_dipin1, t_dipin2, t_dipin3, TranDip, TranDipGrad, Use_cm, Use_nm, var, VibModPlot, WriteVibLevels, &
          yin1, yin2
