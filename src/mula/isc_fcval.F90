...
#include "WrkSpc.fh"
#include "inout.fh"
!      Write(6,*) 'CGGt[ISC_FCval] Enter '                         ! CGGt
!      Write(6,*) '                iMx_nOrd, nYes = ',iMx_nOrd, nYes ! Ct
!      Write(6,*) '                VibWind2 :',(VibWind2(i),i=1,nYes)  !t
...
!      Call XFlush(6)                                              ! CGGt
      Do kOsc = 1,nOsc
!      Write(6,*) 'CGGt[FCVal] nInc(0,kOsc)=',nInc(0,kOsc)         ! CGGt
!      Call XFlush(6)                                              ! CGGt
!      Write(6,*) 'CGGt[FCVal] Work(ipd2..)=',Work(ipd2+kOsc-1)    ! CGGt
!      Call XFlush(6)                                              ! CGGt
...
!      Write(6,*) '              ',iOrd,kOsc,nMat(iOrd,kOsc) ! CGGt
