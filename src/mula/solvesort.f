...
C!
C!  Purpose:
C!    Solve the secular equation AC = SCD.
C!
C!  Input:
C!    A         : Real*8 two dimensional array
C!    S         : Real*8 two dimensional array
C!    W0,W1,W2  : Real*8 two dimensional arrays - eigenvectors
C!                scaled by square root of harmonic frequencies.
C!    C0,C1,C2  : Real*8 two dimensional arrays - inverses
C!                of W0,W1 and W2.
C!    r00,
C!    r01,
C!    r02       : Real*8 arrays - geometry in internal
C!                coordinates.
...
C!    D         : Real*8 array
C!    OccNumMat : Real*8 two dimensional array - occupation
C!                numbers for the different modes.
C!
C!  Calls:
C!    Jacob
C!    Jacord
...
C!
C!---- Store the eigenvalues in array D and calculate C.
      Do i = 1,n
      ii = i*(i+1)/2
      D(i) = Work(ipScr+ii-1)
      End Do
