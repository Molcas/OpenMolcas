...
public :: BNAME, CISEL, CSEL, CSPCK, CTRSH, DMO, ENGY, ENP, ESHIFT, ESMALL, ETHRE, ETRSH, FIJKL, FOCK, GFAC, HZERO, IAD25S, &
          ...
          NRROOT, NSECT, NSEL, NSM, NSRTMX, NSTOT, NSYM, NVEC, NVIR, NVIRP, NVIRT, NVMAX, NVPAIR, NVSQ, NVTOT, PNAME, PNUC, PORIG, &
          POTNUC, PTYPE, SQ2, SQ2INV, SQNLIM, SSEL, SZERO, TDMO, THRORB, TIBUF, VALSRT, VSMALL, VZERO
