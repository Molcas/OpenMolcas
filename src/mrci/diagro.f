...
1240    CONTINUE
      ...
      DO 1241 I=1,NRROOT
        ELAST(I)=ESMALL(I)
1241  CONTINUE
1234  FORMAT(1X,I4,1X,I4,1X,F15.8,1X,8X  ,1X,D8.2,1X,F6.3,2(1X,F7.1))
1235  FORMAT(1X,I4,1X,I4,1X,F15.8,1X,D8.2,1X,D8.2,1X,F6.3,2(1X,F7.1))
1236  FORMAT(11X,           F15.8,1X,8X  ,1X,D8.2,1X,F6.3)
1237  FORMAT(11X,           F15.8,1X,D8.2,1X,D8.2,1X,F6.3)
...
C APPROXIMATE CORRECTIONS FOR UNLINKED QUADRUPLES:
        ...
        END IF
        WRITE(6,*)
*PAM04        CALL PRWF (HWORK(LCSPCK),HWORK(LINTSY),HWORK(LINDX),
*PAM04     &             CI,HWORK(LJREFX) )
        CALL PRWF (IWORK(LCSPCK),IWORK(LINTSY),IWORK(LINDX),
     &             CI,IWORK(LJREFX) )
        WRITE(6,*)' ',('*',III=1,70)
