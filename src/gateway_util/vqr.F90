...
!...  auxiliar constant pool:    only DFAC is used here.
#include "const.fh"
...
!     LU6=6
      N=ISIM
!
!...  Reads the Mass Velocity and Darwin potentials for the
!     valence orbitals
!
...
!
!...  Matrix of a numerical local operator V(r)
!     given in a logaritmic mesh
!
