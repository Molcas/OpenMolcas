...
!***********************************************************************
     ...
     &                        valn,jn,kn,ln)
!
!     this routine write one block of 3-indices and appropriate
!     values of integrals into an opened TEMP-file
!
...
!     transpotred through commons  in reorg.fh
!
...
!
       ...
       integer ihelp
!
!*     pack indexes and integral values
!
       do m2=1,length
...
!        whith the pointer at then first possition
...
!        file was alredy used in expansion of this block, it must
!        be opened whith the pointer at the end of the file
#ifdef _DECAXP_
