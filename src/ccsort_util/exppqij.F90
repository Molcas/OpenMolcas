...
call ccsort_grc0(4,typv2,typp,typq,typr,typs,1,poss20,posst,mapd2,mapi2)
...
do ii=1,mapd2(0,5)
  ...
  if (symi >= symj) then
    ...
    if (directyes == 1) then
      ...
      call ireorg(wrk,wrksize,symp,symq,symi,symj,typp,typq,typr,typs,1,2,3,4,5,5,1,1,typv2,possv1d,possv2,1.0d0)
    ...
    if (inverseyes == 1) then
      ...
      call ireorg(wrk,wrksize,symp,symq,symi,symj,typp,typq,typr,typs,2,1,3,4,5,5,1,1,typv2,possv1i,possv2,-1.0d0)
    ...
    if (directyes == 1) then
      ...
      call ireorg(wrk,wrksize,symp,symq,symi,symj,typp,typq,typr,typs,2,1,4,3,5,5,1,1,typv2,possv1d,possv2,1.0d0)
    ...
    if (inverseyes == 1) then
      ...
      call ireorg(wrk,wrksize,symp,symq,symi,symj,typp,typq,typr,typs,1,2,4,3,5,5,1,1,typv2,possv1i,possv2,-1.0d0)
