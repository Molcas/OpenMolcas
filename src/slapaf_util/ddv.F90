...
!        Write (6,*)
!        Write (6,*) ' Warning!'
!        Write (6,*) ' Rotational internal coordinates not implemented'
!    &             //' for fewer than 3 atoms!'
...
!        If (iBondType.gt.Magic_Bond) Go To 10
...
!
!        If (iBondType.eq.vdW_Bond) Go To 444
...
!           Write (6,*)
            ...
            jBondType =iTabBonds(3,jBond)
!           If (jBondType.eq.vdW_Bond) Go To 333
...
!              If (kBondType.eq.vdW_Bond) Go To 222
...
!
         nNeighbor_i = iTabAtoms(1,0,iAtom)
!        Write (*,*) 'iAtom,nNeighbor_i=',iAtom,nNeighbor_i
