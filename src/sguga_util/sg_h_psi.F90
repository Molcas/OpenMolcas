...
! No fancy use of degeneracies, full summation
Write (u6,*) 'SGUGA driven algorithm for H|Psi>, DGEMV version'
Write (u6,*) 'No fancy use of degeneracies, full summation.'
...
Write (u6,*) 'SGUGA driven algorithm for H|Psi>, DGEMV version'
Write (u6,*) 'i>=j Symmetrize: E_ij + E_ji, k>=l Symmetrize E_kl + E_lj, ij>=kl'
