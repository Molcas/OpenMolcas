...
#include "Molcas.fh"
#include "grid.fh"
integer(kind=iwp) :: i, ibr, ibrm, iend, ifirst, iibeg, iiend, ilen, istart, isymm
...
20 write(u6,*) 'Error in analyzing SELECT section'
call Quit_OnUserError()
30 write(u6,*) 'Too many Grids requested'
call Quit_OnUserError()
