...
subroutine One_CHARGE(NSYM,NBAS,NAME,CMO,OCCN,SMAT,iCase,FullMlk,MXTYP,QQ,nNuc)
...
991 write(6,'(/6X,A)') 'The number of basis functions exceeds the present limit'
call Abend()
!992 write(6,'(/6X,A)') 'The number of basis functions exceeds the present limit'
!call Abend()
!993 write(6,'(/6X,A)') 'Warning: Total charge is not equal to number of electrons'
!call Abend()
