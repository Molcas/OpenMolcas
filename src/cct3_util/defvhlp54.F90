...
subroutine defvhlp54(r1,r2,v,dimr1a,dimr1b,dimr1c,dimva,dimvb,dimvc,adda,addb,addc)
! this routine does
...
real(kind=wp) :: r1(dimr1a,dimr1c,dimr1b), r2(dimr1b,dimr1c,dimr1a), v(dimva,dimvb,dimvc)
#include "t31.fh"
