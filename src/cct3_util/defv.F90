...
subroutine defv(wrk,wrksize,deftyp,possv0,mapdv,mapiv,ssv,mapdr,mapir,ssr,rc)
...
if ((deftyp == 1) .or. (deftyp == 2)) then
  ...
  do iv=1,mapdv(0,5)
    ...
    if (syma == symb) then
      ...
      if (symb == symc) then
        ...
        call defvhlp1(wrk(possr1),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5)
        ...
        if (syma >= symc) then
          call defvhlp21(wrk(possr1),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7)
        else
          call defvhlp22(wrk(possr1),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7)
        end if
      ...
      if (syma == symc) then
        ...
        call defvhlp3(wrk(possr1),wrk(possr2),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7,nhelp8,nhelp9,nhelp10)
        ...
        call defvhlp4(wrk(possr1),wrk(possr2),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7,nhelp8,nhelp9,nhelp10)
        ...
        if ((syma > symc) .and. (symb > symc)) then
          call defvhlp51(wrk(possr1),wrk(possr2),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7,nhelp8,nhelp9)
        else if ((syma > symc) .and. (symb < symc)) then
          call defvhlp52(wrk(possr1),wrk(possr2),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7,nhelp8,nhelp9)
        else if ((syma < symc) .and. (symb > symc)) then
          call defvhlp53(wrk(possr1),wrk(possr2),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7,nhelp8,nhelp9)
        else if ((syma < symc) .and. (symb < symc)) then
          call defvhlp54(wrk(possr1),wrk(possr2),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7,nhelp8,nhelp9)
        end if
  ...
  do iv=1,mapdv(0,5)
    ...
    if (symb == symc) then
      ...
      !3.1.* realize definition of V
      if (symb > symc) then
        call defvhlp61(wrk(possr1),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7)
      else
        call defvhlp62(wrk(possr1),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7)
      end if
  ...
  do iv=1,mapdv(0,5)
    ...
    if (syma == symc) then
      ...
      !4.1.* realize definition of V
      if (syma > symc) then
        call defvhlp81(wrk(possr2),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7,nhelp8)
      else
        call defvhlp82(wrk(possr2),wrk(possv),nhelp1,nhelp2,nhelp3,nhelp4,nhelp5,nhelp6,nhelp7,nhelp8)
      end if
