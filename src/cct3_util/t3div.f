...
!     mapdd1 - direct map matrix of 1.st diagonal el. (Input)
!     mapid1 - inverse map matrix of 1.st diagonal el. (Input)
!     mapdd2 - direct map matrix of 2.st diagonal el. (Input)
!     mapid2 - inverse map matrix of 2.st diagonal el. (Input)
...
!
!     this routine realize division by denominators and
...
!1.a.*find address for d1,2,3 (the same one)
       id1=mapid1(syma,1,1)
!
!1.a.*def possition of d1,2,3 (the same one)
       possd1=mapdd1(id1,1)
!
