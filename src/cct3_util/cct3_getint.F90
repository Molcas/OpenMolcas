...
subroutine cct3_getint(wrk,wrksize,i,symi,possr0,mapdr,mapir,rc)
! this routine reads integrals R_i(a,bc) for given i in given symi
!
! i      - number of orbital (I)
! symi   - irrep of i (I)
! possr0 - initial position of R (I)
...
!call cct3_getmediate(wrk,wrksize,lun,possr0,mapdr,mapir,rc1)
