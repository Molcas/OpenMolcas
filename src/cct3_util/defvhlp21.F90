...
subroutine defvhlp21(r1,v,dimr1a,dimr1c,dimvab,dimva,dimvc,adda,addc)
! this routine does
! V(ab,c)xxx = R1(a,b,c)-R1(b,a,c) x=a,b
! for syma=symb>symc
!
! r1     - r1 matrix (I)
! v      - v matrix (O)
...
real(kind=wp), intent(in) :: r1(dimr1a,dimr1a,dimr1c)
...
do c=1,dimvc
  ...
  do a=2,dimva
    ar1 = a+adda
    ab0 = nshf(a)
    v(ab0+1:ab0+a-1,c) = r1(ar1,adda+1:adda+a-1,cr1)
  end do
end do
