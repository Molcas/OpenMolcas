...
subroutine cct3_grc32C(mapda,mapdb,mapdc,mapia,mapib,mapic,mvec,ssa,ssb,pbar,possc0,ix)
...
if (pbar == 1) then
  ...
  call cct3_grc0(3,mapda(0,6),mapda(0,1),mapda(0,2),mapdb(0,2),0,mmul(ssa,ssb),possc0,possct,mapdc,mapic)
