...
subroutine defvhlp51(r1,r2,v,dimr1a,dimr1b,dimr1c,dimva,dimvb,dimvc,adda,addb,addc)
! this routine does
...
real(kind=wp), intent(in) :: r1(dimr1a,dimr1b,dimr1c), r2(dimr1b,dimr1a,dimr1c)
...
do c=1,dimvc
  ...
  do b=1,dimvb
    br1 = b+addb
    v(:,b,c) = r1(adda+1:adda+dimva,br1,cr1)
  end do
end do
