...
subroutine cct3_grc42y(mapda,mapdb,mapdc,mapia,mapib,mapic,mvec,ssa,ssb,posc0,ix)
...
call cct3_grc0(2,ntest1,mapda(0,1),mapda(0,2),0,0,mmul(ssa,ssb),posc0,posct,mapdc,mapic)
