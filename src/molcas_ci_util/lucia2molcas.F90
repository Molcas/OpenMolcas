...
use spinfo, only: MS2,MINOP,MAXOP,NTYP,MXSM,NDTFTP,NCSFTP,MULTS,NCNFTP
use spinfo, only: NDTASM,MXCISM,NCSASM,NCNASM,IORB1F,IORB1L,IORB3F,IORB3L,   &
                  NEL1MX,NEL3MX,NEL3MN,NDET
use spinfo, only: NCSF_HEXS,I_ELIMINATE_GAS_MOLCAS
