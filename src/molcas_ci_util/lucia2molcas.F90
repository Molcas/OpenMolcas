...
use general_data, only: ISPIN, NACTEL, NELEC3, NHOLE1, NRS1, NRS2, NRS3, NSEL, NSYM, STSYM
use stdalloc, only: mma_allocate
use Definitions, only: iwp, u6
use spinfo, only: I_ELIMINATE_GAS_MOLCAS, IORB1F, IORB1L, IORB3F, IORB3L, MAXOP, MINOP, MS2, MULTS, MXCISM, MXSM, NCNASM, NCNFTP, &
                  NCSASM, NCSF_HEXS, NCSFTP, NDET, NDTASM, NDTFTP, NEL1MX, NEL3MN, NEL3MX, NTYP
