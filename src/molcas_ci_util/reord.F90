...
!          STEP VECTOR AND PASS IT TO THE FUNCTIONS SG_PHASE
!          AND SG_NUM WHICH COMPUTES THE PHASE FACTOR
...
do ITYP=1,NTYP
  ...
  do IC=1,NCNATS(ITYP,IREFSM)
    ...
    do IICSF=1,NCPCNT(ITYP)
      ...
      ! COMPUTE STEP VECTOR
      call STEPVEC(ICONF(ICNBS:ICNBS+ICL-1),ICONF(ICNBS+ICL),ICL,IOPEN,ISPIN(ICSBAS),SGS%nLev,IWALK)
