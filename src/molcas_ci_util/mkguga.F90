...
!
      CALL MKMID(NVERT,NLEV,DAW,RAW,SGS%LTV,SGS%MIDLEV, NMIDV, SGS%MVSta, SGS%MVEnd, MXUP, MXDWN)
!
!     FORM VARIOUS OFFSET TABLES:
!     NOTE: NIPWLK AND DOWNWLK ARE THE NUMER OF INTEGER WORDS USED
!           TO STORE THE UPPER AND LOWER WALKS IN PACKED FORM.
!
      NIPWLK=1+(SGS%MIDLEV-1)/15
      NIPWLK=MAX(NIPWLK,1+(NLEV-SGS%MIDLEV-1)/15)
      NNOW=2*NMIDV*NSYM
      NIOW=NNOW
      NNOCSF=NMIDV*(NSYM**2)
      NIOCSF=NNOCSF
...
!
      ...
      Call MKSGNUM(STSYM,NSYM,NLEV,NVERT,SGS%MIDLEV,NMIDV,MXUP,MXDWN,NICASE,NIPWLK,SGS%DOWN,SGS%UP,DAW,RAW,NOW1, &
