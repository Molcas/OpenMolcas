...
!
      CALL MKMID(NVERT,NLEV,DAW,RAW,SGS%LTV,MIDLEV, NMIDV, MVSta, SGS%MVEnd, MXUP, MXDWN)
!
...
!
      ...
      CALL MKCOT(NSYM,NLEV,NVERT,MIDLEV,NMIDV,MVSta,SGS%MVEnd,NWALK,NIPWLK,NSM,DOWN,NOW1,IOW1,NCSF,IOCSF,NOCSF,SCR)
!
!     CONSTRUCT THE CASE LIST
!
      NICASE=NWALK*NIPWLK
      CALL mma_allocate(ICASE,NICASE,Label='ICASE')
      Call MKCLIST(NSYM,NLEV,NVERT,MIDLEV,MVSta,SGS%MVEnd,NMIDV,NICASE,NIPWLK,NSM,DOWN,NOW1,IOW1,ICASE,SCR)
