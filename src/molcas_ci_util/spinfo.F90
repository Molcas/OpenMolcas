...
! iprci, ngas_molcas, INOCALC, ISAVE_EXP, IEXPAND, N_ELIMINATED_GAS_MOLCAS, N_2ELIMINATED_GAS,
...
public :: DoComb, I2ELIMINATED_IN_GAS, I_ELIMINATE_GAS, IELIMINATED_IN_GAS, IEXPAND, igsoccx, &
          ...
          MS2, N_2ELIMINATED_GAS, N_ELIMINATED_GAS_MOLCAS, nactel_Molcas, NCNASM, NCNFTP, NCSASM, nCSF_HEXS, &
