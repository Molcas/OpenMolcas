...
! nSpeed, iSpeed
!
! ngssh, igsoccx, ELIMINATED_IN_GAS, 2ELIMINATED_IN_GAS, potnuc_Molcas,
! thre_Molcas, nsym_Molcas, nactel, ms2, ispin, STSYM, itmax, nroots, ipt2,
...
public :: DoComb, I2ELIMINATED_IN_GAS, I_ELIMINATE_GAS, IELIMINATED_IN_GAS, IEXPAND, igsoccx, &
          ...
          NCSFTP, NDET, NDTASM, NDTFTP, ngas, ngssh, nroots, nsym_Molcas, NTYP, potnuc_Molcas, thre_Molcas
