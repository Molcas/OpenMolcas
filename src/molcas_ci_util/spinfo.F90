...
integer(kind=iwp) :: I2ELIMINATED_IN_GAS_MOLCAS(MxGAS), I_ELIMINATE_GAS_MOLCAS, IELIMINATED_IN_GAS_MOLCAS(MxGAS), IEXPAND_MOLCAS, &
                     igsoccx_molcas(MxGAS,2), INOCALC_MOLCAS, iprci_Molcas, ipt2_Molcas, ISAVE_EXP_MOLCAS, &
                     ...
                     NCSFTP(MXTYP), NDET, NDTASM(mxSym), NDTFTP(MXTYP), ngas_molcas, ngssh_molcas(MxGAS,mxSym), &
                     nroots_Molcas, nsym_Molcas, NTYP
real(kind=wp) :: potnuc_Molcas, thre_Molcas
logical(kind=iwp) :: DoComb

public :: DoComb, I2ELIMINATED_IN_GAS_MOLCAS, I_ELIMINATE_GAS_MOLCAS, IELIMINATED_IN_GAS_MOLCAS, IEXPAND_MOLCAS, &
          ...
          NCNASM, NCNFTP, NCSASM, nCSF_HEXS, NCSFTP, NDET, NDTASM, NDTFTP, ngas_molcas, ngssh_molcas, nroots_Molcas, &
