...
! thre_Molcas, nsym_Molcas, nactel_Molcas, ms2_Molcas, ispin, lsym_Molcas, itmax, nroots_Molcas, ipt2,
...
integer(kind=iwp) :: I2ELIMINATED_IN_GAS(MxGAS), I_ELIMINATE_GAS, IELIMINATED_IN_GAS(MxGAS), IEXPAND, &
                     ...
                     ispin, itmax, lsym_Molcas, MINOP, MS2, ms2_Molcas, N_2ELIMINATED_GAS_MOLCAS, &
...
public :: DoComb, I2ELIMINATED_IN_GAS, I_ELIMINATE_GAS, IELIMINATED_IN_GAS, IEXPAND, igsoccx, &
          INOCALC, iprci, ipt2, ISAVE_EXP, iSpeed, ispin, itmax, lsym_Molcas, MINOP, &
