...
! iprci_Molcas, ngas_molcas, INOCALC, ISAVE_EXP_MOLCAS, IEXPAND, N_ELIMINATED_GAS_MOLCAS, N_2ELIMINATED_GAS_MOLCAS,
...
integer(kind=iwp) :: I2ELIMINATED_IN_GAS(MxGAS), I_ELIMINATE_GAS, IELIMINATED_IN_GAS(MxGAS), IEXPAND, &
                     igsoccx(MxGAS,2), INOCALC, iprci_Molcas, ipt2_Molcas, ISAVE_EXP_MOLCAS, iSpeed(nSpeed), &
...
public :: DoComb, I2ELIMINATED_IN_GAS, I_ELIMINATE_GAS, IELIMINATED_IN_GAS, IEXPAND, igsoccx, &
          INOCALC, iprci_Molcas, ipt2_Molcas, ISAVE_EXP_MOLCAS, iSpeed, ispin_Molcas, itmax_Molcas, lsym_Molcas, MINOP, &
