...
************************************************************************
      Subroutine Do_CS(mGrid,nP2,P2_ontop,P2II,
...
#include "real.fh"
      Real*8 P2_ontop(nP2,mGrid),P2II(mGrid)
      Real*8 gradZ(3),
     &       gradBeta(3),
     &       dgradZdRho(3),
     &       dgradBetadRho(3),
...
*
        ...
        Do i=1,3
          gradBeta(i) = qCS*GradRho(i,iGrid)/
     &                  (3.0d0*GradRho(i,iGrid)**(2.0d0/3.0d0))
*
          dgradBetadRho(i) = -2.0d0*qCS*GradRho(i,iGrid)/
