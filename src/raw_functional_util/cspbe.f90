...
!***********************************************************************
      Subroutine cspbe(mGrid,Coeff,nD,F_xc)
      use xc_f03_lib_m
      ...
      ! PBE correlation
      integer*4, parameter :: func_id = 89
...
!               2017, Aron Cohen                                       *
!***********************************************************************
      Subroutine CSPBE(mGrid,Coeff,iSpin,F_xc)
!***********************************************************************
!                                                                      *
...
! Maybe derivatives w.r.t. gamma_aa, gamma_ab, gamma_bb should be used instead.
      ...
      subroutine cspbe_(idord,rho_in,grdrho_in,zeta_in,func0,func1,func2)
      implicit none
