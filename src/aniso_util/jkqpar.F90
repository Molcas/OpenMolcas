...
!         Write(6,*)
!         Do i1=1,N1
!           Write(6,'(20(2ES14.7,1x))') ( (0.5_wp, 0.0_wp)*
!     &            (  CMPLX((-1)**q1)*W1(i1,j1) + O1(i1,j1)  ), j1=1,N1)
!         End Do
!         Write(6,*)
!         Write(6,'(5x,a,i3,3x,A,I3)') 'JKQPAR:   W1  k1 = ',k1,'q1 =',q1
!         Write(6,*)
!         Do i1=1,N1
!           Write(6,'(20(2ES14.7,1x))') ( (0.0_wp,-0.5_wp)*
!     &            (  CMPLX((-1)**q1)*W1(i1,j1) - O1(i1,j1)  ), j1=1,N1)
!         End Do
!         Write(6,*)
...
!         Do i2=1,N2
!           Write(6,'(20(2ES14.7,1x))') ( (0.5_wp, 0.0_wp)*
!     &            (  CMPLX((-1)**q2)*W2(i2,j2) + O2(i2,j2)  ), j2=1,N2)
!         End Do
!         Write(6,*)
...
!      Jpar( k1,-q1, k2,-q2 ) =  trace_exch(N1,N2,HEXCH, O1_O2)
!     &                        * Knm(k1,ABS(q1)) * Knm(k2,ABS(q2)) / FACT
!      Jpar( k1, q1, k2,-q2 ) = trace_exch(N1,N2,HEXCH, W1_O2)
!     &                        * Knm(k1,ABS(q1)) * Knm(k2,ABS(q2)) / FACT
!      Jpar( k1,-q1, k2, q2 ) = trace_exch(N1,N2,HEXCH, O1_W2)
!     &                        * Knm(k1,ABS(q1)) * Knm(k2,ABS(q2)) / FACT
!      Jpar( k1, q1, k2, q2 ) = trace_exch(N1,N2,HEXCH, W1_W2)
!     &                        * Knm(k1,ABS(q1)) * Knm(k2,ABS(q2)) / FACT
!
